                ...
                <template v-if="!loading">
                    <el-col :span="24">
                        <el-form-item label="工单号" prop="name">
                            <el-input v-model="dataForm.name" placeholder="请输入" clearable :style='{"width":"100%"}' readonly>
                   ...
                   <!-- <el-col :span="24">
                    ...
                    <el-col :span="24">
                        <el-form-item label="操作工" prop="userId">
                            <el-input v-model="dataForm.userId" placeholder="请输入" clearable :style='{"width":"100%"}' readonly>
                    ...
                    <el-col :span="12">
                        <el-form-item label="计划数量" prop="qtyOrder">
                            <el-input v-model="dataForm.qtyOrder" placeholder="数字文本" :step="100" readonly>

                            </el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="完工数量" prop="qtyOrder">
                            <el-input v-model="dataForm.qtyProduced" placeholder="数字文本" :step="100" readonly>

                            </el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="报工数量" prop="number">
                            <el-input v-model="dataForm.number" placeholder="数字文本" :step="100" :max="maxNumber">
        ...
        methods: {
            ...
            request() {
                ...
                let _data = this.dataList()
                   request({url: '/api/jx/Mrp_workorder/' + this.dataForm.id,method: 'PUT',data: _data}).then((res) => {
                        this.$message({
                            message: res.msg,
                            type: 'success',
                            duration: 1000,
            ...
            dataList() {
                ...
                _data.qtyProduced = parseInt(_data.qtyProduced) + parseInt(_data.number);
                if(parseInt(_data.qtyOrder) == parseInt(_data.qtyProduced)){
                    console.log("123");
                    _data.state = "done"
                }
            ...
            dataInfo(dataAll) {
                ...
                this.maxNumber = this.dataForm.qtyOrder - this.dataForm.qtyProduced;
