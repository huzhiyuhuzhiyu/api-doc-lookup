                    ...
                    <div class="JNPF-common-layout-center JNPF-flex-main">
                                ...
                                <el-col :span="4">
                                    <el-form-item>
                                        <!-- <el-date-picker v-model="createRequirementDate" type="datetimerange"
                                            ...
                                            style="width: 100%;" start-placeholder="请选择点检开始时间" end-placeholder="请选择点检结束时间"
                                            clearable :picker-options="pickerOptions">
                                        </el-date-picker> -->
                                        <el-date-picker v-model="createRequirementDate" type="daterange"
                                            value-format="yyyy-MM-dd" style="width: 100%;" start-placeholder="点检开始时间"
                                            end-placeholder="点检结束时间" clearable :picker-options="pickerOptions">
                                        </el-date-picker>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
                        ...
                        <div class="JNPF-common-layout-main JNPF-flex-main">
                            <JNPF-table v-if="flag" v-loading="listLoading" highlight-current-row :fixedNO="true"
                                ...
                                <el-table-column prop="nextMaintenanceTime" label="下次点检时间" min-width="180"
                                    sortable="custom" />
...
import { checkmaintenanceList } from '@/api/dailyManagement/Maintenance'
