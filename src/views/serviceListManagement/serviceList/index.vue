    ...
    <div class="JNPF-common-layout-center JNPF-flex-main" v-if="!formVisible">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
        ...
        <JNPF-table @selection-change="handeleProductInfoData" hasC highlight-current-row v-if="isProjectSwitchFlag"
          ...
          <el-table-column prop="saleOrderNo" label="所属项目" min-width="200" sortable="custom"  v-if="abProjectSwitchVisible"/>
          <el-table-column prop="saleNoticeNo" label="供应商/客户名称" min-width="200" sortable="custom" />
          <el-table-column prop="deliverDate" label="税号" min-width="200" sortable="custom" />
          <el-table-column prop="customerProductNo" label="联系方式" min-width="200" sortable="custom" />
          <el-table-column prop="partnerName" label="审批状态" min-width="180" sortable="custom" />
          <el-table-column prop="partnerCode" label="服务内容" min-width="180" sortable="custom" />
          <el-table-column prop="productCode" label="含税金额" min-width="180" sortable="custom" />
          <el-table-column prop="productName" label="税率" sortable="custom" width="160" show-overflow-tooltip></el-table-column>
          <el-table-column prop="drawingNo" label="备注" min-width="180" sortable="custom" />
          ...
          <el-table-column prop="businessType" label="收付款类型" min-width="150" sortable="custom">
            <template slot-scope="scope">
  ...
  data() {
    return {
      ...
      searchList: [
        ...
        { field: 'partnerName', fieldValue: '', label: '供应商/客户名称', symbol: 'like', searchType: 1, width: 120 }, 
