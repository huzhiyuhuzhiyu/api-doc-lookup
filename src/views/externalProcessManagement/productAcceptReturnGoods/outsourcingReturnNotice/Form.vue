            ...
            <el-tab-pane label="基础信息" name="jcInfo">
              ...
              <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm">
                <el-table style="border: 1px solid #e3e7ee;" hasNO fixedNO v-bind="dataFormTwo.data"
                  ...
                  <el-table-column label="操作" width="180" fixed="right" v-if="dataFormTwo.data.length > 1 && type !== 'look'">
                    <template slot-scope="scope">
      ...
      purPurchaseOrderdetail(this.dataForm.purchaseOrderId).then(res => {
        ...
        this.dataFormTwo.data = res.data.purchaseOrderLineVOList.map(item => {
          return {
            ...
            receivedQuantity: Number( item.receiptQuantity-item.returnQuantity) > 0 ? Number( item.receiptQuantity-item.returnQuantity) : 0,
            receivingStatus: "returning"
          }
        })
        console.log( this.dataFormTwo.data, '通过采购单id 拿到明细数据');
      })
    },
