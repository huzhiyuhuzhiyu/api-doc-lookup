          ...
          <div class="JNPF-common-layout" style="height: 68vh;overflow: auto;">
            ...
            <div class="JNPF-common-layout-center JNPF-flex-main">
              ...
              <div class="JNPF-common-layout-main JNPF-flex-main">
                <JNPF-table v-loading="listLoading" :data="tableDataCustomer" @row-dblclick="seleceCustomer" customKey="JNPFTableKey_280622">
        ...
        <el-dialog title="选择订单" :close-on-click-modal="false" :close-on-press-escape="false" :visible.sync="allProVisible" lock-scroll class="JNPF-dialog JNPF-dialog_center selectPro" width="70%" append-to-body>
          ...
          <div class="JNPF-common-layout" style="height: 68vh;overflow: auto;">
            <div class="JNPF-common-layout-center JNPF-flex-main">
              ...
              <div class="JNPF-common-layout-main JNPF-flex-main">
                <JNPF-table v-loading="listLoading" :data="allproductData" @row-dblclick="seleceCustomerdd" @selection-change="handleSelectionChangeAllPruduct" customKey="JNPFTableKey_541896">
...
export default {
  ...
  methods: {
    ...
    calcValidates() {
      return (rule, value, callback) => {
        ...
        if (value == 0) {
          ...
          let flag = false
          let list = this.dataFormTwo.data
          let num_1 = Number(list[index].receivingQuantity)//已入库数(主)
          let num_2 = Number(list[index].outboundQuantity)//已出库数(主)
          if (!(num_1 <= num_2)) { flag = true }
          if (flag) {
            this.$message.error(msg)
            callback(new Error(msg));
    ...
    seleceCustomerdd(val, data) {
      ...
      //   let a = []
      //   if (res.data.order.orderState == 'finish') {//orderState订单状态、not_finish未完成finish已完成part_finish部分完成
      //     this.Flagtype = true
