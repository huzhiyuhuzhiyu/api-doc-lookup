    ...
    <div class="JNPF-preview-main org-form">
      <div class="JNPF-common-page-header">
        ...
        <el-page-header @back="goBack"
          :content="btnType == 'add' ? '新建半成品订单' : btnType == 'edit' ? '编辑半成品订单' : btnType == 'look' ? '查看半成品订单' : ''" />
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="订单信息" name="orderInfo">
              ...
              <el-row :gutter="30" class="custom-row">
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="订单状态" prop="orderStatus">
                    <el-select v-model="reworkForm.orderStatus" placeholder="请选择订单类型" clearable disabled
                      style="width: 100%;">
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="关闭人" prop="closedByName">
                    <el-input placeholder="请输入关闭人" disabled v-model="reworkForm.closedByName"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="关闭时间" prop="closeDate">
                    <el-input placeholder="请选择关闭时间" disabled v-model="reworkForm.closeDate"></el-input>
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="BOM名称" prop="bomName">
                    <el-input v-model="reworkForm.bomName" placeholder="请输入BOM名称" disabled />
                  </el-form-item>
                </el-col>
            ...
            <JNPF-table ref="product" :data="workOrderData" :fixedNO="false" height="100%" style="width:100%" >
              ...
              <el-table-column prop="orderNo" label="工单号" min-width="180"></el-table-column>
              ...
              <el-table-column prop="planStartDate" label="计划开始日期" min-width="130" />
              <el-table-column prop="planEndDate" label="计划结束日期" min-width="130" />
          ...
          <el-tab-pane label="用料清单" name="annex">
            <JNPF-table ref="dataTable" v-loading="listLoading" :data="materialList">
