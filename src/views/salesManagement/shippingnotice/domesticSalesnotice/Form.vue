            ...
            <el-tab-pane label="订单信息" name="orderInfo">
              ...
              height="700px" style="border: 1px solid #e3e7ee;"> -->
                ...
                <template slot="header">
                  ...
                  <el-table-column prop="customerProductDrawingNo" label="客户产品图号" width="290" show-overflow-tooltip key="16"></el-table-column>
                  ...
                  <el-table-column prop="outboundQuantity" label="已出库数量" width="120" key="7" show-overflow-tooltip>
                  </el-table-column>
                  <el-table-column prop="undeliveredQuantity" label="待出库数量" width="120" key="8" v-if="btnType == 'add' || btnType == 'edit' || btnType == 'copy'" show-overflow-tooltip>
                  </el-table-column>
                  ...
                  <!-- <template slot-scope="scope">
                  <el-input v-model="scope.row.deliveryQuantity" placeholder="请输入数量"
                    :disabled="btnType == 'look' ? true : false" maxlength="11"
                    @input="watchnums(scope.row, scope.$index)" style="width: 135px;">
                  </el-input>
                </template> -->
                  <!-- <el-table-column prop="drawingNo" label="单价(含税)" width="200" v-if="btnType=='look'||btnType=='qrsh'">
              </el-table-column>
              <el-table-column prop="drawingNo" label="金额(含税)" width="200" v-if="btnType=='look'||btnType=='qrsh'">
              </el-table-column>
              <el-table-column prop="drawingNo" label="项号" width="200" v-if="btnType=='look'||btnType=='qrsh'">
              </el-table-column> -->
                  <el-table-column prop="pickingQuantity" label="拣货数量" width="200" key="5" v-if="btnType == 'qrsh'" show-overflow-tooltip>
                  </el-table-column>
                  ...
                  <el-table-column prop="deliveryQuantity" label="换发货数量" width="170" key="28" v-else>
                    <template slot="header">
                  ...
                  <!-- <el-table-column prop="receivedQuantity" label="确认收货数量" width="160" v-if="btnType == 'look'" key="6"
          ...
          <div class="JNPF-common-layout" style="height: 68vh;overflow: auto;">
            ...
            <div class="JNPF-common-layout-center JNPF-flex-main">
              ...
              <div class="JNPF-common-layout-main JNPF-flex-main">
                <JNPF-table v-loading="listLoading" :data="tableDataCustomer" @row-dblclick="seleceCustomer" customKey="JNPFTableKey_339539">
        ...
        <el-dialog title="选择订单" :close-on-click-modal="false" :close-on-press-escape="false" :visible.sync="allProVisible" lock-scroll class="JNPF-dialog JNPF-dialog_center selectPro" width="70%" append-to-body>
          ...
          <div class="JNPF-common-layout" style="height: 68vh;overflow: auto;">
            <div class="JNPF-common-layout-center JNPF-flex-main">
              ...
              <div class="JNPF-common-layout-main JNPF-flex-main">
                <JNPF-table v-loading="listLoading" :data="allproductData" @row-dblclick="seleceCustomerdd" @selection-change="handleSelectionChangeAllPruduct" customKey="JNPFTableKey_382254">
    ...
    init(id, btnType) {
      ...
      if (this.dataForm.id) {
        getQuotationsendlist(this.dataForm.id).then(res => {
          ...
          // if (res.data.notice.province) {
          //   let obj = {
          //     id: res.data.notice.province
          //   }
          //   this.changeProvince(obj)
          // }
          // if (res.data.notice.city) {
          //   let ooo = {
          //     id: res.data.notice.city
          //   }
          //   this.changeCity(ooo)
          // }
