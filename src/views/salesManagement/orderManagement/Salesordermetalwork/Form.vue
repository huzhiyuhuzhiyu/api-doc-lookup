    ...
    <div>
      <div class="JNPF-preview-main org-form">
        <div :class="['JNPF-common-page-header', btnType == 'look' ? 'noButtons' : '']">
          ...
          <el-page-header @back="goBack" :content="btnType == 'add' ? '新建销售订单' : btnType == 'edit' ? '编辑销售订单' : btnType == 'look' ? '查看销售订单' : '新建销售订单'" />
                ...
                <el-row :gutter="30" class="custom-row">
                  ...
                  <el-col :sm="6" :xs="24">
                    <el-form-item label="订单类型" prop="orderType">
                      <el-select v-model="dataForm.orderType" placeholder="请选择订单类型" clearable style="width: 100%;" :disabled="btnType == 'look' ? true : false" @change="changeOrderType">
                  ...
                  <el-col :sm="6" :xs="24" v-if="btnType == 'look'">
                    <el-form-item label="订单编号" prop="orderNo">
                      <el-input v-model="dataForm.orderNo" placeholder="请输入订单编号" disabled maxlength="300" />
                    </el-form-item>
                  </el-col>
                  <el-col :sm="6" :xs="24">
                    <el-form-item label="所属客户" prop="cooperativePartnerId">
                      <el-input v-model="dataForm.cooperativePartnerName" placeholder="请选择所属客户" readonly @focus="openDialog" :disabled="btnType == 'look' ? true : false">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :sm="6" :xs="24">
                  ...
                  <el-col :sm="6" :xs="24">
                    <el-form-item label="所属销售" prop="salesName">
                      <el-select v-model="dataForm.salesName" placeholder="请选择所属销售人员" clearable style="width: 100%;" :disabled="salesFlag" filterable @change="selectsales">
                  ...
                  <el-col :sm="6" :xs="24">
                    <el-form-item label="来源单号" prop="sourceOrderNo">
                      <el-input v-model="dataForm.sourceOrderNo" placeholder="请输入来源单号" :disabled="btnType == 'look' ? true : false" maxlength="50" />
                    </el-form-item>
                  </el-col>
                  <el-col :sm="6" :xs="24">
                    <el-form-item label="订单日期" prop="orderDate">
                      <el-date-picker v-model="dataForm.orderDate" type="date" value-format="yyyy-MM-dd" style="width: 100%;" :picker-options="pickerOptions" placeholder="请选择订单日期" :disabled="btnType == 'look' ? true : false">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
                  ...
                  <el-col :sm="6" :xs="24">
                    <el-form-item label="客户合同号" prop="contractNo">
                      <el-input v-model="dataForm.contractNo" placeholder="请输入客户合同号" :disabled="btnType == 'look' ? true : false" maxlength="300" />
                      
                    </el-form-item>
                  </el-col>
                  <el-col :sm="6" :xs="24">
                    <el-form-item label="交货日期" prop="deliveryDate">
                      <el-date-picker v-model="dataForm.deliveryDate" type="date" value-format="yyyy-MM-dd" style="width: 100%;" placeholder="请选择交货日期" :disabled="btnType == 'look' ? true : false" @change="changDateFun">
                      </el-date-picker>
                    </el-form-item>
                  </el-col>
<!--             
                  <el-col :sm="6" :xs="24">
                    <el-form-item label="对应车型" prop="vehicleTypeCorrespondingName">

                      <el-select v-model="dataForm.vehicleTypeCorrespondingName" placeholder="请选择对应车型" clearable filterable style="width: 100%;" :disabled="btnType == 'look' ? true : false" @change="selecevehicle">
                        <el-option v-for="(item, index) in bimVehicle" :key="index" :label="item.name" :value="item.id"></el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>  -->
                  <el-col :sm="6" :xs="24" v-if="btnType == 'look'">
                    <el-form-item label="发货完成日期" prop="deliveryCompletionDate">
                      <el-date-picker v-model="dataForm.deliveryCompletionDate" type="date" value-format="yyyy-MM-dd" :disabled="btnType == 'look' ? true : false" style="width: 100%;" :picker-options="pickerOptions" placeholder="请选择发货完成日期">
                      </el-date-picker>
                    </el-form-item>
                  </el-col> 
                  <!-- <el-col :sm="6" :xs="24">
                    <el-form-item label="发货方式" prop="delivery">
                      <el-select v-model="dataForm.delivery" placeholder="请选择发货方式" :disabled="btnType == 'look' ? true : false" style="width: 100%;">
                  ...
                  <el-col :sm="6" :xs="24" v-if="btnType == 'look'">
                    <el-form-item label="发货单号" prop="deliveryNoteNumber">
                      <el-input v-model="dataForm.deliveryNoteNumber" placeholder="请输入发货单号" :disabled="btnType == 'look' ? true : false" maxlength="300" />
                    </el-form-item>
                  </el-col>

                  <!-- <el-col :sm="6" :xs="24">
                    <el-form-item label="收件人" prop="recipient">
                      <el-input v-model="dataForm.recipient" readonly placeholder="请输入收件人" :disabled="btnType == 'look' ? true : false" maxlength="20" />
                    </el-form-item>
                  </el-col>
                  <el-col :sm="6" :xs="24">
                    <el-form-item label="收件人电话" prop="phone">
                      <el-input v-model="dataForm.phone" readonly placeholder="请输入收件人电话" :disabled="btnType == 'look' ? true : false" maxlength="20" />
                    </el-form-item>
                  </el-col> -->
                  ...
                  <el-col :sm="6" :xs="24" v-if="btnType == 'look'">
                    <el-form-item label="订单状态" prop="orderState">
                      <el-select v-model="dataForm.orderState" placeholder="请选择订单状态" style="width: 100%;" :disabled="btnType == 'look' ? true : false">
                        <el-option v-for="item in orderStateList" size="small" :key="item.id" :label="item.label" :value="item.value">
                        </el-option>
                      </el-select>
                    </el-form-item>
                  </el-col>
                  ...
                  <el-col :sm="6" :xs="24" v-if="btnType != 'look'">
                    <el-form-item label="套数" prop="coverNum">
                      <el-input v-model="coverNum" placeholder="请输入套数" :disabled="btnType == 'look' ? true : false" maxlength="4" oninput="value = value.replace(/[^0-9]/g,'')">
                        <template slot="append">
                          <div v-if="btnType != 'look'" :key="Math.random()">
                            <el-button type="primary" :disabled="btnType == 'look' ? true : false" @click="computeWatch()">计算</el-button>
                          </div>
                  ...
                  <el-col :sm="6" :xs="24" v-if="btnType == 'look'">
                    <el-form-item label="含税总金额" prop="totalAmount">
                      <el-input v-model="dataForm.totalAmount" placeholder="请输入含税总金额" :disabled="btnType == 'look' ? true : false" />
                    </el-form-item>
                  </el-col>
                  <el-col :sm="6" :xs="24" v-if="btnType == 'look'">
                    <el-form-item label="不含税总金额" prop="excludingTaxTotalAmount">
                      <el-input v-model="dataForm.excludingTaxTotalAmount" placeholder="请输入不含税总金额" :disabled="btnType == 'look' ? true : false" />
                    </el-form-item>
                  </el-col>
                  <el-col :sm="6" :xs="24" v-if="btnType == 'look'">
                    <el-form-item label="税额" prop="taxAmount">
                      <el-input v-model="dataForm.taxAmount" placeholder="请输入税额" :disabled="btnType == 'look' ? true : false" />
                    </el-form-item>
                  </el-col>
                  ...
                  <el-col :sm="6" :xs="24" v-if="btnType == 'look'">
                    <el-form-item label="变更次数" prop="changesCount">
                      <el-input v-model="dataForm.changesCount" placeholder="请输入变更次数" :disabled="btnType == 'look' ? true : false" maxlength="4" />
                    </el-form-item>
                  </el-col>
                  <!-- <el-col :sm="12" :xs="24">
                    <el-form-item label="收货地址" prop="address">
                      <template slot="label">
                        <span>收货地址</span>
                        <span>>></span>
                        <el-button :disabled="btnType == 'look'" type="text" @click="changeAddress">更换收货地址</el-button>
                      </template>
                      <el-input v-model="defaultAddress" readonly :disabled="btnType == 'look'" type="textarea" maxlength="50" :rows="2" />
                    </el-form-item>
                  </el-col> -->
                  <el-col :sm="12" :xs="24">
              ...
              <div style="line-height:33px;font-size:18px;border-bottom:1px solid #dcdfe6;background: #fafafa;padding-left:5px;" ref="box">
                <h5>产品信息</h5>
              </div>
              <div v-if="btnType !== 'look'">
                ...
                <el-button type="text" style="margin-right:8px;margin-left:8px font-size:14px!important" icon="el-icon-plus" :disabled="btnType == 'look' ? true : false" @click="importProductFun()" v-if="dataForm.orderType == 'normal' || dataForm.orderType == 'urgent'">导入产品 |</el-button>
                <el-button type="text" style="margin-right:8px;margin-left:8px font-size:14px!important" icon="el-icon-plus" :disabled="btnType == 'look' ? true : false" @click="downLoadTemplate()" v-if="dataForm.orderType == 'normal' || dataForm.orderType == 'urgent'">下载导入模板 |</el-button>
              ...
              <div style="height: 530px;display:flex;" ref="boxresiz" v-if="btnType=='look'">
                <vue-draggable-resizable :w="width||1" :h="height" @resizing="handleResize" class-name="dragging1" axis="y" :parent="true" :handles="['mr']">
                  <el-table ref="product" :data="productData" :fixedNO="true" @selection-change="handeleProductInfoData" @row-click="rowclick" border height="100%" style="width: 100%;" :key="1">
                    ...
                    <el-table-column prop="availableQuantity" label="可用库存(主)" width="200" :key="121" v-if="btnType != 'look'"></el-table-column>
                    <el-table-column prop="shipmentStatus" label="发货状态" width="120" :key="67">
                      <template slot-scope="scope">
                        <div v-if="scope.row.shipmentStatus == 'not_finish'"> <el-tag type="warning">未完成</el-tag> </div>
                    ...
                    <el-table-column prop="num" label="数量(主)" width="200" :key="7">
                      ...
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.num" :disabled="btnType == 'look' ? true : false" @input="watchNum(scope.row, scope.$index)" placeholder="请输入数量(主)" @blur="checkNum(scope.row, scope.$index)">{{
                      scope.row.productName }}
                        </el-input>
                      </template>
                    </el-table-column>
                    <el-table-column prop="mainUnit" label="单位(主)" width="200" :key="8" />
                    <el-table-column prop="deputyAvailableQuantity" label="可用库存(副)" width="200" :key="122" v-if="btnType != 'look'"></el-table-column>
                    ...
                    <el-table-column prop="deliveryDate" label="交货日期" width="200" :key="13">
                      ...
                      <template slot-scope="scope">
                        <el-date-picker v-model="scope.row.deliveryDate" type="date" value-format="yyyy-MM-dd" :disabled="btnType == 'look' ? true : false" style="width: 100%;" placeholder="请选择交货日期">
                        </el-date-picker>
                      </template>
                    </el-table-column>
                    <el-table-column prop="ask" label="要求" width="160" :key="14">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.ask" placeholder="请输入要求" :disabled="btnType == 'look' ? true : false" maxlength="3000" />
                      </template>
                    </el-table-column>

                    <!-- 列表中显示的自定义属性 -->
                    <el-table-column v-for="item in customList" :key="item.prop" :prop="item.prop" :label="item.label" min-width="180" :formatter="filterateLabel" />
                    <el-table-column prop="remark" label="备注1" width="200" :key="1">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.remark" placeholder="请输入备注1" :disabled="btnType == 'look' ? true : false" maxlength="200" />
                      </template>
                    </el-table-column>
                    <el-table-column prop="remark2" label="备注2" width="200" :key="111">
                      <template slot-scope="scope">
                        <el-input v-model="scope.row.remark2" placeholder="请输入备注2" :disabled="btnType == 'look' ? true : false" maxlength="200" />
                      </template>
                    </el-table-column>
                ...
                <vue-draggable-resizable :w="width1||1" :h="height" class-name="dragging2" :x="10" :draggable="false" :parent="true" :resizable="false">
                  <el-table v-bind="dataFormTwo.data" :data="dataFormTwo.data" size='mini' border id="table" style="width: 100%" height="100%" v-loading="bomLoading">
              ...
              <el-table ref="product" v-else :data="productData" :fixedNO="true" @selection-change="handeleProductInfoData" @row-click="rowclick" border height="660" :key="1">
                <el-table-column type="selection" width="55" fixed="left" v-if="btnType != 'look'" :key="2">
                </el-table-column>
                <el-table-column type="index" width="60" fixed="left" label="序号" :key="10">
                </el-table-column>
            ...
            <el-tab-pane label="进度跟踪" name="schedule" v-if="btnType === 'look'" ref="orderInfos">
              <el-row class="JNPF-common-search-box" :gutter="16">
                <el-form @submit.native.prevent>
                  ...
                  <el-col :span="4">
                    <el-form-item>
                      <el-input v-model.trim="scheduleForm.productsCode" placeholder="请输入产品编码" clearable @keyup.enter.native="searchDetail()" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="4">
                    <el-form-item>
                      <el-input v-model.trim="scheduleForm.productsName" placeholder="请输入产品名称" clearable @keyup.enter.native="searchDetail()" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="4">
                    <el-form-item>
                      <el-input v-model.trim="scheduleForm.productsDrawingNo" placeholder="请输入产品图号" clearable @keyup.enter.native="searchDetail()" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="6">
                    <el-form-item>
              ...
              <JNPF-table :data="scheduleData" custom-column ref="scheduleRef" :style="{height:customStyleData+'px'}">
                ...
                <el-table-column prop="deliverSchedule" label="发货进度" min-width="160">
                  <template slot-scope="scope">
                    <el-progress :percentage="Number((scope.row.outboundQuantity / scope.row.num * 100).toFixed(2))||0"></el-progress>
                  </template>
                </el-table-column>
              ...
              <pagination :total="total" :page.sync="scheduleForm.pageNum" :background="background" :limit.sync="scheduleForm.pageSize" @pagination="searchDetail" />
              <ExportForm v-if="exportFormVisible" ref="exportForm" @download="download" />
              <!-- <el-dialog title="更多查询" :close-on-click-modal="false" :close-on-press-escape="false" :modal-append-to-body="false" :visible.sync="visible" lock-scroll class="JNPF-dialog JNPF-dialog_center" width="1000px">
                <el-row :gutter="20">
                  <el-form ref="diaForm" :model="scheduleForm" label-width="120px" label-position="top">
                    <el-col :span="12">
                      <el-form-item label="客户物料号">
                        <el-input v-model.trim="scheduleForm.customerProductNo" placeholder="请输入客户物料号" clearable @keyup.enter.native="searchDetail()" />
                      </el-form-item>
                    </el-col>

                    <el-col :span="12">
                      <el-form-item label="客户图号">
                        <el-input v-model.trim="scheduleForm.customerProductDrawingNo" placeholder="请输入客户图号" clearable @keyup.enter.native="searchDetail()" />
                      </el-form-item>
                    </el-col>
                    <el-col :span="12">
        ...
        <el-dialog title="选择产品" :close-on-click-modal="false" :close-on-press-escape="false" :visible.sync="allProVisible" lock-scroll class="JNPF-dialog JNPF-dialog_center selectPro" width="70%" append-to-body>
          ...
          <div class="JNPF-common-layout" style="height: 68vh;overflow: auto;">
            ...
            <div class="JNPF-common-layout-center JNPF-flex-main">
              ...
              <div class="JNPF-common-layout-main JNPF-flex-main">
                <JNPF-table v-loading="listLoading" :data="allproductData" @selection-change="handleSelectionChangeAllPruduct" ref="dataTable" @row-click="handleRowClick" hasC>
        ...
        <ComSelect-page ref="comSelect-page" @change="submitCustomerProduct" :tableItems="ProductTableItems" dialogTitle="选择产品" :listMethod="getcooperativeProduct" :listRequestObj="ProductListRequestObjs" :searchList="ProductTableSearchList" :elementShow="false" :multiple="true" :renderTree="false" />
...
import { getOrderDetail, addOrders, editOrders, getcategoryTrees, getAttributeline, getcooperativeProduct, getCopyOrders, getWorkOrderNo, uploadProduct, uploadmetalworkProduct } from '@/api/salesManagement/assemblyOrders'
import { getCounryData, getCooperativeInfo, getCooperativeData, getBimVehicleTypeData, getscheduleList } from '@/api/basicData/index'
...
export default {
  ...
  computed: {
    ...
    totalAssistantNum: function () {
      ...
      for (var i = 0; i < this.productData.length; i++) {
        console.log("this.productData[i].assistantNum]", this.productData[i].assistantNum);
  ...
  methods: {
    ...
    UploadProduct(data) {
      ...
      //调用上传文件接口
      uploadmetalworkProduct(formData).then(res => {
    ...
    downLoadTemplate() {
      ...
      a.setAttribute('href', location.origin + '/static/销售订单导入模板 (金工).xlsx')
      a.click()
    },
