    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" highlight-current-row fixedNO ref="tableForm" :data="tableData"
          @sort-change="sortChange" show-summary :summary-method="getSummaries" customKey="JNPFTableKey_686197">
...
<script>
import { getSaleDeliveryList, exportSaleDeliveryData } from '@/api/reportAnalysis/saleReport.js'
...
export default {
  ...
  methods: {
    initData() {
      ...
      getSaleDeliveryList(this.listQuery).then(res => {
    ...
    exportForm() {
      ...
      exportSaleDeliveryData(this.exportListQuery).then(res => {
