        ...
        <el-tab-pane label="通知单列表" name="orderList">
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" :fixedNO="true" @sort-change="sortChange" custom-column @selection-change="handleSelectionChange" hasC :checkSelectable="checkSelectable" customKey="JNPFTableKey_958443">
        ...
        <el-tab-pane label="明细列表" name="detailList">
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
              ...
              <JNPF-table ref="linesTableData" :data="linesTableData" :fixedNO="true" custom-column @sort-change="sortChange" :partentOrChild="'child'">
                ...
                <el-table-column label="操作" width="180" fixed="right">
                  <template slot-scope="scope">
                    ...
                    <el-dropdown hide-on-click>
                      ...
                      <el-dropdown-menu slot="dropdown">
                        <!-- <el-dropdown-item @click.native="confirmreceipt(scope.row.returnDeliveryNoticeId, 'qrsh')"
                          v-if="scope.row.deliveryStatus == 'delivered' && scope.row.approvalStatus == 'ok' && scope.row.fullReceiptFlag == 0">
                          确认收货
                        </el-dropdown-item> -->
        ...
        <el-form ref="diaForm" :model="orderForm" label-width="120px" label-position="top">
          ...
          <el-col :span="12">
            <el-form-item label="发货完成日期">
              <el-date-picker v-model="deliveryDateArr" type="datetimerange" :default-time="['00:00:00', '23:59:59']" value-format="yyyy-MM-dd HH:mm:ss" style="width: 100%;" start-placeholder="开始时间" end-placeholder="结束时间">
              </el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
