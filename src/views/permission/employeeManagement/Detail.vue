    ...
    <div class="JNPF-preview-main user-form">
      <div class="JNPF-common-page-header">
        <el-page-header @back="goBack"
          :content="!dataForm.id ?$t(`user.addUser`) : '查看信息'" />
        <div class="options">
          <el-button type="primary" :loading="btnLoading" @click="changeEdit()">打开编辑</el-button>
          ...
          <el-row :gutter="20" class="custom-row">
            <el-col :sm="12" :xs="24">
              <el-form-item label="账户" prop="account">
                <el-input v-model="dataForm.account" disabled :readonly="!!dataForm.id" />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="所属组织" prop="organizeIdTree">
                <ComSelect v-model="dataForm.organizeIdTree" disabled multiple
                  @change="onOrganizeChange" clearable auth />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="直属主管" prop="managerId">
                <user-select v-model="dataForm.managerId" disabled />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="岗位" prop="positionId">
                <el-select v-model="positionId" disabled @change="onChange('positionId')"
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="角色" prop="roleId">
                <el-select v-model="roleId" disabled @change="onChange('roleId')"
                  @visible-change="visibleChange" multiple filterable clearable>
            ...
            <el-col :span="12">
              <el-form-item label="状态" prop="enabledMark">
                <el-select v-model="dataForm.enabledMark" disabled>
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="员工类型" prop="email">
                <el-input v-model="dataForm.email" disabled />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="员工状态" prop="email">
                <el-input v-model="dataForm.email" disabled />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="离职时间" prop="email">
                <el-input v-model="dataForm.email" disabled />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="婚姻状况" prop="email">
                <el-input v-model="dataForm.email" disabled />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="合同开始日期" prop="email">
                <el-input v-model="dataForm.email" disabled />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="合同结束日期" prop="email">
                <el-input v-model="dataForm.email" disabled />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="社保起交时间" prop="email">
                <el-input v-model="dataForm.email" disabled />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="社保断交时间" prop="email">
                <el-input v-model="dataForm.email" disabled />
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="说明" prop="description">
                <el-input v-model="dataForm.description" type="textarea" :rows="3" disabled />
              </el-form-item>
            </el-col>
          </el-row>
          <div class="JNPF-common-title mb-20">
          ...
          <el-row :gutter="20" class="custom-row">
            <el-col :span="24">
              <el-form-item label="头像" prop="headIcon">
                <el-upload class="avatar-uploader" :headers="uploadHeaders" disabled
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="民族" prop="nation">
                <el-select v-model="dataForm.nation" disabled filterable>
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="籍贯" prop="nativePlace">
                <el-input v-model="dataForm.nativePlace" disabled />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="证件类型" prop="certificatesType">
                <el-select v-model="dataForm.certificatesType" disabled>
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="入职时间" prop="entryDate">
                <el-date-picker v-model="dataForm.entryDate" type="date" disabled
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="证件号码" prop="certificatesNumber">
                <el-input v-model="dataForm.certificatesNumber" disabled />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="文化程度" prop="education">
                <el-select v-model="dataForm.education" disabled>
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="出生年月" prop="birthday">
                <el-date-picker v-model="dataForm.birthday" type="date" disabled
                  value-format="timestamp">
                </el-date-picker>
              </el-form-item>
            </el-col>
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="办公座机" prop="landline">
                <el-input v-model="dataForm.landline" disabled />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
            ...
            <el-col :sm="12" :xs="24">
              <el-form-item label="紧急联系" prop="urgentContacts">
                <el-input v-model="dataForm.urgentContacts" disabled />
              </el-form-item>
            </el-col>
            <el-col :sm="12" :xs="24">
              <el-form-item label="紧急电话" prop="urgentTelePhone">
                <el-input v-model="dataForm.urgentTelePhone" disabled />
              </el-form-item>
            </el-col>
            <el-col :span="24">
              <el-form-item label="通讯地址" prop="postalAddress">
                <el-input v-model="dataForm.postalAddress" type="textarea" :rows="3" disabled />
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
