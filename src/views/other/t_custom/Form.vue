...
<el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px" label-position="right" >
 ...
 prop="type" >
                    <el-input-number   v-model="dataForm.type"
 ...
 prop="templedata" >
                    <el-input   v-model="dataForm.templedata"
            ...
            init(id) {
                ...
                this.$nextTick(() => {
                    ...
                    if(this.dataForm.id){
                        this.loading = true
                        request({
                            url: '/api/os.jx/T_custom/'+this.dataForm.id,
                            method: 'get'
                        }).then(res => {
