    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      <div class="JNPF-common-layout-center JNPF-flex-main">
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
          ...
          <JNPF-table ref="dataTable" @selection-change="handeleProductInfoData" hasC  :data="tableData" :fixedNO="true"  v-if="isProjectSwitchFlag" custom-column
            :setColumnDisplayList="columnList" customKey="JNPFTableKey_852046" show-summary :summary-method="getSummaries" :listQuery="orderForm" @queryChange="initData" :queryJson="superQueryJson">
            ...
            <el-table-column prop="productionWeight" label="生产重量" min-width="170" />
            <el-table-column prop="aperture" label="板数" min-width="120" v-if="this.isBOOS"/>
           <el-table-column prop="plateNumber" label="每板个数" min-width="120"   v-if="this.isBOOS" />
            <el-table-column prop="totalWeight" label="总重量" min-width="120" v-if="this.isBOOS" />
            <el-table-column prop="trayTotalWeight" label="托盘重量" min-width="120" v-if="this.isBOOS" />
            <el-table-column prop="cases" label="箱数" min-width="120" v-if="this.isBOOS" />
            <el-table-column prop="bagNumber" label="袋子个数" min-width="120" v-if="this.isBOOS" />
            <el-table-column prop="bagWeight" label="袋子重量" min-width="120" v-if="this.isBOOS" />
            <el-table-column prop="productWeight" label="产品单重" min-width="120" v-if="this.isBOOS" />
