  ...
  <div class="JNPF-common-layout">
    <div class="JNPF-common-layout-center JNPF-flex-main">
      <el-tabs v-model="activeName">
        <el-tab-pane label="外协收货单" name="dataTable">
          <div class="JNPF-common-layout-center JNPF-flex-main">
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <JNPF-table ref="linesTableData" v-loading="listLoading" :data="linesTableData" :fixedNO="true"
                ...
                <el-table-column prop="orderNo" label="收货单号" min-width="200" sortable="custom" fixed="left">
                  <template slot-scope="scope">
                ...
                <el-table-column prop="partnerName" label="供应商名称" fixed="left" width="160" sortable="custom" />
  ...
  methods: {
    ...
    addOrUpdateHandle(id, readOnly) {
      if (readOnly) {
        ...
        this.$nextTick(() => { this.$refs.Form.init(id, readOnly, 'external', 'notice') })
      }
    },
    sortChange({ prop, order }) {
      ...
      if (this.activeName === 'dataTable') {
        ...
        if (['orderNo', 'partnerName', 'productName', 'productDrawingNo', 'createTime'].includes(prop)) { newProp = prop }
        else { newProp = prop.replace(/[A-Z]/g, match => '_' + match.toLowerCase()); }
