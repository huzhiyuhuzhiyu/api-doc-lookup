  ...
  data() {
    return {
      ...
      tableItems: [
        ...
        { prop: 'initPaymentAmount', label: '期初应收金额', minWidth: '142', sortable: true },
        { prop: 'currentBillingAmount', label: '本期开票金额', minWidth: '142', sortable: true },
        { prop: 'currentInboundOutboundAmount', label: '本期出库金额', minWidth: '142', sortable: true },
        { prop: 'duePaymentAmount', label: '到期应收金额', minWidth: '142', sortable: true },
        { prop: 'currentActualAmount', label: '本期实收金额', minWidth: '142', sortable: true },
        { prop: 'overduePaymentAmount', label: '逾期收款金额', minWidth: '142', sortable: true },
        { prop: 'endPaymentAmount', label: '期末应收金额', minWidth: '142', sortable: true },
      ],
      searchList: [
