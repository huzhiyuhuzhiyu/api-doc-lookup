        ...
        <div class="JNPF-common-layout-center">
            <el-row class="JNPF-common-search-box" :gutter="16">
                <el-form @submit.native.prevent>
                    <el-col :span="4">
                        <el-form-item>
                            <el-input width="200" v-model="listQuery.realName" placeholder="请输入姓名" clearable
                    ...
                    <el-col :span="6">
                        <el-form-item>
                            <el-date-picker v-model="listQuery.changeDate" type="daterange" value-format="yyyy-MM-dd"
                                style="width: 100%;" start-placeholder="调动开始日期" end-placeholder="调动结束日期">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                ...
                <JNPF-table v-loading="listLoading" :data="dataList" @sort-change="sortChange" custom-column fixedNO
                    ref="dataTable" customKey="JNPFTableKey_925296">
                    <el-table-column prop="realName" label="姓名" width="140" fixed="left" sortable="custom" />
                    <el-table-column prop="departmentName" label="原部门" min-width="200" />
                    <el-table-column prop="postName" label="原岗位" width="200" />
                    <el-table-column prop="departmentName2" label="现部门" min-width="200" />
                    <el-table-column prop="postName2" label="现岗位" width="200" />
                    <el-table-column prop="changeDate" label="调动日期" :formatter="jnpf.tableDateFormatDay" width="140"
                        sortable="custom" />
...
<script>
import { getTransferData } from "@/api/basicData/personnelManagement"
...
export default {
    ...
    methods: {
        ...
        initData() {
            ...
            getTransferData(this.listQuery).then(res => {
