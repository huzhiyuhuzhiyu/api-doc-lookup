<template>
  <el-dialog title="选择外协供应商" :close-on-click-modal="false" :close-on-press-escape="false" :visible.sync="customerVisible"
      ...
      <div class="JNPF-common-layout-center JNPF-flex-main">
        <el-row class="JNPF-common-search-box" :gutter="16">
          <el-form @submit.native.prevent>
            ...
            <el-col :span="6">
              <el-form-item>
                <el-input v-model="form.name" placeholder="请输入外协供应商名称" clearable />
              </el-form-item>
            </el-col>
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main">
          <JNPF-table v-loading="listLoading" :data="tableDataCustomer">
            <el-table-column prop="code" label="外协供应商编码" show-overflow-tooltip></el-table-column>
            <el-table-column prop="name" label="外协供应商名称" />
...
export default {
  ...
  methods: {
    ...
    seleceCustomer(e) {
      ...
      this.selectArr = e
      if (this.CooperativeData.length) {

        this.$confirm('已选择过外协供应商，是否切换，切换后会清空外协订单和产品信息是否继续!', '提示', {
