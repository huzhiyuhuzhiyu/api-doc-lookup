        ...
        <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                ...
                <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" @sort-change="sortChange" fixedNO
                    ...
                    <el-table-column prop="maintenanceDuration" label="维修时长" width="200"
                        sortable="custom"></el-table-column>
                    ...
                    <el-table-column label="操作" width="180" fixed="right">
                        <template slot-scope="scope">
                            <el-button size="mini" type="text" :disabled="scope.row.state != 'toBeMaintain'"
                                @click="addOrUpdateHandle(scope.row.id, 'edit')">编辑</el-button>
                            <el-button size="mini" type="text" class="JNPF-table-delBtn" :disabled="scope.row.state === 'maintaining'"
                            ...
                            <el-dropdown hide-on-click>
                                ...
                                <el-dropdown-menu slot="dropdown">
                                    <el-dropdown-item @click.native="handleUserRelation(scope.row.id, 'start')"
                                        :disabled="scope.row.state != 'toBeMaintain'">
                                        开始维修
                                    </el-dropdown-item>
                                    <el-dropdown-item @click.native="handleUserRelation(scope.row.id, 'end')"
                                        :disabled="scope.row.state != 'maintaining'">
                                        完成维修
                                    </el-dropdown-item>
                    ...
                    <el-col :span="12">
                        <el-form-item label="申请日期">
                            <el-date-picker v-model="orderDateArr" type="daterange" value-format="yyyy-MM-dd"
                                style="width: 100%;" start-placeholder="请选择申请开始日期" end-placeholder="请选择申请结束日期" clearable>
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="故障开始时间">
                            <el-date-picker v-model="faultStartTime" type="datetimerange" value-format="yyyy-MM-dd HH:mm:ss"
                                start-placeholder="请选择故障开始时间" end-placeholder="请选择故障结束时间" style="width: 100%;"
