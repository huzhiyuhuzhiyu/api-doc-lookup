        ...
        <el-row :gutter="15" class="">
            <el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="120px"
                ...
                <template v-if="!loading">
                    ...
                    <popupSelect v-model="dataForm.mrpWorkshopId" placeholder="请选择" clearable field="mrpWorkshopId"
                      interfaceId="339744098799848005" :columnOptions="mrpWorkshopIdcolumnOptions" propsValue="F_Id"
