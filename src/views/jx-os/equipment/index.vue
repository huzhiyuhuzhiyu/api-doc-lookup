  ...
  <div class="JNPF-common-layout">
    <div class="JNPF-common-layout-left">
      ...
      <el-tree :data="treeData" :props="treeProps" default-expand-all highlight-current ref="treeBox"
        :expand-on-click-node="false" @node-click="handleNodeClick" class="JNPF-common-el-tree" node-key="id">
    ...
    <div class="JNPF-common-layout-center">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="list" @sort-change='sortChange' :span-method="arraySpanMethod" custom-column>
          <el-table-column prop="name_name" label="设备名称" align="left" />
          <el-table-column prop="code_name" label="设备编号" align="left" />
          <el-table-column prop="categoryId_name" label="设备分类" align="left" />
          <el-table-column prop="purchaseDate_name" label="购置日期" align="left" />
          <el-table-column prop="effectiveDate_name" label="启用日期" align="left" />
          <el-table-column prop="note_name" label="说明" align="left" />
  ...
  export default {
    ...
    data() {
      return {
        ...
        tableField205_productIdcolumnOptions: [{
          "label": "编号",
          "value": "code"
        }, {
          "label": "名称",
        ...
        tableField220_equimentMaintainTypeIdcolumnOptions: [{
          "label": "保养名称",
          "value": "name"
        }, {
          "label": "保养内容",
        ...
        tableField220_frequencyTypeOptions: [{
          "fullName": "天数",
          "id": "1"
        }, {
          "fullName": "次数",
    ...
    methods: {
      ...
      initData() {
        ...
        request({
          url: `/api/equipment/Equipment/getList`,
          method: 'post',
          data: _query
        }).then(res => {
          var _list = [];
