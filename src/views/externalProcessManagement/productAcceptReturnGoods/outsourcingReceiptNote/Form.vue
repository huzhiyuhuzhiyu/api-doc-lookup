      ...
      <div class="JNPF-preview-main org-form">
        <div :class="['JNPF-common-page-header', type === 'look' ? 'noButtons' : '']">
          <el-page-header @back="goBack"
            :content="type == 'add' ? '新建外协收货通知单' : type == 'edit' ? '编辑外协收货通知单' : type == 'look' ? '查看外协收货通知单' : '新建外协收货通知单'" />
            ...
            <el-tab-pane label="基础信息" name="jcInfo">
              ...
              <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm">
                <el-table style="border: 1px solid #e3e7ee;" hasNO fixedNO v-bind="dataFormTwo.data"
                  ...
                  <el-table-column prop="productCode" label="产品编码" min-width="160" fixed="left" show-overflow-tooltip>
                  ...
                  <el-table-column prop="productDrawingNo" label="产品图号" min-width="200" fixed="left" show-overflow-tooltip>
                    <template slot-scope="scope">
                  ...
                  <el-table-column prop="mainUnit" label="单位(主)" min-width="120" show-overflow-tooltip>
                    <template slot-scope="scope">
                  ...
                  <el-table-column prop="receiptQuantity" label="已入库数量" min-width="180">
                    <template slot-scope="scope">
                  ...
                  <el-table-column prop="receivedQuantity" label="收货数量" min-width="180">
                    <template slot="header">
                  ...
                  <el-table-column prop="receivingStatus" label="收货状态" width="130" v-if="type === 'look'">
                    <template slot-scope="scope">
