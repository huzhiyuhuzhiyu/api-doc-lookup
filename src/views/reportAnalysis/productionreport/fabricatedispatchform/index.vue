  ...
  <div class="JNPF-common-layout">
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <JNPF-table ref="dataTable" show-summary :summary-method="getSummaries" v-loading="listLoading" :data="tableData" custom-column :fixedNO="true" customKey="JNPFTableKey_827338">
          ...
          <el-table-column prop="shipmentFlag" label="已发料" min-width="100">
            <template slot-scope="scope">
              <div v-if="scope.row.shipmentFlag=='1'">是</div>
              <div v-else-if="scope.row.shipmentFlag=='0'">否</div>
            </template>
          </el-table-column>
