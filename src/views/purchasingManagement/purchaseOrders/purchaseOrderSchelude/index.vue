          ...
          <JNPF-table @selection-change="handeleFinshData" hasC v-if="flag" v-loading="listLoading"
            ...
            <el-table-column prop="orderNo" label="采购单号" min-width="200" sortable="custom">
              <template slot-scope="scope">
                <el-link type="primary" @click.native="addOrUpdateHandle(scope.row.id)">
                  {{ scope.row.orderNo }}
                </el-link>
              </template>
            </el-table-column>
            ...
            <el-table-column label="操作" width="180" fixed="right">
              <template slot-scope="scope">
                ...
                <el-button size="mini" type="text" @click.native="addOrUpdateHandle(scope.row.id)">
                  查看进度
                </el-button>
