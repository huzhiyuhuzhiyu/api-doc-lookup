...
export default () => [
  {
    ...
    tabName: "基本信息",
    tabContent: [
      { prop: "project", label: "所属项目", value: "", type: 'select', itemRules: [{ required: true, trigger: "blur" }],options: [], filterable: true, render: true, itemDisabled: false },
      ...
      { prop: "deputyUnit", label: "副单位", value: "", type: 'select', itemRules: [{ required: true, trigger: "blur" }], options: [], filterable: true },
      ...
      { prop: "productSource", label: "产品来源", value: "", type: "select", options: [{ label: "组装", value: "assemble" }, { label: "生产", value: "produce" }, { label: "采购", value: "purchase" }, { label: "外协", value: "out" }], itemRules: [{ required: true, trigger: "change" }], itemDisabled: false },
