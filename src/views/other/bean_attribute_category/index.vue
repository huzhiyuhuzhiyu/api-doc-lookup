<template>
    ...
    <div class="JNPF-common-layout">
        <div class="JNPF-common-layout-left">
            ...
            <el-tree :data="treeData" :props="treeProps" highlight-current ref="treeBox"
                :default-expand-all="expandsTree" v-if="refreshTree" :expand-on-click-node="false"
                @node-click="handleNodeClick" class="JNPF-common-el-tree" node-key="F_Id">
        ...
        <div class="JNPF-common-layout-center">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                ...
                <JNPF-table v-loading="listLoading" :data="list" @sort-change='sortChange'
                    :span-method="arraySpanMethod" customKey="JNPFTableKey_819378">
                    <el-table-column prop="name_name" label="名称" align="left" />
                    <el-table-column prop="content_name" label="字段" align="left" />
                    <el-table-column label="描述" prop="description" algin="left">
                        <template slot-scope="scope">
                            {{ scope.row.description | dynamicText(descriptionOptions) }}
                        </template>
                    </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            initData() {
                ...
                request({
                    url: `/api/jx/Bean_attribute_category/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list = [];
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/jx/Bean_attribute_category/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            addOrUpdateHandle(id, isDetail) {
                ...
                this.$nextTick(() => {
                    this.$refs.JNPFForm.init(id, this.propTreeData, isDetail)
                })
            },
            exportData() {
            ...
            download(data) {
                ...
                request({
                    url: `/api/jx/Bean_attribute_category/Actions/Export`,
                    method: 'post',
                    data: query
                }).then(res => {
