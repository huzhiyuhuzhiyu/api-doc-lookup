              ...
              <div class="JNPF-common-layout-center JNPF-flex-main" v-loading="listLoading">
                <el-row class="JNPF-common-search-box" :gutter="16">
                  <el-form @submit.native.prevent>
                    ...
                    <el-col :span="4">
                      <el-form-item>
                        <el-select v-model="listQuerysbtz.state" filterable placeholder="请选择工具状态" clearable>
                ...
                <div style="height: 835px;" class="JNPF-flex-main">
                  <JNPF-table ref="dataTable" v-if="istable" :data="tableDatasbtz" @sort-change="sortChangesbtz" fixedNO custom-column customKey="JNPFTableKey_224514">
          ...
          <el-tab-pane label="检定分布" name="djfb">
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <div style="height: 500px;" class="JNPF-flex-main">
                <JNPF-table ref="dataTabledjfb" v-loading="listLoadingdjfb" :data="tableDatadjfb" @sort-change="sortChangedjfb" fixedNO custom-column customKey="JNPFTableKey_501384">
          ...
          <el-tab-pane label="维修分布" name="wxfb">
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <div class="vux-flexbox container-content vux-flex-row">
                ...
                <div class="right-content-dj JNPF-flex-main dash-container has-hover" v-loading="listLoadingwxfbcl">
                  ...
                  <div style="height: 320px;padding: 0 10px 10px 10px;" class="JNPF-flex-main">
                    <JNPF-table v-if="istable" :data="tableDatawxfbcl" @sort-change="sortChangewxfbcl" fixedNO custom-column customKey="JNPFTableKey_290341">
              ...
              <div style="height: 500px;" class="JNPF-flex-main" v-loading="listLoadingwxfb">
                <JNPF-table ref="dataTablewxfb" v-if="istable" :data="tableDatawxfb" @sort-change="sortChangewxfb" fixedNO custom-column customKey="JNPFTableKey_868829">
                  <el-table-column prop="maintenanceNo" label="维修单号" min-width="200" sortable="custom">
                  </el-table-column>
                  <el-table-column prop="equipmentIdCode" label="工具编码" min-width="200" sortable="custom" />
                  <el-table-column prop="equipmentIdName" label="工具名称" min-width="200" sortable="custom"></el-table-column>
          ...
          <el-tab-pane label="保养分布" name="byfb">
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <div style="height: 652px;" class="JNPF-flex-main" v-loading="listLoadingbyfb">
                <JNPF-table ref="dataTablebyfb" v-if="istable" :data="tableDatabyfb" @sort-change="sortChangebyfb" fixedNO custom-column customKey="JNPFTableKey_351273">
  ...
  data() {
    return {
      ...
      flexlist: [
        ...
        {
          list: [
            { label: '工具动态看板', title: '正常工具', id: 'equNum', value: '0', icon: require('./imgs/sbdt.png'), path: '/toolclampmeasuring/deviceReportanaly/dynamicanalysis' },
            { label: '检定统计看板', title: '已检定', id: 'totalInspectionNum', value: '0', icon: require('./imgs/djtj.png'), path: '/toolclampmeasuring/deviceReportanaly/pointCheckStatisticalAnalysis' },
            // { label: '巡检统计看板', icon: require('./imgs/xjtj.png'),path:'/dailyManagement/scrapManagement/announceInvalidated' },
            { label: '维修统计看板', title: '已维修', id: 'totalRepairNum', value: '0', icon: require('./imgs/wxtj.png'), path: '/toolclampmeasuring/deviceReportanaly/maintenanceStatisticalAnalysis' },
            { label: '保养统计看板', title: '已保养', id: 'totalMaintenanceNum', value: '0', icon: require('./imgs/bytj.png'), path: '/toolclampmeasuring/deviceReportanaly/upkeepStatisticalAnalysis' },
