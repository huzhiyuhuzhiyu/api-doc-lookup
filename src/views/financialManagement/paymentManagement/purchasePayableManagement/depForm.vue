            ...
            <el-tab-pane label="基础信息" name="jcInfo">
              ...
              <el-row :gutter="15" class="">
                <el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px"
                  ...
                  <el-col :sm="8" :xs="24">
                    <el-form-item label="对账应付金额" prop="totalReconciliationAmount" ref="totalReconciliationAmount">
                      <el-input v-model="dataForm.totalReconciliationAmount" placeholder="请输入对账应付金额"
                        :disabled="type == 'look' ? true : false">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :sm="8" :xs="24">
                    <el-form-item label="已付款金额" prop="totalPaymentAmount" ref="totalPaymentAmount">
                  ...
                  <el-col :sm="8" :xs="24">
                    <el-form-item label="未付款金额" prop="totalUnpaidAmount" ref="totalUnpaidAmount">
