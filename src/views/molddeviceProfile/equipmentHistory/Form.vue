    ...
    <div class="JNPF-preview-main org-form">
      ...
      <div class="main" ref="main" v-loading="formLoading">
        <el-collapse v-model="activeNames">
          <el-collapse-item title="模具信息" name="basicInfo">
            ...
            <div style="padding-left: 5px;border-bottom: 1px solid #dcdfe6;" ref="radio">
              <el-radio-group v-model="activeName">
                <el-radio-button label="sbxxinfo">模具信息</el-radio-button>
            ...
            <div style="padding: 5px;">
                  ...
                  <el-row :gutter="20" class="custom-row">
                    <el-col :sm="12" :xs="24">
                      <el-form-item label="模具类型" prop="categoryName" ref="comList1">
                        <ComSelect-list :isdisabled="true" v-model="dataForm.categoryName" placeholder="请选择模具类型" auth :title="'选择模具类型'" :method="getCategoryTrees" :requestObj="requestObj" :paramsObj="{}" />
                      </el-form-item>
                    </el-col>
                    <el-col :sm="12" :xs="24">
                      <el-form-item label="模具名称" prop="name">
                        <el-input v-model="dataForm.name" placeholder="请输入模具名称" maxlength="20" :disabled="true" />
                      </el-form-item>
                    </el-col>
                    <el-col :sm="12" :xs="24">
                      <el-form-item label="模具编码" prop="code">
                        <el-input v-model="dataForm.code" placeholder="请输入模具编码" maxlength="20" :disabled="true" />
                      </el-form-item>
                    </el-col>
                    ...
                    <el-col :sm="12" :xs="24">
                      <el-form-item label="模穴数量" prop="specModel">
                        <el-input maxlength="50" v-model="dataForm.specModel" placeholder="请输入模穴数量" :disabled="true" />
                      </el-form-item>
                    </el-col>
                    <el-col :sm="12" :xs="24">
                    ...
                    <el-col v-if="$store.getters.configData.product.showDrawingNo" :sm="12" :xs="24">
                      <el-form-item label="图号" prop="drawingNo">
                        <el-input v-model="dataForm.drawingNo" placeholder="请输入图号" maxlength="50" :disabled="true">
                        </el-input>
                      </el-form-item>
                    </el-col>                    
                    <el-col v-if="$store.getters.configData.product.showSpec" :sm="12" :xs="24" >
                      <el-form-item>
                        <el-input v-model="dataForm.spec" :placeholder="$store.getters.spec" clearable />
                      </el-form-item>
                    </el-col>
                    <el-col :sm="12" :xs="24">
                    ...
                    <el-col :sm="12" :xs="24">
                      <el-form-item label="模具状态" prop="state">
                        <el-select v-model="dataForm.state" placeholder="请选择模具状态" clearable :disabled="true" style="width: 100%;">
              ...
              <div v-if="activeName=='lyghinfo'">
                ...
                <JNPF-table ref="lyghdataTable" v-loading="lyghlistLoading" :data="lyghdataTable" @sort-change="lyghsortChange" fixedNO custom-column :height=height customKey="JNPFTableKey_553036">
              ...
              <div v-if="activeName=='wxjlinfo'">
                ...
                <JNPF-table ref="wxjldataTable" v-loading="wxjllistLoading" @sort-change="wxjlsortChange" :data="wxjldataTable" fixedNO custom-column :height=height customKey="JNPFTableKey_973739">
                  <el-table-column prop="maintenanceNo" label="维修单号" min-width="200" sortable="custom">
                  </el-table-column>
                  <el-table-column prop="equipmentIdCode" label="模具编码" min-width="200" sortable="custom" />
                  <el-table-column prop="equipmentIdName" label="模具名称" min-width="200" sortable="custom"></el-table-column>
                  ...
                  <el-table-column prop="equipmentState" label="模具状态" width="120" sortable="custom">
                    <template slot-scope="scope">
              ...
              <div v-if="activeName=='byrwinfo'">
                ...
                <JNPF-table ref="byrwdataTable" v-loading="byrwlistLoading" :data="byrwdataTable" @sort-change="byrwsortChange" fixedNO custom-column :height=height customKey="JNPFTableKey_430234">
                  <el-table-column prop="name" label="任务名称" min-width="200" fixed="left" sortable="custom">
                  </el-table-column>
                  <el-table-column prop="equipmentIdCode" label="模具编码" min-width="200" fixed="left" sortable="custom" />
                  <el-table-column prop="equipmentIdName" label="模具名称" min-width="200" fixed="left" sortable="custom"></el-table-column>
              ...
              <div v-if="activeName=='byjlinfo'">
                ...
                <JNPF-table ref="byjldataTable" v-loading="byjllistLoading" :data="byjldataTable" @sort-change="byjlsortChange" fixedNO custom-column :height=height customKey="JNPFTableKey_860931">
                  <el-table-column prop="maintenanceTaskIdText" label="任务名称" min-width="180" sortable="custom" />
                  <el-table-column prop="equipmentIdCode" label="模具编码" min-width="200" sortable="custom" />
                  <el-table-column prop="equipmentIdName" label="模具名称" min-width="200" sortable="custom" />
                  <el-table-column prop="factoryFloor" label="使用车间" min-width="140" sortable="custom" />
                  <el-table-column prop="mountedPlaces" label="安装地点" min-width="140" sortable="custom" />
              ...
              <div v-if="activeName=='djrwinfo'">
                ...
                <JNPF-table ref="djrwdataTable" v-loading="djrwlistLoading" :data="djrwdataTable" @sort-change="djrwsortChange" fixedNO custom-column :height=height customKey="JNPFTableKey_676181">
              ...
              <div v-if="activeName=='djjlinfo'">
                ...
                <JNPF-table ref="djjldataTable" v-loading="djjllistLoading" :data="djjldataTable" @sort-change="djjlsortChange" fixedNO custom-column :height=height customKey="JNPFTableKey_570025">
...
export default {
  ...
  data() {
    return {
      ...
      deviceTypeList: [
        { value: "normal", label: "正常模具" },
        { value: "virtually", label: "虚拟模具" },
      ],
      // 模具状态
      equipmentStatusList: [
        {
