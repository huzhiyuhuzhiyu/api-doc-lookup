          ...
          <el-tab-pane label="订单信息" name="orderInfo">
            ...
            <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm" class="data-form">
              <el-table ref="product" :data="dataFormTwo.productData" @selection-change="handeleProductInfoData"
                ...
                <el-table-column prop="customerProductNo" label="客户物料号" width="200" show-overflow-tooltip v-if="dataForm.adjustType === 'other'">
                </el-table-column>
                <el-table-column prop="customerProductDrawingNo" label="客户产品图号" width="200" show-overflow-tooltip v-if="dataForm.adjustType === 'other'">
                </el-table-column>
                ...
                <el-table-column prop="drawingNo" label="产品图号" width="auto" v-if="isproductDrawing" show-overflow-tooltip
                  key="23">
                </el-table-column>
                <el-table-column prop="productDrawingNo" label="产品图号" width="auto" v-else show-overflow-tooltip>
                </el-table-column>
                ...
                <el-table-column prop="newDiscount" label="新折扣率" width="150" show-overflow-tooltip>
                </el-table-column>
                ...
                <el-table-column prop="excludingTaxNewPrice" label="新单价(不含税)" width="150" show-overflow-tooltip>
                </el-table-column>
        ...
        <div class="JNPF-common-layout" style="height: 68vh;overflow: auto;">
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <JNPF-table v-loading="listLoading" :data="tableDataCustomer" @row-dblclick="seleceCustomer" customKey="JNPFTableKey_316499">
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="4">
                  <el-form-item>
                    <el-input @keyup.native.enter="searchcusProduct()"  v-model="productForm.drawingNo" placeholder="请输入产品图号" clearable />
                  </el-form-item>
                </el-col>

                <el-col :span="4">
                  <el-form-item>
                    <el-input @keyup.native.enter="searchcusProduct()"  v-model="productForm.productCode" placeholder="请输入产品编码" clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
                    <el-input @keyup.native.enter="searchcusProduct()"  v-model="productForm.productName" placeholder="请输入产品名称" clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="6">
                  <el-form-item>
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <JNPF-table v-loading="listLoading" :data="cusProductData" hasC @selection-change="handleSelectionChange"
                @row-click="rowaction" ref="dataTable" customKey="JNPFTableKey_243899">
...
export default {
  components: { workFlow,okOrNo,transferForm },
  data() {
    return {
      okOrNoVisible:false,
