    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" ref="dataTable" :data="tableData" @sort-change="sortChange" custom-column
          fixedNO customKey="JNPFTableKey_393258">
          ...
          <el-table-column label="操作" width="140" fixed="right">
            <template slot-scope="scope">
              <tableOpts @edit="addOrUpdateHandle(scope.row, 'edit')" :hasDel="false"
                :editDisabled="scope.row.processStatus !== 'processing'" :editText="'处理'">
...
import DetailForm from '@/views/salesManagement/contractQuotation/quotationTranslate/Form.vue'
export default {
  ...
  data() {
    return {
      ...
      initListQuery: {
        ...
        processStatus: 'processing', //	处理状态,可用值:processed,processing			
  ...
  methods: {
    ...
    addOrUpdateHandle(row, btnType) {
      if (btnType === 'edit') {
        ...
        this.$nextTick(() => { this.$refs.Form.init(row.id, btnType || 'add') })
      } else {
        this.detailFormVisible = true
        this.$nextTick(() => { this.$refs.DetailForm.init(row, btnType || 'add') })
      }
    },
