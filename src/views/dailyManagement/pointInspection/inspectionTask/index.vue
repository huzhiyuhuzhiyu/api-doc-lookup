        ...
        <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                ...
                <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" @sort-change="sortChange" fixedNO
                    ...
                    <el-table-column prop="departmentIdName" label="计划点检部门" width="120" />
                    <el-table-column prop="maintainerIdName" label="计划点检人" width="120"></el-table-column>
                    <el-table-column prop="nextMaintenanceTime" label="下次点检时间" width="180"
                        sortable="custom"></el-table-column>
                    ...
                    <el-col :span="12">
                        <el-form-item label="下次点检时间">
                            <el-date-picker v-model="orderDateArr" type="daterange" value-format="yyyy-MM-dd"
                                style="width: 100%;" start-placeholder="请选择开始时间" end-placeholder="请选择结束时间" clearable :picker-options="pickerOptions">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
