  ...
  <div class="JNPF-common-layout">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main ">
       ...
       <div class="tableContainer">
        <el-table ref="dataTable" v-loading="listLoading" :data="tableData" @sort-change="sortChange" custom-column hasC
          :fixedNO="true" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="productCode" fixed="left" label="产品编码" width="120"></el-table-column>
          <el-table-column prop="productName" fixed="left" label="产品名称" width="160"></el-table-column>
          <el-table-column prop="productDrawingNo" fixed="left" label="产品图号" min-width="160" show-overflow-tooltip></el-table-column>
          <el-table-column prop="productDrawingNo"  label="工作令号" min-width="160" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="生产派工" :close-on-click-modal="false" :close-on-press-escape="false" :visible.sync="workerDialog"
      ...
      <el-row :gutter="20">
        ...
        <el-table ref="workerDialog" v-loading="listLoading" :data="workerList" bordercccccccccc>
    ...
    worker() {
      ...
      for (let index = 0; index < this.workerList.length; index++) {
        ...
        if (Number(item.dispatchQuantity) + Number(item.dispatchedQuantity ? item.dispatchedQuantity : 0) > Number(item.workOrderQuantity)) {
          flag = false
          this.$message({
            message: "第" + (index + 1) + "总派工数量不能超过生产订单数量！",
            type: "error"
          })
          break
        }
