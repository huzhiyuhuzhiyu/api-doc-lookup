<template>
  <el-dialog :title="!dataForm.id ? '新建客户分类' : '编辑客户分类'" :close-on-click-modal="false" :close-on-press-escape="false"
    ...
    <el-form ref="dataForm" v-loading="formLoading" :model="dataForm" :type="dataForm.type" :rules="dataRule"
      ...
      <el-form-item label="分类名称" prop="name">
        <el-input v-model="dataForm.name" placeholder="输入分类名称" maxlength="20" />
      </el-form-item>
