  ...
  <div class="JNPF-common-layout">
    <div class="JNPF-common-layout-center  JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="treeList" row-key="id" v-if="refreshTable" :default-expand-all="expands" :tree-props="{children: 'childrenList', hasChildren: ''}" custom-column customKey="JNPFTableKey_605740">
          ...
          <el-table-column prop="sortCode" label="排序" width="120">
            <template slot-scope="scope">
              <el-input @change="switchShow(scope.row)" clearable v-model="scope.row.sortCode" maxlenth="4" onkeyup="value=value.replace(/[^\d]/g,'')"></el-input>
            </template>
          </el-table-column>
