    ...
    <div class="JNPF-preview-main org-form">
      <div :class="['JNPF-common-page-header', btnType === 'look' ? 'noButtons' : '']">
        ...
        <el-page-header @back="goBack"
          :content="btnType == 'add' ? '新建报废申请单' : btnType == 'edit' ? '编辑报废申请单' : '查看报废申请单'" />
          ...
          <el-tab-pane label="报废信息" name="orderInfo">
              ...
              <el-row :gutter="30" class="custom-row">
                <el-col :sm="8" :xs="24">
                  <el-form-item label="申请部门" prop="departmentId">
                    <ComSelect v-model="organizeIdTrees" :disabled="btnType === 'look'" placeholder="请选择申请部门" auth
                      :dialogTitle="'请选择申请部门'" @change="changedepartment" :currOrgId="dataForm.departmentId || '0'" />
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="申请人" prop="applicantId">
                    <el-select v-model="dataForm.applicantIdName" placeholder="请选择申请人" clearable style="width: 100%;"
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="申请日期" prop="applicantTime">
                    <el-date-picker v-model="dataForm.applicantTime" type="date" value-format="yyyy-MM-dd"
                      style="width: 100%;" placeholder="请选择申请日期" :disabled="btnType == 'look'">
                    </el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :sm="12" :xs="24">
                  <el-form-item label="报废理由" prop="reasonScrapping">
                    <el-input v-model="dataForm.reasonScrapping" placeholder="请输入报废理由" :disabled="btnType == 'look'"
            ...
            <div v-if="btnType !== 'look'">
              <el-button type="text" style="margin-right:8px;margin-left:8px font-size:14px!important" icon="el-icon-plus"
                :disabled="btnType == 'look' ? true : false" @click="openSeleceProductDialog()">选择设备</el-button>|
      ...
      <ComSelect-page ref="ComSelect-page" @change="submitCustomerProduct" :tableItems="ProductTableItems" title="选择设备"
        treeTitle="设备分类" :methodArr="{ method: getcategoryTree, requestObj: { classAttribute: 'equipment' } }"
        :listMethod="getEquEquipmentList" :listRequestObj="ProductListRequestObj" :searchList="ProductTableSearchList"
