                  ...
                  <el-collapse v-model="activeNames">
                    ...
                    <el-collapse-item title="产品信息" name="productInfo" class="productInfo">
                      ...
                      <JNPF-table ref="product" :data="productData" :fixedNO="true" :hasC="btnType != 'look'"
                        @selection-change="handeleProductInfoData" border :key="165" style="width: 100%;" customKey="JNPFTableKey_503499">
                    ...
                    <el-table-column prop="productCategoryName" label="产品分类" width="140" show-overflow-tooltip></el-table-column>
                        ...
                        <el-table-column prop="num" :label="mainUnitFlag == 1 ? '退料数量(主)' : '退料数量'" min-width="160">
                          <template slot="header">
                            <span class="required">*</span>{{ mainUnitFlag == 1 ? '退料数量(主)' : '退料数量' }}
                          </template>
                          <template slot-scope="scope">
                            <el-input v-model="scope.row.num" placeholder="退料数量(主)" :disabled="btnType == 'look'"
      ...
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          if (this.productData.length) {
            ...
            for (let index = 0; index < this.productData.length; index++) {
              ...
              if (Number(item.num) > Number(item.ordersNum)) {
                ...
                submitFlag = false
                this.$message.error("产品信息第" + (index + 1) + "行数量不能超过待退料数量")
                break
              }
          ...
          if (submitFlag) {
            ...
            this.dataForm.productClassAttributeList = this.productClassAttributeList
