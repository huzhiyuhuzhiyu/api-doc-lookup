    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" highlight-current-row :fixedNO="true" ref="dataTable" :data="tableDataList"
          ...
          <el-table-column prop="partnerName" label="客户名称" min-width="180"> </el-table-column>
          ...
          <el-table-column prop="productsDrawingNo" label="型号" min-width="180"> </el-table-column>
          <el-table-column prop="mainUnit" label="单位" min-width="180"> </el-table-column>
          <el-table-column prop="productionQuantity" label="生产数量" min-width="180"> </el-table-column>
          <el-table-column prop="liable" label="责任人" min-width="150" />
      ...
      <div style="height: 40px; line-height: 40px; background: #f5f7fa;text-align:end" class="text">
        <span style="font-weight:500;margin-right:10px">总生产数量：{{ totalData.productionQuantity }}</span>
        ...
        <el-form ref="diaForm" :model="listQuery" label-width="120px" label-position="top">
          ...
          <el-col :span="12">
            <el-form-item label="客户编码">
              <el-input v-model="listQuery.partnerCode" placeholder="请输入客户编码" min-width="150" clearable maxlength="50">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="生产数量">
              <el-input v-model="listQuery.productionQuantity" placeholder="请输入生产数量" width="180" clearable maxlength="20">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="检验类型">
              <el-select v-model="listQuery.inspectionMethod" placeholder="请选择检验结果" clearable style="width: 100%;">
...
<script>
import { getqualityReportList } from '@/api/reportAnalysis/qualityReport.js'
...
export default {
  ...
  methods: {
    ...
    this.listQuery.inspectDateEnd = this.inspectDate[1]
      ...
      this.totalList = []
      getqualityReportList(this.listQuery).then(res => {
