        ...
        <div class="JNPF-common-layout-center">
                ...
                <el-form @submit.native.prevent>
                    ...
                    <el-col :span="6">
                        <el-form-item label="类型">
                            <el-select v-model="query.typeid" placeholder="请选择" clearable>
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                ...
                <JNPF-table v-loading="listLoading" :data="list" @sort-change='sortChange'
                    ...
                    <el-table-column prop="typeid_name" label="点检类型" align="left" />
...
export default {
    ...
    data() {
        return {
            ...
            typeidOptions: [],
            typeidProps: { "label": "name", "value": "F_Id" },
            isMustOptions: [{ "fullName": "是", "id": "true" }, { "fullName": "否", "id": "false" }],
            isMustProps: { "label": "fullName", "value": "id" },
            typeId:'2'
        }
    },
    computed: {
    ...
    methods: {
        ...
        handleDel(id) {
            this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                ...
                request({
                    url: `/api/maintionTypeItem/Equipment_maintain_type_item/${id}`,
                    method: 'DELETE'
                }).then(res => {
                    this.$message({
                        type: 'success',
        ...
        download(data) {
            ...
            request({
                url: `/api/maintionTypeItem/Equipment_maintain_type_item/Actions/Export`,
                method: 'post',
                data: query
            }).then(res => {
