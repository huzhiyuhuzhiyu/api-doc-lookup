        ...
        <div v-show="!flag" class="JNPF-common-layout-center">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                <JNPF-table v-loading="listLoading" :data="list">
                    ...
                    <el-table-column prop="tableField119[0].energyType" label="环境类型" align="center" width="90"/>
                    ...
                    <el-table-column prop="value" label="值" align="left" min-width="100">
                    </el-table-column>
