    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <JNPF-table ref="dataTable" show-summary :summary-method="getSummaries" v-loading="listLoading" :data="tableData" custom-column :fixedNO="true" customKey="JNPFTableKey_550438">
          ...
          <el-table-column prop="productSpec" label="产品规格" min-width="180" />
          ...
          <el-table-column prop="materialsUsedQuantity" label="材料需求数量" min-width="140" />
...
<script>
import { getMaterialtrackingreport } from '@/api/reportAnalysis/saleReport'
import ExportForm from '@/components/no_mount/ExportBox/index'
import { excelExport } from '@/api/basicData/index'
export default {
  name: 'MaterialListmetalworking',
  ...
  methods: {
    ...
    initData() {
      ...
      getMaterialtrackingreport(this.dataForm).then(res => {
