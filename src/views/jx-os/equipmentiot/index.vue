        ...
        <div class="JNPF-common-layout-center">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                ...
                >
                    ...
                    <el-table-column v-show="query.isIot || query.isIot == undefined" prop="uuid_name" label="盒子ID"
                                     align="left" min-width="100"
                    />
                    <el-table-column v-show="query.isIot || query.isIot == undefined" prop="theoryBeat_name"
                                     label="理论节拍" align="left" width="90"
                    />
                    <el-table-column v-show="query.isIot || query.isIot == undefined" prop="theoryBeat_name"
                                     label="状态" align="left" width="90"
                    >
                        <template slot-scope="{row}"
                                  v-if="row.uuid != null && row.uuid!= undefined && row.uuid != ''"
                        >
