      ...
      <template>
        <div class="orderHeader" style="width: 100%;display: flex;height: 80px;">
          ...
          justify-content: space-around;">
            <img src="@/assets/images/eslog.png" style="transform: scale(0.6);" />
          </div>
        ...
        <div style="display:flex;justify-content:space-between;font-size:14px">
          <div style="font-size:14px;text-indent: 0.5em;flex:2">工作令号：{{ dataValue.workOrderNo }}</div>
          <div style="font-size:14px;flex:2">合同号：{{ dataValue.contractNo }}</div>
        ...
        <table border="1" cellspacing="0" cellpadding="0" width="100%" class="tyTable">
          <thead>
            <tr style="box-sizing: border-box;font-size:16px;">
              ...
              <th colspan="1" style="min-width:70px;padding:5px;text-align:center;font-weight:500">箱数(件)</th>
              <th colspan="1" style="min-width:100px;padding:5px;text-align:center;font-weight:500">备注1</th>
              <th colspan="1" style="min-width:110px;padding:5px;text-align:center;font-weight:500">备注2</th>
            </tr>
          </thead>
          <tbody style="">
            <tr v-for="(item1, index1) in item.pagedata" :key="index1" style="box-sizing: border-box; font-size:14px;">
              ...
              <td style="padding:5px;text-align:center">{{ item1.boxNum }}</td>
              <td style="padding:5px;text-align:center">{{ item1.remark }}</td>
              <td style="padding:5px;text-align:center">{{ item1.remark2 }}</td>

            </tr>
            <tr v-if="index + 1 == pages">
              <td colspan="1"></td>
              <td colspan="5" style="padding:3px;text-align:right;font-size:18px">合计：</td>
              <td colspan="5" style="padding:3px;text-align:left;font-size:18px">{{dataValue.totalNum}}</td>
            </tr>
          </tbody>
        </table>
