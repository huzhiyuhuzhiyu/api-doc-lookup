              ...
              <el-row :gutter="30" class="custom-row">
                ...
                <el-col :sm="6" :xs="24">
                  <el-form-item label="计划点检部门" prop="departmentId">
                    <ComSelect v-model="organizeIdTrees" :disabled="btnType === 'look'" placeholder="请选择计划点检部门" auth
                      :dialogTitle="'请选择计划点检部门'" @change="changedepartment" :currOrgId="dataForm.departmentId || '0'" />
                  </el-form-item>
                </el-col>
                <el-col :sm="6" :xs="24">
                  <el-form-item label="计划点检人" prop="maintainerId">
                    <el-select v-model="dataForm.maintainerIdName" placeholder="请选择计划点检人" clearable style="width: 100%;"
                ...
                <!-- <el-col :sm="6" :xs="24" v-if="dataForm.cycleType == 'disposable'" key="4">
                  <el-form-item label="计划点检时间" prop="planMaintenanceTime">
                    <el-date-picker v-model="dataForm.nextMaintenanceTime" type="date" value-format="yyyy-MM-dd"
                      style="width: 100%;" :picker-options="pickerOptions" placeholder="请选择计划点检时间"
                      @change="planMaintenanceTimeaction" :disabled="btnType == 'look'">
                    </el-date-picker>
                    <el-date-picker v-model="dataForm.nextMaintenanceTime" type="datetime" placeholder="请选择计划点检时间"
                ...
                <el-col :sm="6" :xs="24">
                  <el-form-item label="下次点检时间" prop="nextMaintenanceTime">
                    <el-date-picker v-model="dataForm.nextMaintenanceTime" type="date" value-format="yyyy-MM-dd"
                      style="width: 100%;" placeholder="请选择下次点检时间" :picker-options="pickerOptions"
                      :disabled="btnType == 'look'">
                    </el-date-picker>
                  </el-form-item>
                </el-col>
