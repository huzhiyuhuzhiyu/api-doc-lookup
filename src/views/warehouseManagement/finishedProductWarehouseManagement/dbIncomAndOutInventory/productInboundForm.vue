                  ...
                  <el-collapse v-model="activeNames">
                    ...
                    <el-collapse-item title="产品信息" name="productInfo" class="productInfo">
                      ...
                      <JNPF-table ref="product" :data="productData"  :fixedNO="true" border :key="165"
                        ...
                        :setColumnDisplayList="columnList" customKey="JNPFTableKey_158423">
                        ...
                        <el-table-column prop="shelfSpaceName" label="库位" min-width="180" :key="10112"
                          v-if="allocationFlag">
  ...
  methods: {
    ...
    init(data, btnType, classAttributeList, warehouseCode, type) {
      ...
      if (btnType == 'look' || btnType == 'edit') {
        ...
        this.datafilelist = []
        this.getBusInfo('b045')
        getInboundWarehouseData({ productionOrderId: data[0].id }).then(res => {
          console.log("生产入库数据", res);
          ...
          this.dataForm.sourceNo = res.data[0].orderNo
