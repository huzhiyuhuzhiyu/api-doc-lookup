      ...
      <div class="JNPF-common-layout-center JNPF-flex-main">
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
          ...
          <JNPF-table ref="dataTable"  :data="tableData" :fixedNO="true"
            ...
            :setColumnDisplayList="columnList" customKey="JNPFTableKey_289540">
            ...
            <el-table-column prop="personId" label="领料人" min-width="120" sortable="custom" />
...
export default {
  name: 'blankReturnMaterManagement',
