<template>
  <el-dialog :title="title" :close-on-click-modal="false" :close-on-press-escape="false" :visible="visible" lock-scroll
    ...
    <div class="JNPF-common-layout" style="overflow: auto;">
      <div class="JNPF-common-layout-center JNPF-flex-main">
        <div class="JNPF-common-layout-main JNPF-flex-main">
          ...
          <div class="subtitle" v-if="dataForm.businessCode=='metalworking'">
            <h5>上/下工记录</h5>
          </div>
          <JNPF-table v-loading="listLoading" :data="tableData" hasNO fixedNO ref="dataTable" v-if="dataForm.businessCode=='metalworking'">
            <el-table-column prop="personName" label="操作员" width="120"/>
            <el-table-column prop="upTime" label="上工时间" min-width="160" />
            <el-table-column prop="downTime" label="下工时间" min-width="160" />
            <el-table-column prop="workingTime" label="上工时长（秒）" min-width="140" />
            <el-table-column prop="equipmentProductionQuantity" label="下工设备产量（件）" min-width="120" />
  ...
  data() {
    return {
      ...
      dataFormItems: [
        ...
        { prop: "dispatchQuantity", label: "派工生产数量", value: "", type: "input", sm: 6 },
        { prop: "completedQuantity", label: "完工数", value: "", type: "input", sm: 6 }, 
        { prop: "industrialWasteQuantity", label: "工废数量", value: "", type: "input", sm: 6 },
