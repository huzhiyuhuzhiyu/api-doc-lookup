                    ...
                    <div class="JNPF-common-layout-center JNPF-flex-main">
                        ...
                        <div class="JNPF-common-layout-main JNPF-flex-main">
                            ...
                            <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" @sort-change="sortChange"
                                custom-column>
                                <el-table-column prop="orderNo" label="领料单号" min-width="200" sortable="custom">
                                ...
                                <el-table-column prop="personName" label="领料人" min-width="150" />
                                <el-table-column prop="operationDate" label="领料日期" min-width="150" sortable="custom" />
                    ...
                    <div class="JNPF-common-layout-center JNPF-flex-main">
                        <el-row class="JNPF-common-search-box" :gutter="16">
                            <el-form @submit.native.prevent>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-input v-model="linesQuery.orderNo" placeholder="请输入领料单号"
                                            @keyup.enter.native="search()" clearable />
                                    </el-form-item>
                                </el-col>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-input v-model="linesQuery.personName" placeholder="请输入领料人"
                                            @keyup.enter.native="search()" clearable />
                                    </el-form-item>
                                </el-col>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-date-picker v-model="deliveryDatefahuo" type="daterange"
                                            ...
                                            start-placeholder="领料开始日期" end-placeholder="领料结束日期">
                                        </el-date-picker>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
                        ...
                        <div class="JNPF-common-layout-main JNPF-flex-main">
                            ...
                            <JNPF-table ref="linesTableData" v-loading="listLoading" :data="linesTableData" :fixedNO="true"
                                ...
                                <el-table-column prop="orderNo" label="领料单号" width="200" sortable="custom" fixed="left">
                                    <template slot-scope="scope">
                ...
                <el-form :model="dataForm" label-width="120px" label-position="top">
                    <el-col :span="12">
                        <el-form-item label="领料单号">
                            <el-input v-model="dataForm.orderNo" placeholder="请输入领料单号" clearable />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                    ...
                    <el-col :span="12">
                        <el-form-item label="领料人">
                            <el-input v-model="dataForm.personName" placeholder="请输入领料人" clearable />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
...
export default {
    name: 'halfMaterialRequisitionNotice',
    components: { Form, },
    data() {
        return {
            linesTotal: 0,
