<template>
  <transition name="el-zoom-in-center">
    <div class="JNPF-preview-main org-form">
          ...
          <el-tab-pane label="订单信息" name="orderInfo">
              ...
              <el-row :gutter="30" class="custom-row">
                <el-col :sm="8" :xs="24">
                  <el-form-item label="产品名称" prop="productName">
                    <ComSelect-page v-model="dataForm.productName" @change="submitCustomerProduct1"
                      :tableItems="ProductTableItems1" title="选择产品" treeTitle="物料分类" :methodArr="ProductMethodArr"
                      :listMethod="getProductList" :listRequestObj="ProductListRequestObj"
                      :searchList="ProductTableSearchList1" :isdisabled="btnType == 'look'" placeholder="请选择产品" />
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="组装人" prop="transferBy">
                    <user-select v-model="dataForm.transferBy" placeholder="请选择组装人" clearable style="width: 100%"
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="组装日期" prop="transferDate">
                    <el-date-picker v-model="dataForm.transferDate" type="date" value-format="yyyy-MM-dd"
                      style="width: 100%" placeholder="请选择组装日期" :disabled="btnType == 'look' ? true : false">
                    </el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="仓库" prop="warehouseId">
                    <ComSelect-list :requestObj="{ type: 'normal' }" dialogTitle="选择仓库" placeholder="请选择仓库"
                      :value="dataForm.warehouseName" :isdisabled="btnType === 'look'" :method="getWarehouseList"
                      @change="changeWarehouse" :beforeSubmit="beforeWarehoustChange"></ComSelect-list>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="库位" prop="shelfSpaceId">
                    <ComSelect-list :requestObj="kwstock" dialogTitle="请选择库位" placeholder="请选择库位"
                      :value="dataForm.shelfSpaceName" :isdisabled="btnType === 'look' || !dataForm.warehouseName"
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="目标箱条码" prop="boxBarcode">
                    <ComSelect-page :placeholder="'请选择目标箱条码'" :isdisabled="btnType === 'look' || !dataForm.shelfSpaceName
                      " :value="dataForm.boxBarcode" :dialogTitle="'选择条码'" @change="targetBox"
                      :tableItems="targetTableItems" :renderTree="false" :listMethod="TransferBarCode"
                      :listRequestObj="targetRequestObj" :paramsObj="{}" :searchList="targetTableSearchList"
                      :elementShow="true" />
                  </el-form-item>
                </el-col>
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="批次号" prop="batchNumber">
                    <el-select v-model.trim="dataForm.batchNumber" filterable remote reserve-keyword placeholder="请输入批次号"
                      style="width: 100%" clearable :disabled="btnType == 'look'" :remote-method="remoteMethod"
                      :loading="loading" @focus="action">
            ...
            <el-form :model="dataFormTwo" ref="productForm" class="data-form">
              <el-table class="TableForm table" ref="product" :data="dataFormTwo.data"
                ...
                <el-table-column prop="productDrawingNo" label="产品图号" width="300" show-overflow-tooltip />
                ...
                <el-table-column prop="boxBarcode" label="原箱条码" width="220">
                  ...
                  <template slot-scope="scope">
                    <el-form-item :prop="'data.' + scope.$index + '.' + 'boxBarcode'" :rules="productRules.boxBarcode">
                      <ComSelect-page :placeholder="'请选择原箱条码'" :value="scope.row.boxBarcode" :dialogTitle="'选择条码'"
                        @change="addth" :tableItems="targetTableItems" :renderTree="false" :listMethod="TransferBarCode"
                        :listRequestObj="barCodeRequestObj(scope.$index)" :paramsObj="{ scope }"
                        :searchList="targetTableSearchList" :isdisabled="btnType === 'look'" />
                    </el-form-item>
                  </template>
                </el-table-column>
                  ...
                  <template slot-scope="scope">
                    <el-form-item :prop="'data.' + scope.$index + '.' + 'num'" :rules="productRules.num">
                      <el-input v-model="scope.row.num" :disabled="btnType === 'look'" maxlength="11" placeholder="请输入数量"
                        @input="watchnums(scope.row, scope.$index)" style="width: 100%">{{ scope.row.num }}
                      </el-input>
                    </el-form-item>
                  </template>
                </el-table-column>
      ...
      <ComSelect-page ref="ComSelect-page" @change="submitAllProduct" :tableItems="ProductTableItems2" dialogTitle="选择产品"
        treeTitle="产品分类" :methodArr="ProductMethodArr" :listMethod="getProductList"
        :listRequestObj="ProductListRequestObj2" :searchList="ProductTableSearchList1" :elementShow="false" />
    </div>
  </transition>
</template>
  ...
  data() {
    return {
      ...
      ProductTableItems1: [
        ...
        { prop: 'drawingNo', label: '产品图号', minWidth: 300 },
        { prop: 'spec', label: '规格型号', minWidth: 120 },
        { prop: 'classAttributeText', label: '产品分类', minWidth: 120 },
