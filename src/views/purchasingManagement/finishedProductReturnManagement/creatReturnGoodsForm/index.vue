              ...
              <el-collapse-item title="产品信息" name="productInfo">
                ...
                <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm" class="data-form">
                  <JNPF-table ref="product" :data="dataFormTwo.productData" v-bind="dataFormTwo.data" :hasC="btnType !== 'look'" hasNO fixedNO
                    @selection-change="handeleProductInfoData" :height="customStyleData" customKey="JNPFTableKey_400369">
                    ...
                    <el-table-column prop="drawingNo" label="型号" width="160" show-overflow-tooltip />
