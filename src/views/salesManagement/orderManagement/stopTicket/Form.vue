    ...
    <div class="JNPF-preview-main org-form">
      <div class="JNPF-common-page-header">
        ...
        <el-page-header @back="goBack"
          :content="btnType == 'add' ? '新建停止订单' : btnType == 'edit' ? '编辑停止订单' : btnType == 'look' ? '查看停止订单' : ''" />
        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="订单信息" name="orderInfo" ref="orderInfos">
            ...
            <div :style="{ height: customStyleData + 'px'}">
              <el-table ref="product" :data="orderDetailData" :fixedNO="true" @selection-change="handeleProductInfoData" height="100%">
              ...
              <el-table-column prop="drawingNo" label="产品图号" width="350" />
              <el-table-column prop="num" label="订单数量" width="100"></el-table-column>
              ...
              <el-table-column prop="stopQuantity" label="停止数量" width="100">
              ...
              <el-table-column label="操作" width="120" fixed="right" v-if="btnType != 'look'&&orderDetailData.length>1" key="24">
                <template slot-scope="scope">
    ...
    handleConfirm(value) {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          if (submitFlag === false) return this.btnLoading = false
