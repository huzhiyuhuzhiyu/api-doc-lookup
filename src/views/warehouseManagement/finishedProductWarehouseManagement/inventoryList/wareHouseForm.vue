      ...
      <div class="JNPF-common-layout-center JNPF-flex-main">
        <el-row class="JNPF-common-search-box" :gutter="16">
          <el-form @submit.native.prevent>
            <el-col :span="6">
              <el-form-item>
                <el-input @keyup.native.enter="search()"  v-model="tableQuery.code" placeholder="请输入货位编码" clearable />
              </el-form-item>
            </el-col>
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main">
          ...
          <JNPF-table ref="tabForm" v-loading="listLoading" :data="tableDataList" row-key="id" :fixedNO="true"
            @sort-change="sortChange" custom-column  customKey="JNPFTableKey_622241">
