    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" @selection-change="handeleProductInfoData" hasC highlight-current-row
          ...
          <el-table-column prop="cooperativePartnerName" label="外协供应商名称" min-width="180"  />
          <el-table-column prop="cooperativePartnerCode" label="外协供应商编码" min-width="180"  />
          ...
          <el-table-column prop="purchaseQuantity" label="外协数量" min-width="180" />
      ...
      if (this.selectData.length === 0) {
       ...
       if(allCode){
         ...
         this.$nextTick(() => {
          ...
          this.$message.error('请选择外协供应商相同的通知单!') 
       }
