    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      <el-row class="JNPF-common-search-box" :gutter="16">
        <el-form @submit.native.prevent>
          ...
          <el-col :span="4">
            <el-form-item>
              <el-input v-model="listQuery.partnerCode" placeholder="请输入客户编码" @keyup.enter.native="search()" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="6">
            <el-form-item>
...
export default {
  ...
  data() {
    return {
      visible: false,
      objectTypeList: [{ label: '客户', value: 'custom' }, { label: '默认', value: 'default_template' }],
      formVisible: false,
      tableData: [],
      listQuery: {},
      initListQuery: {
  ...
  methods: {
    ...
    sortChange({ prop, order }) {
      let newProp
      if (['partnerName'].includes(prop)) { newProp = prop }
