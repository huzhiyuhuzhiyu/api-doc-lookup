                    ...
                    <el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px"
                      ...
                      <el-col :span="6">
                        <el-form-item label="对账金额" prop="totalReconciliationAmount">
                          <el-input disabled v-model="dataForm.includingTaxAmount" placeholder="请输入对账金额"></el-input>
                        </el-form-item>
                      </el-col>
                ...
                <el-collapse-item title="产品信息" name="productInfo">
                  ...
                  <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm">
                    <el-table style="border: 1px solid #e3e7ee;" hasNO fixedNO v-bind="dataFormTwo.data"
                      ...
                      <el-table-column label="操作" width="120" v-if="dataFormTwo.data.length > 1">
                        <template slot-scope="scope">
  ...
  methods: {
    getDeputyUnit() {
      ...
      getBimBusinessDetail(obj).then((res) => {
        ...
        console.log(this.isDeputyUnitSwitch, '933332333')
      })
    },
    ...
    init(row, data, type) {
      ...
      _data.forEach((item) => {
        console.log(item, 'receiptQuantity')
