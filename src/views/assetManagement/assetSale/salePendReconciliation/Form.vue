    ...
    <transition name="el-zoom-in-center">
      <div class="JNPF-preview-main org-form">
        <div :class="['JNPF-common-page-header', type === 'look' ? 'noButtons' : '']" v-if="!approvalFlag">
          <el-page-header @back="goBack" :content="dialogTitle + `采购对账单`" />
          <div class="options">
                ...
                <el-collapse-item title="对账信息" name="productInfo">
                  <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm">
                    ...
                    <el-table-column prop="productCategoryName" label="产品分类" width="140" show-overflow-tooltip></el-table-column>
                      <el-table-column prop="reconciliationUnitPrice" label="对账数量" width="100">
                        <template slot-scope="scope">
            ...
            <el-collapse-item title="对账信息" name="productInfo">
              <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm">
                <el-table style="border: 1px solid #e3e7ee;" hasC hasNO fixedNO v-bind="dataFormTwo.data"
                  ...
                  <el-table-column prop="propertyCode" label="资产编码" min-width="160" show-overflow-tooltip>
                    <template slot-scope="scope">
                      <el-form-item :prop="'data.' + scope.$index + '.' + 'propertyCode'">
                        <div class="viewData">
                          <span>{{ scope.row.propertyCode ? scope.row.propertyCode : '调价' }}</span>
                  ...
                  <el-table-column prop="excludingTaxAmount" label="不含税金额" width="120">
                    <template slot-scope="scope">
                      <el-form-item :prop="'data.' + scope.$index + '.' + 'excludingTaxAmount'">
                        <div :class="['viewData', scope.row.excludingTaxAmount < 0 ? 'red' : 'green']">
                          <span>
                  ...
                  <el-table-column prop="includingTaxAmount" label="含税金额" width="100">
                    <template slot-scope="scope">
                      <el-form-item :prop="'data.' + scope.$index + '.' + 'includingTaxAmount'">
                        <div :class="['viewData', scope.row.includingTaxAmount < 0 ? 'red' : 'green']">
                          <span>
...
<script>
import {propertyAccountReconciliationDetail} from '@/api/bimPropertyCategory/index'
  ...
  methods: {
    getDeputyUnit() {
      ...
      getBimBusinessDetail(obj).then((res) => {
        ...
        console.log(this.isDeputyUnitSwitch, '99999999999')
      })
    },
    clearData() {
      this.dataForm.id = ''
    ...
    init(id, type, approvalFlag) {
      ...
      this.$nextTick(() => {
        ...
        if (!this.dataForm.id) {
          ...
          this.loading = true
          propertyAccountReconciliationDetail(this.dataForm.id).then((res) => {
            console.log(res, '详情')
            // return
