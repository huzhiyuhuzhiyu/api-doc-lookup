    ...
    <div class="JNPF-common-layout">
      <div class="JNPF-common-layout-center JNPF-flex-main">
        <div class="JNPF-preview-main org-form">
                  ...
                  <el-collapse-item title="产品信息" name="productInfo">
                    <div v-if="btnType !== 'look'">
                      <el-button type="text" style="margin-right:8px;margin-left:8px; font-size:14px!important"
                        icon="el-icon-plus" @click="openSeleceProductDialog()">选择产品
                      </el-button>
                      |
                      <el-button type="text" style="margin-right:8px;margin-left:8px; font-size:14px!important"
                        icon="el-icon-plus" @click="openSelectDocuments()">选择单据
                      </el-button>
                      |
                  ...
                  :disabled="btnType == 'look' ? true : false" @click="openSeleceProductDialog()">选择订单</el-button>| -->
                    ...
                    <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm" class="data-form">
                      <el-table ref="product" :data="dataFormTwo.productData" v-bind="dataFormTwo.data" hasC hasNO
                        ...
                        <el-table-column prop="deliveryQuantity" :label="mainUnitFlag == 1 ? '退货数量(主)' : '退货数量'" width="170" key="789">
                          <template slot="header">
                            <span class="required">*</span>{{
                              dataForm.exchangeGoodsFlag ? (mainUnitFlag === '1' ? '换货数量(主)' : '换货数量') : (mainUnitFlag === '1' ? '退货数量(主)' : '退货数量')
                            }}
                          </template>
                          <template slot-scope="scope">
                        ...
                        <el-table-column prop="price" label="单价(含税)" width="120" :key="110"
                          v-if="isattachmentswitch == 1"></el-table-column>
            ...
            <div class="JNPF-common-layout" style="height: 68vh;overflow: auto;">
              ...
              <div class="JNPF-common-layout-center JNPF-flex-main">
                ...
                <div class="JNPF-common-layout-main JNPF-flex-main">
                  <JNPF-table v-loading="listLoading" :data="tableDataCustomer" @row-dblclick="seleceCustomer" customKey="JNPFTableKey_801241">
          ...
          <el-dialog title="选择产品" :close-on-click-modal="false" :close-on-press-escape="false"
            ...
            <div class="JNPF-common-layout" style="height: 68vh;overflow: auto;">
              ...
              <div class="JNPF-common-layout-center JNPF-flex-main">
                ...
                <div class="JNPF-common-layout-main JNPF-flex-main">
                  <JNPF-table v-loading="listLoading" :data="productList" @row-click="seleceCustomerProduct" hasC @sort-change="sortChange2"
              ...
              <div class="JNPF-common-layout-center JNPF-flex-main">
                ...
                <div class="JNPF-common-layout-main JNPF-flex-main">
                  <JNPF-table v-loading="listLoading" :data="allproductData" hasC @sort-change="sortChange"
                    @selection-change="handleSelectionChangeAllPruduct" ref="dataTable" @row-click="handleRowClick" customKey="JNPFTableKey_351540">
          ...
          <ComSelect-page v-bind="addDocumentsProps" ref="ComSelectDocumentsRef" :element-show="false" @change="submitAllDocuments"/>
        </div>
      </div>
    </div>
...
<script>
import {addQuotationsendlist, getQuotationdatasenddatalist} from "@/api/salesManagement/index";
import {getProducts} from '@/api/masterDataManagement/index.js' // 产品列表
import {getAttributeline, getcategoryTrees, getcooperativeProduct, getsaleOrderDetailList} from '@/api/salesManagement/assemblyOrders'
import {getcategoryTree} from '@/api/basicData/materialSettings' // 产品分类 编排属性值
import {getBimBusinessSwitchConfigList, getCooperativeData, getCooperativeInfo, getOrderFiledMap} from '@/api/basicData/index'
...
export default {
  ...
  data() {
    return {
      ...
      addDocumentsProps: {
        ...
        renderTree: false,
        multiple: true,
        listMethod: getQuotationdatasenddatalist,
        tableItems: [
  ...
  methods: {
    ...
    openSelectDocuments() {
      this.$refs.ComSelectDocumentsRef.openDialog()
    },
    submitAllDocuments(id, data) {
      const newData = data.map(item => ({
        ...item.all,
        taxRate: +item.taxRate,
        deliveryQuantity: item.all.num,
        drawingNo: item.all.productDrawingNo,
        productsId: item.all.productsId,
      }));

      this.dataFormTwo.productData = [...this.dataFormTwo.productData, ...newData]
    },
    // 配对方式显示隐藏
    ...
    seleceCustomerProduct(row) {
      this.$refs.tableData.$refs.JNPFTable.toggleRowSelection(row);
    },
