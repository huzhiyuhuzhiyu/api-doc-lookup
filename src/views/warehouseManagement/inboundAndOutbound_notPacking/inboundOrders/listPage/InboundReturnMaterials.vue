          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <div class="JNPF-common-head">
                <el-page-header @back="$emit('close', true)" :content="'生产退料入库'" />
              ...
              <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" :fixedNO="true"
                ...
                <el-table-column prop="operationDate" label="退料日期" width="120" sortable="custom" />
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
                ...
                <el-col :span="4">
                  <el-form-item>
                    <el-date-picker v-model="linesQuery.deliveryDatefahuo" type="daterange" value-format="yyyy-MM-dd"
                      style="width: 100%;" clearable start-placeholder="退料开始日期" end-placeholder="退料结束日期">
                    </el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="linesTableData" v-loading="listLoading" :data="linesTableData" :fixedNO="true"
                ...
                <el-table-column label="操作" width="140" fixed="right">
                  <template slot-scope="scope">
                    <tableOpts @edit="addOrUpdateHandle(scope.row.materialCollectId)" :editDisabled="!!scope.row.outboundId"
                      :editText="'入库'" :hasDel="false">
                      <el-dropdown hide-on-click>
                        <span class="el-dropdown-link">
                          <el-button type="text" size="mini">
        ...
        <el-form ref="diaForm" :model="linesQuery" label-width="120px" label-position="top">
          ...
          <el-col :span="12">
            <el-form-item label="退料日期">
              <el-date-picker v-model="linesQuery.deliveryDatefahuo" type="daterange" value-format="yyyy-MM-dd" style="width: 100%;"
                clearable start-placeholder="请选择退料开始日期" end-placeholder="请选择退料结束日期">
              </el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="创建时间">
              <el-date-picker v-model="linesQuery.createTimeArrfahuo" type="datetimerange" value-format="yyyy-MM-dd HH:mm:ss"
...
// import DetailForm from '../../../inboundAndOutbound/inboundOrders/detailForm/InboundReturnMaterials.vue'
export default {
  ...
  data() {
    return {
      ...
      initListQuery: {
        ...
        inspectionStatus: 'inspected',// 检验状态 待检验 unInspect、已检验 inspected
        orderNo: '',
        personName: '',
        productionOrderNo: '',
        orderItems: [{
  ...
  methods: {
    ...
    addOrUpdateHandle(id, readOnly) {
      if (readOnly) {
        ...
        this.$nextTick(() => { this.$refs.Form.init(id, undefined, "inbound_return_materials") })
      }
    },
    search() {
      if (this.activeName === 'dataTable') {
