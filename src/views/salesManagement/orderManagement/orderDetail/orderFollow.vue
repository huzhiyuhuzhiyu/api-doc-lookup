          ...
          <el-collapse v-model="activeNames" @change="handleChange">
            ...
            <el-collapse-item   name="productInfo">
              <template slot="title">
                ...
                <JNPF-table :highlight-current-row="false" v-if="titleFlag==1" :cell-style="tableCellStyle" ref="dataTable" v-loading="listLoading" :data="orderDataFormLine" :fixedNO="true"  customKey="JNPFTableKey_898762">
              ...
              <JNPF-table :highlight-current-row="false" v-if="titleFlag==2" :cell-style="tableCellStyle" ref="dataTables" v-loading="listLoading" :data="orderDataFormLine" :fixedNO="true" :row-class-name="tableRowClassName"  :row-style="selectedHighlight"
                @row-click="rowClick" customKey="JNPFTableKey_862035">
                    <el-table-column prop="customerProductNo" label="客户物料号" min-width="200"   />
                    <el-table-column prop="customerProductDrawingNo" label="客户产品图号" min-width="200" >
                    </el-table-column>
                    <el-table-column prop="productCode" label="产品编码" min-width="200"  />
            ...
            <el-collapse-item title="阶段信息" name="stageOnfo">
                <el-tabs v-model="activeName"  @tab-click="handleClick" class="stafeOnfo">
                  <el-tab-pane label="分配" name="distribution">
                    <JNPF-table ref="distributionREF" v-loading="listLoading" :data="distributionData" :fixedNO="true" customKey="JNPFTableKey_101602">
                  ...
                  <el-tab-pane label="计划" name="plan">
                    <JNPF-table ref="planREF" v-loading="listLoading" :data="planData" :fixedNO="true" customKey="JNPFTableKey_893259">
                    ...
                    <el-tabs v-model="mrpactiveName" @tab-click="handleMRPClick">
                        <el-tab-pane label="生产需求" name="mrpproduce">
                            <JNPF-table  :data="produceData" highlight-current-row
                              class="dataTables" border ref="MRPlistTable" customKey="JNPFTableKey_892632">
                        ...
                        <el-tab-pane label="采购需求" name="mrppurchase">
                            <JNPF-table v-loading="listLoading"  :data="purchaseDataMRP" highlight-current-row
                              class="dataTabless" border ref="MRPlistTables" customKey="JNPFTableKey_244931">
                              <el-table-column prop="productCode" label="产品编码"   width="140"/>
                              <el-table-column prop="productName" label="产品名称"    width="180"/>
                              <el-table-column prop="productDrawingNo" label="产品图号"  min-width="470"  />
                              <el-table-column prop="planNo" label="计划单号"  width="180"/>
                        ...
                        <el-tab-pane label="外协需求" name="mrpout">
                            <JNPF-table v-loading="listLoading"   :data="outData" highlight-current-row
                              class="dataTablesss" border ref="listTabless" customKey="JNPFTableKey_973151">
                              <el-table-column prop="productCode" label="产品编码"  width="140"/>
                              <el-table-column prop="productName" label="产品名称"   width="180"/>
                              <el-table-column prop="productDrawingNo" label="产品图号"  min-width="470"   />
                  ...
                  <el-tab-pane label="采购" name="purchase">
                    <JNPF-table ref="purchaseREF" v-loading="listLoading" :data="purchaseData" :fixedNO="true" customKey="JNPFTableKey_254747">
                  ...
                  <el-tab-pane label="领料" name="picking">
                    <JNPF-table ref="pickingREF" v-loading="listLoading" :data="pickingData" :fixedNO="true" customKey="JNPFTableKey_396301">
                  ...
                  <el-tab-pane label="产品外协" name="productOut">
                    <JNPF-table ref="productOutREF" v-loading="listLoading" :data="productOutData" :fixedNO="true" customKey="JNPFTableKey_810168">
                  ...
                  <el-tab-pane label="生产" name="production">
                    <JNPF-table ref="productionREF" v-loading="listLoading" :data="productionData" :fixedNO="true" customKey="JNPFTableKey_849651">
                  ...
                  <el-tab-pane label="工序外协" name="productionOut">
                    <JNPF-table ref="productionOutREF" v-loading="listLoading" :data="productionOutData" :fixedNO="true" customKey="JNPFTableKey_718355">
                        <el-table-column prop="orderNo" label="外协单号"    />
                        <el-table-column prop="cooperativePartnerCode" label="外协供应商编码" >
                  ...
                  <el-tab-pane label="入库" name="warehousing">
                    ...
                    <JNPF-table ref="warehousingREF" v-loading="listLoading" :data="warehousingData" :fixedNO="true" customKey="JNPFTableKey_366268">
                  ...
                  <el-tab-pane label="发货" name="delivery">
                    <JNPF-table ref="deliveryREF" v-loading="listLoading" :data="deliveryData" :fixedNO="true" customKey="JNPFTableKey_100576">
                  ...
                  <el-tab-pane label="对账收款" name="reconciliation">
                    <JNPF-table ref="reconciliationREF" v-loading="listLoading" :data="reconciliationData" :fixedNO="true" customKey="JNPFTableKey_583176">
        ...
        <div class="JNPF-common-layout" style="height: 68vh;overflow: auto;">
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <JNPF-table v-loading="listLoading" :data="allOrderList" :fixedNO="true" customKey="JNPFTableKey_271681">
