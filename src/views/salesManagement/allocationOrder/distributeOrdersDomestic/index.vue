        ...
        <el-tab-pane label="单据列表" name="orderForm">
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" :fixedNO="true"  @selection-change="handleSelectionChange" :hasC="orderForm.distributeStatus=='undistributed'"
        ...
        <el-tab-pane label="明细列表" name="detailForm">
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <div class="JNPF-common-head">
                <div>
                  <el-button size="mini" :disabled="btnLoading" @click="allocationDetail" type="primary" :loading="btnLoading">一键分配</el-button>
                  <el-button size="mini" :disabled="btnLoading" @click="allocationPlanDetail" type="primary" :loading="btnLoading">一键分配转计划</el-button>
                </div>
...
export default {
  ...
  methods: {
    ...
    allocationPlanDetail() {
      if (!this.allocationDetailList.length) return this.$message.error("请先勾选数据")
      this.btnLoading = true
      distributeTransferPlan(this.allocationDetailList).then(res => {
        console.log("res=>", res)
      this.btnLoading = false
        this.$message.success("一键分配转计划成功")
          this.initData()
    ...
    initData() {
      ...
      initDataMethod(activeForm).then(res => {
        ...
        else { this.detailData = res.data.records }
