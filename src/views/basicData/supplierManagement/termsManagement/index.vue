...
import {deleteTerms, getTermsPage} from "@/api/termsManagement";
      ...
      superQueryJson: [
        {
          ...
          label: '分类',
          type: 'select',
          options: this.getDictDataSync('clauseClassification')
        },
      ],
      listQuery: {},
      btnList: buttonList,
  ...
  methods: {
    async initData(listQuery) {
      ...
      try {
        ...
        const res = await getTermsPage(this.listQuery);
