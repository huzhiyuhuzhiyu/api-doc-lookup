                ...
                <el-tabs v-model="activeName"  @tab-click="handleClick" class="stafeOnfo">
                    ...
                    <el-tabs v-model="mrpactiveName" @tab-click="handleMRPClick">
                        <el-tab-pane label="生产需求" name="mrpproduce">
                            <JNPF-table  :data="produceData" highlight-current-row
                              ...
                              <!-- <el-table-column prop="availableQuantity" label="可用库存数量"  width="150">
                                <template slot-scope="scope">
                  ...
                  <el-tab-pane label="发货" name="delivery">
                    <JNPF-table ref="deliveryREF" v-loading="listLoading" :data="deliveryData" :fixedNO="true">
                        ...
                        <el-table-column prop="partnerCode" label="客户编码" >
                        ...
                        <el-table-column prop="delivery" label="发货方式" >
                          <template slot-scope="scope">
                        ...
                        <el-table-column prop="deliveryStatus" label="发货状态"   fixed="right" align="center">
                          <template slot-scope="scope">
                  ...
                  <el-tab-pane label="对账收款" name="reconciliation">
                    <JNPF-table ref="reconciliationREF" v-loading="listLoading" :data="reconciliationData" :fixedNO="true">
                        <el-table-column prop="orderNo" label="对账单号"    />
                        <el-table-column prop="reconciliationDate" label="对账日期" >
                        ...
                        <el-table-column prop="excludingTaxAmount" label="不含税总金额" min->
                            <template slot-scope="scope">
                        ...
                        <el-table-column prop="includingTaxAmount" label="含税总金额" min->
                          ...
                          <el-table-column prop="totalReconciliationAmount" label="对账金额" min->
                            <template slot-scope="scope">
                          ...
                          <el-table-column prop="totalPaymentAmount" label="已收款金额" min->
                            <template slot-scope="scope">
                          ...
                          <el-table-column prop="totalInvoicingAmount" label="已开票金额" min->
                            <template slot-scope="scope">
                          ...
                          <el-table-column prop="remark" label="备注" min- />
                          <el-table-column prop="createTime" label="创建时间"   />
                          <el-table-column prop="createByName" label="创建人" min-/>
                        <el-table-column label="操作"  fixed="right">
                         <template slot-scope="scope">
                           <el-button size="mini" type="text"
...
export default {
  props: {},
  // components: {PlanFormPage,  PurchaseFormPage,PickingFormPage, ProductOutFormPage,ProductionFormPage,ProductionrOutFormPage,DeliveryFormPage,ReconciliationFormPage,WarehousingFormPage },
    data() {
        return {
          planVisible:false,
