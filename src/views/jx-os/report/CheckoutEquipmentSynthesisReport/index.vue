...
<script>
import { getProductionCheckoutEquipmentSynthesisReport } from '@/api/report'
...
export default {
    ...
    data() {
        return {
            name: 'CheckoutEquipmentSynthesisReport',
            expandObj: {},
            columnOptions: [],
            mergeList: [],
            columnList,
                ...
                for (let i = 0; i < res.data.list.length; i++) {
                    ...
                    if (_data.result.mapping.mappingLines.length > 0) {
                        for (var j = 0; j < _data.result.mapping.mappingLines.length; j++) {
                            ...
                            } else if (_mapping.dictionary.code == _data.countNG2.code) {
                                _data.countNG2.name = _mapping.name
                            } else if (_mapping.dictionary.code == _data.countNG3.code) {
                                _data.countNG3.name = _mapping.name
                            } else if (_mapping.dictionary.code == _data.countNG4.code) {
