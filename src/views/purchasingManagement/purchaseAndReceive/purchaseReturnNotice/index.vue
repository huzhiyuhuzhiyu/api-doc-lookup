          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" :fixedNO="true"
                ...
                <el-table-column prop="purchaseOrderNo" label="采购单号" width="220" sortable="custom">
                ...
                <el-table-column prop="deliveryCompletionDate" label="退货完成时间" min-width="180"></el-table-column>

                <el-table-column prop="remark" min-width="140" label="备注" />
                <el-table-column prop="createTime" label="创建时间" min-width="180" sortable="custom" />
                <el-table-column prop="createByName" label="创建人" />
                <!-- <el-table-column prop="inspectionStatus" label="检验状态" align="center" width="120" sortable="custom" fixed="right">
                  <template slot-scope="scope">
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="linesTableData" v-loading="listLoading" :data="linesTableData" :fixedNO="true"
                ...
                <el-table-column prop="orderNo" label="退货单号" min-width="220" sortable="custom" fixed="left">
                  <template slot-scope="scope">
                    <el-link type="primary"
                      @click.native="addOrUpdateHandle(scope.row.purchaseReceiptReturnGoodsId, 'look')">{{
                        scope.row.orderNo
                      }}</el-link>
                  </template>
                </el-table-column>
                <el-table-column prop="purchaseOrderNo" label="采购单号" width="220" fixed="left">

                </el-table-column>

                <el-table-column prop="salesman" label="业务员" min-width="140" />
                <el-table-column prop="deliverDate" label="退货日期" min-width="140" sortable="custom" />
                  ...
                  <template slot-scope="scope">
                    ...
                    <el-dropdown hide-on-click>
                      ...
                      <el-dropdown-menu slot="dropdown">
                        ...
                        <el-dropdown-item
                          @click.native="addOrUpdateHandle(scope.row.purchaseReceiptReturnGoodsId, 'copy')">
                          复制通知单
                        </el-dropdown-item>
                      </el-dropdown-menu>
                    </el-dropdown>
...
export default {
  ...
  methods: {
    ...
    sortChange({ prop, order }) {
      let newProp;
      if (prop === 'productName' || prop === 'productDrawingNo' || prop === 'createTime' || prop === 'orderNo') {
        newProp = prop
      } else {
    ...
    initData() {
      ...
      if (this.activeName === 'dataTable') {
        ...
        purPurchaseReceiptReturnGoodsList(this.listQuery).then(res => {
          ...
          //   item.disabled = item.receivingStatus == 'returning' && item.approvalStatus == 'ok' ? false : true
          // })
        ...
        linesReceiptReturn(this.linesQuery).then(res => {
          ...
          //   item.disabled = item.receivingStatus == 'returning' && item.documentStatus == 'submit' ? false : true
          // })
