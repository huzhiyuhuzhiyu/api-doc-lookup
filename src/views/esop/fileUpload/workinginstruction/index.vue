...
import ChooseCategory from "@/views/esop/fileUpload/workinginstruction/chooseCategory.vue";
import ChooseProduct from "@/views/esop/fileUpload/workinginstruction/chooseProduct.vue";
import ChooseProcess from "@/views/esop/fileUpload/workinginstruction/chooseProcess.vue";
import SubmitFile from "@/views/esop/fileUpload/workinginstruction/submitFile.vue";
import FinishSubmit from "@/views/esop/fileUpload/workinginstruction/finishSubmit.vue";
export default {
