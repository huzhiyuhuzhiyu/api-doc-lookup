    ...
    */
        ...
        ecarts() {
            ...
            /* {
                 ...
                 series: [{
                     type: 'bar',
                     itemStyle: {normal: {color: '#0E96D0',label: {show: true,position: 'top',textStyle: { color: 'black',fontSize: 16}}}},

                 },
                 {
                     type: 'bar',
                     itemStyle: {normal: {color: '#67C23A',label: {show: true,position: 'top',textStyle: { color: 'black',fontSize: 16}}}}
                 },
                 {
                     type: 'bar',
                     itemStyle: {normal: {color: '#E6A23C',label: {show: true,position: 'top',textStyle: { color: 'black',fontSize: 16}}}}
                 },
                 {
                     type: 'bar',
                     itemStyle: {normal: {color: '#EF4136',label: {show: true,position: 'top',textStyle: { color: 'black',fontSize: 16}}}}
                 },
                 {
                     type: 'bar',
                     itemStyle: {normal: {color: '#909399',label: {show: true,position: 'top',textStyle: { color: 'black',fontSize: 16}}}}
                 }
                 ]
             };
  */
            ...
            //     ['在线率', '运转率','报警率' ,'故障率', '离线率']
            // ]
            // options.series = [{type: 'bar'},{type: 'bar'},{type: 'bar'},{type: 'bar'},{type: 'bar'}]
