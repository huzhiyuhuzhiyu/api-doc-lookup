    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" highlight-current-row :fixedNO="true" ref="tableForm" :data="tableDataList"
          ...
          <el-table-column prop="totalCost" label="成本合计(元)(不含税)" min-width="240" sortable="custom" />
          ...
          <el-table-column prop="listPrice" label="销售牌价" min-width="150" sortable="custom" /> 
          ...
          <el-table-column prop="updateTime" label="最新成本更新时间" min-width="200" sortable="custom">
            <template scope="scope">
...
export default {
  ...
  methods: {
    ...
    sortChange({ prop, order }) {
      ...
      if (prop == "materialCost"||prop=='totalCost'||prop=='totalLaborCost'||prop=='listPriceUpdateTime'||prop=='feeAmount'||prop=='totalProfitCost'||prop=='excludingTaxTotalProfitCost'||prop=='listPrice'||prop=='updateTime') { 
        newProp = prop.replace(/[A-Z]/g, match => '_' + match.toLowerCase());
      }else{
        newProp = prop
      }
