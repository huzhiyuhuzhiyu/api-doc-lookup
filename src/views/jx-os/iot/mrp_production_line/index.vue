    ...
    <div class="JNPF-common-layout-center">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        >
          ...
          />
          <el-table-column prop="mrpWorkshopId_name" label="生产车间" align="left"
          />
          <el-table-column prop="employeeId_name" label="负责人" align="left"
          />
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      request({
        url: `/api/mrp_production_line/Mrp_production_line/getList`,
        method: 'post',
        data: _query
      }).then(res => {
        var _list = []
    ...
    handleDel(id) {
      this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
        ...
        request({
          url: `/api/mrp_production_line/Mrp_production_line/${id}`,
          method: 'DELETE'
        }).then(res => {
          this.$message({
            type: 'success',
    ...
    download(data) {
      ...
      request({
        url: `/api/mrp_production_line/Mrp_production_line/Actions/Export`,
        method: 'post',
        data: query
      }).then(res => {
