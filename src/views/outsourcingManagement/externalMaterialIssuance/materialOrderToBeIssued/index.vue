      ...
      <div class="JNPF-common-layout-center JNPF-flex-main">
        <el-row class="JNPF-common-search-box" :gutter="16">
          <el-form @submit.native.prevent>
            ...
            <el-col :span="3">
              <el-form-item>
                <el-input v-model="orderForm.productDrawingNo" @keyup.enter.native="search()" placeholder="型号"
                  clearable />
              </el-form-item>
            </el-col>
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
          ...
          <JNPF-table v-if="tableFlag" ref="dataTable" :data="tableData" :fixedNO="true" hasC
            ...
            custom-column customKey="JNPFTableKey_628781">
...
export default {
  ...
  methods: {
    ...
    addSupplier(id, btntype) {
      ...
      this.$nextTick(() => {
        this.$refs.addForm.init(id, btntype, false, this.list, 'outInboundWarehouse')
      })
    },
