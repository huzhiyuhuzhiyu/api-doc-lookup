<template>
  <el-dialog title="选择工具" :close-on-click-modal="false" :close-on-press-escape="false" :visible.sync="allProVisible"
      ...
      <div class="JNPF-common-layout-center JNPF-flex-main">
        <el-row class="JNPF-common-search-box" :gutter="16">
          <el-form @submit.native.prevent>
            <el-col :span="6">
              <el-form-item>
                <el-input @keyup.native.enter="searchAllProduct()"  v-model="DeviceListRequestObj.code" placeholder="请输入工具编码" clearable />
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item>
                <el-input @keyup.native.enter="searchAllProduct()"  v-model="DeviceListRequestObj.name" placeholder="请输入工具名称" clearable />
              </el-form-item>
            </el-col>
...
import { getGroupList, editEquEquipmentAll, getEquEquipmentList,stateEquEquipment } from '@/api/basicData/index' // 工具 工具 接口
export default {
  data() {
    return {
      allProductTotal: 0,
