<template>
    ...
    <div class="JNPF-common-layout">
                ...
                > <!-- :header-cell-style="{background:'#eef1f6',color:'#606266'}" -->
                   <!-- <el-table-column prop="index" type="index" width="60" label="序号" align="center" fixed>
                    ...
                    <el-table-column prop="equipmentWorkpieceRatio" label="稼动率" align="center">
                        <el-table-column prop="equipmentWorkpieceRatio.timeRate" label="时间稼动率(%)" align="center" min-width="130">
                            <template slot-scope="{row}">
                                {{ row.equipmentWorkpieceRatio.timeRate }}%
                            </template>
                        </el-table-column>
                        <el-table-column prop="equipmentWorkpieceRatio.performanceRate" label="性能稼动率(%)" align="center" min-width="130">
                            <template slot-scope="{row}">
                                {{ row.equipmentWorkpieceRatio.performanceRate }}%
                            </template>
                        </el-table-column>
                        <el-table-column prop="equipmentWorkpieceRatio.realCropRate" label="实质稼动率(%)" align="center" min-width="130">
                            <template slot-scope="{row}">
                                {{ row.equipmentWorkpieceRatio.realCropRate }}%
                            </template>
                        </el-table-column>
                        <el-table-column prop="equipmentWorkpieceRatio.velocityRate" label="速度稼动率(%)" align="center" min-width="130">
                            <template slot-scope="{row}">
        ...
        <SuperQuery v-if="superQueryVisible" ref="SuperQuery" :columnOptions="superQueryJson" @superQuery="superQuery"/>
         <BiaoZhun v-if="formVisible" ref="JNPFForm"  :objectOptions="objectOptions" @refresh="refresh"   @setNormList="setNormList"></BiaoZhun>
