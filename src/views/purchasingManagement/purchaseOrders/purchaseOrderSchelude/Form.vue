        ...
        <div class="main" v-loading="formLoading" ref="main">
          <el-collapse v-model="activeNames1" class="orderInfo">
            <el-collapse-item title="基本信息" name="basicInfo">
              <div class="stoclInfo" ref="stoclInfo">
                ...
                <el-descriptions class="margin-top" :column="4">
                  <el-descriptions-item label="供应商名称" class="orderNo">{{ dataForm.cooperativePartnerName }}
            ...
            <el-collapse-item title="订单产品" name="product">
              ...
              <!-- 检验单 -->
              <div v-if="categoryType == 'checklist'">
              ...
              <!-- 质检退货单 -->
              <div v-if="categoryType == 'returnOrder'">
...
export default {
  components: {
     ShipementForm, ReturnForm, SaleOutboundForm, OutboundSaleSendForm, InboundSaleReturnForm, Reconciliation, ReceivePayRefundForm, InvoiceForm, PurchaseForm, ExtendForm
  },
  props: {
  ...
  data() {
    return {
      ...
      formVisible: false,
      categoryType: "deliveryNote",
      height: 0,
      relatedTaskVisible: false,
      categoryTypeList: [
        { code: "deliveryNote", fullName: "采购收货单", },
        { code: "checklist", fullName: "检验单", },
        { code: "badDan", fullName: "不良处理单", },
        { code: "outinboundwarehouse", fullName: "入库单", },
        { code: "returnOrder", fullName: "质检退货单", },
      ],
      shipmentData: [],
      productData: [],
      orderTypeList: [
...
//         { code: "returnOrder", fullName: "质检退货单", },
      ...
      if (this.categoryType == 'deliveryNote') {
        // 采购收货单
        let obj = {
      ...
      } else if (this.categoryType == 'badDan') {
        // 不良处理单
        this.requestObj.source = 'mrp'
        this.requestObj.ordersLineId = this.orderLinesId
        this.requestObj.orderType = 'procure'
        purchaseOrderList(this.requestObj).then(res => {
          console.log("不良处理单", res);
      ...
      } else if (this.categoryType == 'returnOrder') {
        // 质检退货单
        this.departMentList = []
