<template>
  <transition name="el-zoom-in-center">
    <div class="JNPF-preview-main org-form">
                  ...
                  <el-row :gutter="30" class="custom-row">
                    <el-col :sm="8" :xs="24">
                      <el-form-item label="产品名称" prop="productName">
                        <ComSelect-page v-model="dataForm.productName" @change="submitCustomerProduct1" :tableItems="ProductTableItems1" title="选择产品" treeTitle="产品分类" :methodArr="ProductMethodArr" :listMethod="getProductList" :listRequestObj="ProductListRequestObj" :searchList="ProductTableSearchList1" :isdisabled="btnType == 'look'" placeholder="请选择产品" />
                      </el-form-item>
                    </el-col>
                    <el-col :sm="8" :xs="24">
      ...
      <ComSelect-page ref="ComSelect-page" @change="submitAllProduct" :tableItems="ProductTableItems2" dialogTitle="选择产品" treeTitle="产品分类" :methodArr="ProductMethodArr" :listMethod="getProductList" :listRequestObj="ProductListRequestObj2" :searchList="ProductTableSearchList1" :elementShow="false" />
    </div>
  </transition>
</template>
