              ...
              <el-collapse-item title="产品信息" name="productInfo">
                ...
                <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm" class="data-form">
                  <el-table ref="product" :data="dataFormTwo.productData" v-bind="dataFormTwo.data" hasC hasNO fixedNO
                    ...
                    <el-table-column prop="productCode" label="客户料号" min-width="160"
                      show-overflow-tooltip></el-table-column>
                    <el-table-column prop="productCode" label="品名规格" min-width="160"
                      show-overflow-tooltip></el-table-column>
                    <el-table-column prop="productCode" label="产品编码" min-width="160"
                      show-overflow-tooltip></el-table-column>
                    <el-table-column prop="productCode" label="单位" min-width="160"
                      show-overflow-tooltip></el-table-column>
...
export default {
  data() {
    return {
      ...
      dataRule: {
        ...
        cooperativePartnerName: [{ required: true, message: '供应商不能为空', trigger: 'change' }],
  ...
  methods: {
    ...
    searchProductFun() {
      ...
      getsaleOrderDetailList(this.orderForm)
        .then((res) => {
          console.log('产品', res)
