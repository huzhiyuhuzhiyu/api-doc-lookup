    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      <div class="JNPF-common-layout-center JNPF-flex-main">
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main">
          ...
          <JNPF-table ref="dataTable" @selection-change="handleSelectionChange" hasC v-loading="listLoading" :data="tableData" :fixedNO="true" custom-column customKey="JNPFTableKey_801185">
