<template>
 ...
 customKey="JNPFTableKey_470331">
                                                <el-table-column prop="content_name" label="模板内容（JSON）"  align="left"
/>
         ...
         this.columnOptions = this.transformColumnList(this.columnList)
            ...
            handleDel(id) {
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    request({
                        url: `/api/os.jx/T_custom_field_template/${id}`,
                        method: 'DELETE'
                    }).then(res => {
                        this.$message({
                            type: 'success',
            ...
            download(data) {
                ...
                request({
                    url: `/api/os.jx/T_custom_field_template/Actions/Export`,
                    method: 'post',
                    data: query
                }).then(res => {
