    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      <el-row class="JNPF-common-search-box" :gutter="16">
        <el-form @submit.native.prevent>
          ...
          <el-col :span="5">
            <el-form-item>
              <el-input v-model.trim="listQuery.programName" placeholder="请输入当前运行程序" @keyup.enter.native="search()" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item>
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="tableData" :fixedNO="true" :customColumn="true" ref="dataTable"
          ...
          <el-table-column prop="storageLocation" label="存放地点" min-width="200" />
          <el-table-column prop="programName" label="当前运行程序" min-width="160" sortable="custom" />
...
import { conditionlList } from '@/api/productOrdes'
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      conditionlList(this.listQuery).then(res => {
        console.log("res++", res)
