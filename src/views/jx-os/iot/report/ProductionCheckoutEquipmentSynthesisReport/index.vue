            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                ...
                > <!-- :header-cell-style="{background:'#eef1f6',color:'#606266'}" -->
                    ...
                    <el-table-column prop="cl" label="产量" align="center">
                        ...
                        <el-table-column prop="cumulativeOutput.value" label="累计产量" align="left" min-width="100"/>
...
export default {
    ...
    data() {
        return {
            ...
            normList: [
                {
                    object: 'equipmentWorkpieceRatio.timeRate',
                    operator: 'in',
                    value: 1,
                    value2: 100,
                    color: '#67C23A'
                ...
                {
                    object: 'equipmentWorkpieceRatio.performanceRate',
                    operator: '==',
                    value: 0,
                    color: '#02F322'
                },
                {
                    object: 'thisWeekOutput.max',
                    operator: '<',
                    value: 30000,
                    color: '#F2F322'
                },
