          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table v-loading="listLoading" :data="tableData" fixedNO @sort-change="sortChange" custom-column
                ref="dataTable">
                <el-table-column prop="orderNo" label="入库单号" min-width="200" fixed="left" sortable="custom">
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table v-loading="listLoading" :data="linesTableData" fixedNO @sort-change="sortChange" custom-column
                ...
                <el-table-column prop="orderNo" label="入库单号" min-width="200" fixed="left" sortable="custom">
                  <template slot-scope="scope">
                    <el-link type="primary" @click.native="addOrUpdateHandle(scope.row.moveId, true)">
                      {{ scope.row.orderNo }}
                    </el-link>
                  </template>
                </el-table-column>
                  ...
                  <template slot-scope="scope">
                    <tableOpts @edit="addOrUpdateHandle(scope.row.moveId)" @del="handleDel(scope.row.moveId)"
                      ...
                      <el-dropdown hide-on-click>
                        ...
                        <el-dropdown-menu slot="dropdown">
                          <el-dropdown-item @click.native="addOrUpdateHandle(scope.row.moveId, true)">
                            查看详情
                          </el-dropdown-item>
                        </el-dropdown-menu>
                      </el-dropdown>
  ...
  data() {
    return {
      ...
      initListQuery: {
        ...
        warehouseType: "scrap", // 仓库类型 正常仓库 normal , 报废仓库 scrap
        orderItems: [{
          asc: false,
          column: ""
        }, {
