                    ...
                    <div class="JNPF-common-layout-center JNPF-flex-main">
                        <el-row class="JNPF-common-search-box" :gutter="16">
                            <el-form @submit.native.prevent>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-input v-model="dataForm.orderNo" @keyup.enter.native="search()"
                                            placeholder="请输入补料单号" clearable />
                                    </el-form-item>
                                </el-col>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-input v-model="dataForm.personName" @keyup.enter.native="search()"
                                            placeholder="请输入补料人" clearable />
                                    </el-form-item>
                                </el-col>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-date-picker v-model="orderDateArr" type="daterange" value-format="yyyy-MM-dd"
                                            style="width: 100%;" :picker-options="global.timePickerOptions"
                                            start-placeholder="补料开始日期" end-placeholder="补料结束日期" clearable>
                                        </el-date-picker>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
                        ...
                        <div class="JNPF-common-layout-main JNPF-flex-main">
                            ...
                            <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" @sort-change="sortChange"
                                custom-column>
                                <el-table-column prop="orderNo" label="补料单号" min-width="200" sortable="custom">
                                ...
                                <el-table-column prop="personName" label="补料人" min-width="150" />
                                <el-table-column prop="operationDate" label="补料日期" min-width="150" sortable="custom" />
                                ...
                                <el-table-column prop="approvalStatus" label="审批状态" fixed="right" width="120"
                                    ...
                                    <template slot-scope="scope">
                                        ...
                                        <div
                                            v-if="scope.row.approvalStatus == 'ok' && scope.row.documentStatus == 'submit'">
                                            <el-tag type="success">审批通过</el-tag>
                                        </div>
                                        <div
                                            v-if="scope.row.approvalStatus == 'rebut' && scope.row.documentStatus == 'submit'">
                    ...
                    <div class="JNPF-common-layout-center JNPF-flex-main">
                        <el-row class="JNPF-common-search-box" :gutter="16">
                            <el-form @submit.native.prevent>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-input v-model="linesQuery.orderNo" placeholder="请输入补料单号"
                                            @keyup.enter.native="search()" clearable />
                                    </el-form-item>
                                </el-col>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-input v-model="linesQuery.personName" placeholder="请输入补料人"
                                            @keyup.enter.native="search()" clearable />
                                    </el-form-item>
                                </el-col>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-date-picker v-model="deliveryDatefahuo" type="daterange"
                                            value-format="yyyy-MM-dd" style="width: 100%;" clearable
                                            start-placeholder="补料开始日期" end-placeholder="补料结束日期">
                                        </el-date-picker>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
                        ...
                        <div class="JNPF-common-layout-main JNPF-flex-main">
                            ...
                            <JNPF-table ref="linesTableData" v-loading="listLoading" :data="linesTableData" :fixedNO="true"
                                ...
                                <el-table-column prop="orderNo" label="补料单号" width="200" sortable="custom" fixed="left">
                                    <template slot-scope="scope">
                                        <el-link type="primary"
                                            @click.native="handleUserRelation(scope.row.materialCollectId, 'look')">
                                            {{ scope.row.orderNo }}
                                        </el-link>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="personName" label="补料人" width="120" sortable="custom">
                                </el-table-column>
                                <el-table-column prop="operationDate" label="补料日期" width="180" sortable="custom" />
                                ...
                                <el-table-column prop="num" label="补料数量" min-width="120" />
                                ...
                                <el-table-column label="操作" fixed="right" width="180">
                                    <template slot-scope="scope">
                                        <el-button size="mini" type="text"
                                            :disabled="scope.row.documentStatus == 'draft' ? false : true"
                                            @click="updateHandle(scope.row.materialCollectId, 'edit')">编辑</el-button>
                                        <el-button size="mini" type="text" class="JNPF-table-delBtn"
                                            :disabled="scope.row.documentStatus == 'draft' ? false : true"
                                            @click="handleDel(scope.row.materialCollectId)">删除</el-button>
                                        <el-dropdown hide-on-click>
                                            <span class="el-dropdown-link">
                                                <el-button type="text" size="mini">
                                                    {{ $t('common.moreBtn') }}<i
                                            ...
                                            <el-dropdown-menu slot="dropdown">
                                                ...
                                                <el-dropdown-item
                                                    @click.native="handleUserRelation(scope.row.materialCollectId, 'copy')">
                                                    复制通知单
                                                </el-dropdown-item>
                                            </el-dropdown-menu>
                                        </el-dropdown>
        ...
        <el-dialog title="更多查询" :close-on-click-modal="false" :close-on-press-escape="false" :visible.sync="visible"
            ...
            <el-row :gutter="20" v-if="activeName === 'orderList'">
                <el-form :model="dataForm" label-width="120px" label-position="top">
                    <el-col :span="12">
                        <el-form-item label="补料单号">
                            <el-input v-model="dataForm.orderNo" placeholder="请输入补料单号" clearable />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                    ...
                    <el-col :span="12">
                        <el-form-item label="补料人">
                            <el-input v-model="dataForm.personName" placeholder="请输入补料人" clearable />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="补料日期">
                            <el-date-picker v-model="orderDateArr" type="daterange" value-format="yyyy-MM-dd"
                                style="width: 100%;" :picker-options="global.timePickerOptions" start-placeholder="补料开始日期"
                                end-placeholder="补料结束日期" clearable>
                            </el-date-picker>
                        </el-form-item>
                    </el-col>

                    <el-col :span="12">
                        <el-form-item label="补料状态">
                            <el-select v-model="dataForm.pickingStatus" placeholder="请选择补料状态" clearable>
                    ...
                    <el-col :span="12">
                        <el-form-item label="创建时间">
                            <el-date-picker v-model="createTimeArrsta" type="datetimerange" format="yyyy-MM-dd HH:mm:ss"
                                :picker-options="global.timePickerOptions" value-format="yyyy-MM-dd HH:mm:ss"
            ...
            <el-row :gutter="20" v-else>
                <el-form ref="diaForm" :model="linesQuery" label-width="120px" label-position="top">
                    <el-col :span="12">
                        <el-form-item label="补料单号">
                            <el-input v-model="linesQuery.orderNo" placeholder="请输入补料单号" clearable />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="补料人">
                            <el-input v-model="linesQuery.personName" placeholder="请输入补料人" clearable />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="补料日期">
                            <el-date-picker v-model="deliveryDatefahuo" type="daterange" value-format="yyyy-MM-dd"
                                style="width: 100%;" clearable start-placeholder="请选择补料开始日期" end-placeholder="请选择补料结束日期">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
