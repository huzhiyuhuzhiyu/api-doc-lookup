          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <div class="scanCodeTent">
              <div class="searchregion">
                <el-input v-model="scanResult" placeholder="请输入编码或单号,支持扫码" @keyup.enter.native="searchResult()" class="scanResultIpt"></el-input>
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                ...
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="workGroupForm.name" @keyup.enter.native="getWorkGroupData()" placeholder="名称"
                      clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="workGroupForm.code" @keyup.enter.native="getWorkGroupData()" placeholder="编码"
                      clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="6">
