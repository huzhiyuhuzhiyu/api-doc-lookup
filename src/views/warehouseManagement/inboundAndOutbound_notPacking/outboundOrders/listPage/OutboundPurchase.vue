          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <div class="JNPF-common-head">
                <el-page-header @back="$emit('close', true)" :content="'采购退货出库'" />
              ...
              <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" :fixedNO="true"
                ...
                <el-table-column prop="purchaseOrderNo" label="采购单号" min-width="190" sortable="custom" />
...
// import DetailForm from '@/views/purchasingManagement/purchaseAndReceive/purchaseReturnNotice/Form.vue'
import DetailForm from '../../../inboundAndOutbound/outboundOrders/detailForm/OutboundPurchase.vue'
export default {
  ...
  data() {
    return {
      ...
      initListQuery: {
        ...
        pageNum: 1,
        pageSize: 20,
        notificationType: 'procure', // 类型（采购）
  ...
  methods: {
    ...
    addOrUpdateHandle(id, readOnly) {
      if (readOnly) {
        ...
        this.$nextTick(() => { this.$refs.Form.init(id, undefined, "outbound_purchase") })
      }
    },
    search() {
      if (this.activeName === 'dataTable') {
    ...
    sortChange({ prop, order }) {
      ...
      if (this.activeName === 'dataTable') {
        ...
        if (prop === 'purchaseOrderNo' || prop === 'productName' || prop === 'productDrawingNo' || prop === 'createTime' || prop === 'orderNo') { newProp = prop }
        else { newProp = prop.replace(/[A-Z]/g, match => '_' + match.toLowerCase()); }
