    ...
    return {
      ...
      linesListItems: [
        ...
        { prop: "availableQuantity", label: "总可用数量", value: "", type: 'view', minWidth: 120, render: this.openMode !== '只读' },
        {
          ...
          itemRules: [
            { required: true, trigger: 'blur' },
            {
              validator: this.formValidate({
                type: 'calc',
                params: [
                  (rowIndex, value) => Number(value) <= Number(this.linesList[rowIndex].availableQuantity),
                  "出库不能超过对应总可用数量",
          ...
          ], minWidth: 120, itemDisabled: this.openMode === '只读' || this.$parent.dataForm.sourceType !== 'outbound_pick_out'
        },
