                    ...
                    <div class="JNPF-common-layout-center JNPF-flex-main">
                                ...
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-date-picker v-model="orderDateArr" type="daterange" value-format="yyyy-MM-dd"
                                            ...
                                            start-placeholder="超领料开始日期" end-placeholder="超领料结束日期" clearable>
                                        </el-date-picker>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
                        ...
                        <div class="JNPF-common-layout-main JNPF-flex-main">
                            ...
                            <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" @sort-change="sortChange"
                                ...
                                <el-table-column prop="operationDate" label="超领料日期" min-width="150" sortable="custom" />
                    ...
                    <div class="JNPF-common-layout-center JNPF-flex-main">
                        <el-row class="JNPF-common-search-box" :gutter="16">
                            <el-form @submit.native.prevent>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-input v-model="linesQuery.orderNo" placeholder="请输入超领料单号"
                                            @keyup.enter.native="search()" clearable />
                                    </el-form-item>
                                </el-col>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-input v-model="linesQuery.personName" placeholder="请输入超领料人"
                                            @keyup.enter.native="search()" clearable />
                                    </el-form-item>
                                </el-col>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-date-picker v-model="deliveryDatefahuo" type="daterange"
                                            ...
                                            start-placeholder="超领料开始日期" end-placeholder="超领料结束日期">
                                        </el-date-picker>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
                        ...
                        <div class="JNPF-common-layout-main JNPF-flex-main">
                            ...
                            <JNPF-table ref="linesTableData" v-loading="listLoading" :data="linesTableData" :fixedNO="true"
                                ...
                                <el-table-column prop="operationDate" label="超领料日期" width="180" sortable="custom" />
                ...
                <el-form :model="dataForm" label-width="120px" label-position="top">
                    ...
                    <el-col :span="12">
                        <el-form-item label="超领料日期">
                            <el-date-picker v-model="orderDateArr" type="daterange" value-format="yyyy-MM-dd"
                                style="width: 100%;" :picker-options="global.timePickerOptions" start-placeholder="超领料开始日期"
                                end-placeholder="超领料结束日期" clearable>
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="12">
                        <el-form-item label="超领料日期">
                            <el-date-picker v-model="deliveryDatefahuo" type="daterange" value-format="yyyy-MM-dd"
                                style="width: 100%;" clearable start-placeholder="请选择超领料开始日期" end-placeholder="请选择超领料结束日期">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
