      ...
      <div class="JNPF-common-layout-center JNPF-flex-main">
        <div class="treeBox_bot gjsearch" ref="fangan">
          ...
          <div style="min-width: 136px;">
            <el-button class="btnBox" :class="{'is-reverse':listQuery.privateFlag==1}" size="mini" @click="btnsearch()">我的拜访计划</el-button>
          </div>
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main">
          ...
          <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" :fixedNO="true" @sort-change="sortChange" custom-column customKey="JNPFTableKey_628122">
