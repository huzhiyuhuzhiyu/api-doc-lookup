...
>
                                                <el-table-column prop="code_name" label="产品编码"  align="left"
/>
                                                <el-table-column prop="name_name" label="产品名称"  align="left"
/>
                                                <el-table-column prop="specification_name" label="产品规格"  align="left"
/>
         ...
         this.columnOptions = this.transformColumnList(this.columnList)
            ...
            initData() {
             ...
             dataType: 0,
                ...
                request({
                    url: `/api/jx/Product_product/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            download(data) {
                ...
                request({
                    url: `/api/jx/Product_product/Actions/Export`,
                    method: 'post',
                    data: query
                }).then(res => {
