          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
                ...
                <el-col :span="4">
                  <el-form-item>
                    <ComSelect-list :requestObj="{ type: 'normal' }" :dialogTitle="'请选择仓库'"
                      v-model="orderForm.warehouseName" :method="getWarehouseList" placeholder="请选择仓库"
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" :fixedNO="true"
                ...
                <el-table-column prop="approvalCompletionDate" label="审批完成日期" width="180"
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="linesQuery.orderNo" placeholder="请输入转换单号" @keyup.enter.native="search()"
                      clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
                    <ComSelect-list :requestObj="{ type: 'normal' }" :dialogTitle="'选择仓库'" v-model="linesQuery.warehouseName"
    ...
    <el-dialog :title="title" :close-on-click-modal="false" :close-on-press-escape="false" :visible.sync="visible"
      ...
      <el-row :gutter="20" v-if="activeName === 'orderList'">
        ...
        <el-form ref="diaForm" :model="orderForm" label-width="120px" label-position="top">
          <el-col :span="12">
            <el-form-item label="转换单号">
              <el-input v-model="orderForm.orderNo" placeholder="请输入转换单号" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="仓库">
              <ComSelect-list :requestObj="{}" :dialogTitle="'请选择仓库'" v-model="orderForm.warehouseName"
                :method="getWarehouseList" placeholder="请选择仓库" @change="changeWarehouse"></ComSelect-list>
            </el-form-item>
          </el-col>
      ...
      <el-row :gutter="20" v-else>
        <el-form ref="diaForm" :model="linesQuery" label-width="120px" label-position="top">
          <el-col :span="12">
            <el-form-item label="转换单号">
              <el-input v-model="linesQuery.orderNo" placeholder="请输入转换单号" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="仓库名称">
              <ComSelect-list :requestObj="{}" :dialogTitle="'选择仓库'" v-model="linesQuery.warehouseName"
                :method="getWarehouseList" placeholder="请选择仓库" @change="changeWarehousex"></ComSelect-list>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="原批次号">
              <el-input v-model="linesQuery.originBatchNumber" placeholder="请输入原批次号" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="目标产品名称">
              <el-input v-model="linesQuery.targetProductsName" placeholder="请输入目标产品名称" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="目标批次号">
              <el-input v-model="linesQuery.targetBatchNumber" placeholder="请输入目标批次号" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="创建时间">
