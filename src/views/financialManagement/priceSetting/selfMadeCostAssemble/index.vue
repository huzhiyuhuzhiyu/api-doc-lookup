    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" highlight-current-row :fixedNO="true" ref="tableForm" :data="tableDataList"
          @sort-change="sortChange" custom-column border @selection-change="handleSelectionChange" hasC customKey="JNPFTableKey_227740">

          <el-table-column prop="productsCode" label="产品编码" min-width="120" show-overflow-tooltip sortable="custom" />
          <el-table-column prop="productsName" label="产品名称" min-width="120" show-overflow-tooltip sortable="custom" />
          <el-table-column prop="productsDrawingNo" label="产品图号" min-width="240" show-overflow-tooltip />
          <el-table-column prop="materialCost" label="材料成本" min-width="120" show-overflow-tooltip sortable="custom" />
          ...
          <el-table-column prop="updateTime" label="最新成本更新时间" min-width="160" >
    ...
    <el-dialog :title="title" :close-on-click-modal="false" :close-on-press-escape="false" :visible.sync="visible"
      ...
      <el-row :gutter="20">
        ...
        <el-form ref="diaForm" :model="dataForm" label-width="120px" label-position="top">
          ...
          <el-col :span="12">
            <el-form-item label="最新成本更新时间" prop="planStartDate">
...
export default {
  ...
  methods: {
    ...
    sortChange({ prop, order }) {
      let newProp = null
      if (prop == "productsCode" || prop == "productsName" ) {
        newProp = prop
