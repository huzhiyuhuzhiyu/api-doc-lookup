  ...
  <transition name="el-zoom-in-center">
    <div class="JNPF-preview-main org-form">
      <div :class="['JNPF-common-page-header', btnType === 'look' ? 'noButtons' : '']" v-if="!approvalFlag">
        <el-page-header @back="goBack" content="检验单" />
              ...
              <el-row :gutter="30" style="padding:0 10px">
                <el-col :sm="6" :xs="24">
                  <el-form-item label="检验单号">
                    <el-input v-model="dataForm.inspectionOrderNo" placeholder="检验单号" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="6" :xs="24">
              ...
              <el-row :gutter="30" style="padding:0 10px">
                ...
                <el-col :sm="12" :xs="24">
                  <el-form-item label="让步接收数量">
                    <el-input v-model="dataForm.actualConcessionQuantity" placeholder="让步接收数量" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="返工数量">
                    <el-input placeholder="返工数量" v-model="dataForm.actualReworkQuantity" disabled>
                      <template slot="append">
                        <el-button @click="setReworkWasteM">查看</el-button>
                      </template>
                    </el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="责废数量">
                    <el-input placeholder="责废数量" v-model="dataForm.actualResponsibilityWasteQuantity" disabled>
                      <template slot="append">
                        <el-button @click="setResponsWasteM">查看</el-button>
                      </template>
                    </el-input>
                  </el-form-item>
                </el-col>
