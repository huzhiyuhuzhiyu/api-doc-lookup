            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                <div class="JNPF-common-head">
                    <div>
                        ...
                        <el-button type="primary" icon="el-icon-copy-document" @click="exportData()">导出Excel
                        </el-button>
                    </div>
                ...
                >
                    ...
                    <!-- <el-table-column prop="" :label="index" align="center" min-width="120" v-for="index in 14" />-->
...
import { getEquipmentOeeList_v2 } from '@/api/report'
...
export default {
    ...
    methods: {
        ...
        initData() {
            ...
            getEquipmentOeeList_v2(_query).then(res => {
                var _list = []
        ...
        download(data) {
            ...
            request({
                url: `/api/equipment/EquipmentReport/Actions/Export`,
                method: 'post',
                data: query
            }).then(res => {
