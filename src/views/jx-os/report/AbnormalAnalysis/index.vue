    ...
    <div class="JNPF-common-layout">
        <div class="JNPF-common-layout-center">
            ...
            <div class="JNPF-common-layout-main">
                <div
                    style="width: calc(45% - 10px); display: inline-block; vertical-align: top; height: calc(100vh - 245px); overflow: auto;"
                >
                ...
                <div style="width: 10px;height: 110%; display: inline-block;  vertical-align: top; background-color: #EBEEF5;"></div>
                <div style="width: 54%; display: inline-block; vertical-align: top;">
                    <JNPF-table v-loading="listLoading" height="calc(100vh - 255px)" :data="list">
                        ...
                        <el-table-column prop="retaineruuid" label="异常编码" align="left" min-width="100"/>
