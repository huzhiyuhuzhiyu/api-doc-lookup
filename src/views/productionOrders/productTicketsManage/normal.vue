    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <JNPF-table v-loading="listLoading" highlight-current-row fixedNO ref="tableForm" :data="tableData"
          ...
          <el-table-column prop="orderNo" label="工单号" min-width="200" sortable="custom" fixed="left" >
          ...
          <el-table-column prop="productName" label="产品名称" min-width="180" fixed="left" />
          <el-table-column prop="productDrawingNo" label="产品图号" min-width="180" fixed="left" />
          <el-table-column prop="processCode" label="工序编码" min-width="120" fixed="left" />
          <el-table-column prop="processName" label="工序名称" min-width="120" sortable="custom" fixed="left" />
          ...
          <el-table-column prop="completedQuantity" label="完成数量" min-width="120" />
        ...
        <el-form ref="diaForm" :model="listQuery" label-position="top">
          ...
          <el-col :span="12">
            <el-form-item label="实际开始日期">
              <el-date-picker v-model="listQuery.actualStartTime" type="daterange" value-format="yyyy-MM-dd"
          ...
          <el-col :span="12">
            <el-form-item label="实际结束日期">
              <el-date-picker v-model="listQuery.actualEndTime" type="daterange" value-format="yyyy-MM-dd"
                style="width: 100%;" start-placeholder="请选择开始时间" end-placeholder="请选择结束时间"
                :picker-options="global.timePickerOptions" :default-time="['00:00:00', '23:59:59']" clearable>
              </el-date-picker>
            </el-form-item>
  ...
  data() {
    return {
      ...
      initListQuery: {
        ...
        orderNo: "",
        orderType: "normal", // 订单类型 正常订单 normal、返工订单 rework
        demandType: "finish_product", // 需求类型 成品 finish_product、半成品 semi_finished
        pageNum: 1,
        pageSize: 20,
        planEed: "", // 计划结束-结束时间
        planEsd: "", // 计划结束-开始时间
