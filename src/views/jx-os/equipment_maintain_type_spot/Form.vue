...
export default {
    ...
    methods: {
        ...
        clearData() {
            ...
            this.dataForm.equipment_maintain_type_itemList.type = "2";
            this.dataForm.equipment_maintain_type_itemList.active = 1;
            this.dataForm.equipment_maintain_type_itemList1.type = "2";
            this.dataForm.equipment_maintain_type_itemList1.active = 1;
            this.dataForm.equipment_maintain_type_itemList2.type = "2";
            this.dataForm.equipment_maintain_type_itemList2.active = 1;
            this.dataForm.equipment_maintain_type_itemList3.type = "2";
