    ...
    <div class="JNPF-preview-main org-form">
      <div :class="['JNPF-common-page-header', btnType === 'look' ? 'noButtons' : '']">
        ...
        <el-page-header @back="goBack"
          :content="btnType == 'add' ? '新建销售调价单' : btnType == 'edit' ? '编辑销售调价单' : '查看销售调价单'" />
        ...
        <div class="JNPF-common-layout" style="height: 68vh;overflow: auto;">
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <JNPF-table v-loading="listLoading" :data="tableDataCustomer" @row-dblclick="seleceCustomer" customKey="JNPFTableKey_558835">
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="24">
              <el-form @submit.native.prevent>
                <el-col :span="5">
                  <el-form-item>
                    <el-input @keyup.native.enter="searchcusProduct()"  v-model="productForm.customerProductNo" placeholder="请输入客户物料号" clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="5">
                  <el-form-item>
                    <el-input @keyup.native.enter="searchcusProduct()"  v-model="productForm.customerProductDrawingNo" placeholder="请输入客户产品图号" clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <JNPF-table v-loading="listLoading" :data="cusProductData" hasC @selection-change="handleSelectionChange"
                @row-click="rowaction" ref="dataTable" customKey="JNPFTableKey_857788">
