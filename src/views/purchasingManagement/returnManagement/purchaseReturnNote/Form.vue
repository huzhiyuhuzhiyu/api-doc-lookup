              ...
              <el-collapse-item title="产品信息" name="productInfo">
                ...
                <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm" class="data-form">
                  <el-table ref="product" :data="dataFormTwo.productData" v-bind="dataFormTwo.data" hasC hasNO fixedNO
                    ...
                    <el-table-column prop="excludingTaxAmount" label="金额(不含税)" width="160" v-if="userInfo.roleCode.split(',').includes('show_procure_data')">
                      <template slot-scope="scope">
          ...
          <el-collapse-item title="产品信息" name="productInfo">
            ...
            <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm" class="data-form">
              <el-table ref="product" :data="dataFormTwo.productData" v-bind="dataFormTwo.data" hasC hasNO fixedNO
                ...
                <el-table-column prop="excludingTaxAmount" label="金额(不含税)" width="150" v-if="userInfo.roleCode.split(',').includes('show_procure_data')">
                  <template slot="header">
                    <span class="required">*</span>
                    金额(不含税)
                  </template>
