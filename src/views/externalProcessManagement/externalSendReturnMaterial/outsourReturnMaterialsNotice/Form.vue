      ...
      <div class="JNPF-preview-main org-form">
        <div :class="['JNPF-common-page-header', type === 'look' ? 'noButtons' : '']">
          <el-page-header @back="goBack"
            :content="type == 'add' ? '新建工序外协退料通知单' : type == 'edit' ? '编辑工序外协退料通知单' : type == 'copy' ? '新建工序外协退料通知单' : '查看工序外协退料通知单'" />
            ...
            <el-tab-pane label="基础信息" name="jcInfo">
                ...
                <el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px"
                  ...
                  <el-col :sm="8" :xs="24" v-if="type === 'look'">
                    <el-form-item label="退料状态" prop="deliveryStatus" ref="deliveryStatus">
                      <el-input type="text" v-model="dataForm.deliveryStatus === 'not_returned' ? '未完成' : '已完成'"
              ...
              <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm">
                <el-table style="border: 1px solid #e3e7ee;" hasNO fixedNO v-bind="dataFormTwo.data"
                  ...
                  <el-table-column prop="routingName" label="工艺路线名称" min-width="200">
                    <template slot-scope="scope">
                  ...
                  <el-table-column prop="outboundQuantity" :label="type === 'look' ? '已入库数量' : '已出库数量'" min-width="200">
                    <template slot-scope="scope">
                      <el-form-item prop="outboundQuantity">
                        <div class="viewData">
                          <span>{{ scope.row.outboundQuantity ? scope.row.outboundQuantity : 0 }}</span>
                        </div>
                      </el-form-item>
                    </template>
                  </el-table-column>
        ...
        if (!this.dataForm.id) {
          ...
          getQuotationsendlist(this.dataForm.id).then(res => {
            ...
            if (this.type === 'copy') {
              ...
              this.dataForm.deliveryStatus = "not_returned"
