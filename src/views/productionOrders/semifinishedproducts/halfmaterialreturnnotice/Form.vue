    ...
    <div class="JNPF-preview-main org-form">
      <div :class="['JNPF-common-page-header', btnType === 'look' ? 'noButtons' : '']">
        ...
        <el-page-header @back="goBack"
          :content="btnType == 'add' ? '新建半成品退料通知单' : btnType == 'edit' ? '编辑半成品退料通知单' : btnType == 'copy' ? '新建半成品退料通知单' : '查看半成品退料通知单'" />
            ...
            <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm" class="data-form">
              <el-table ref="product" :data="dataFormTwo.productData" v-bind="dataFormTwo.data" hasC hasNO fixedNO
                ...
                <el-table-column prop="outboundQuantity" label="已出库数量" width="auto" show-overflow-tooltip
                  v-if="btnType !== 'look'" key="2">
                </el-table-column>
                <el-table-column prop="returnedQuantity" label="已退料数量" width="auto" show-overflow-tooltip
                  v-if="btnType !== 'look'" key="3">
                </el-table-column>
                <el-table-column prop="outboundQuantity" label="已入库数量" width="auto" show-overflow-tooltip
