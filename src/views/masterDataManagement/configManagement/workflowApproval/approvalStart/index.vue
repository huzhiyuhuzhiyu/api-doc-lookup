          ...
          <JNPF-table v-loading="listLoading" :data="tableData" @sort-change="sortChange" ref="dataTable" custom-column customKey="JNPFTableKey_550374">
            ...
            <el-table-column prop="approvalFormStatus" label="流程状态" align="center" min-width="120">
              <template slot-scope="scope">
                ...
                <div v-else-if="scope.row.approvalFormStatus == 'withdrawn'">
            ...
            <el-table-column label="操作" min-width="140">
              <template slot-scope="scope">
                <el-button :disabled="scope.row.approvalFormStatus !== 'ing'" type="text"
                  @click="withdrawnHandle(scope.row.id, 'withdrawn')" size="mini">撤回</el-button>
...
<script>
import { approvalCenterList, withdrawn } from '@/api/basicData/approvalAdministrator'
