    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <JNPF-table v-loading="listLoading" highlight-current-row fixedNO ref="tableForm" :data="tableDataList"
          ...
          <el-table-column prop="classAttribute" label="类别属性" width="120" fixed="left" sortable="custom"
...
import Form from '@/views/warehouseManagement/inventory/Form.vue'
export default {
  components: { Form },
  data() {
    return {
  ...
  methods: {
    ...
    handleDetail(scope, typeFlag) {
      ...
      this.$nextTick(() => {
        ...
        this.$refs.Form.init(productsId, routingLineId, processId, typeFlag, "", ["safeInventory"], 'scrap')
      })
    },
    // 关闭明细页面
    closeForm(isRefresh) {
