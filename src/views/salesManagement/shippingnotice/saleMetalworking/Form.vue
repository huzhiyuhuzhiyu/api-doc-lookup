...
import {addQuotationsendlist, confirmOrdersNotice, editQuotationMsendlist, getQuotationsendlist} from "@/api/salesManagement";
...
export default {
  ...
  methods: {
    ...
    async defaultInit(prefillData) {
      ...
      this.apiMethodActions.confirm.deliveryStatus = this.dataForm.deliveryStatus === 'ready' ? 'arranged' : ''
...
<template>
  <transition name="el-zoom-in-center">
    <div class="JNPF-preview-main org-form">
            ...
            <div class="JNPF-common-page-header">
              ...
              <div class="options">
                <template v-if="activeType">
                  <template v-if="btnType === 'add' || btnType === 'edit' || btnType === 'copy'">
      ...
      <!--  导入-->
      <UploadImportData ref="uploadRef" v-if="uploadVisible" :extraFormData="extraFormData" :uploadApi="uploadProduct"
