        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          ...
          <template v-for="item in tabs">
            <el-tab-pane :label="item.tabName" :name="item.tabCode" :key="item.tabCode"
              ...
              <DkcCol v-model="dataForm" :tabContent="item.tabContent" ref="dataForm" :openMode="openMode" />
            </el-tab-pane>
          </template>
          <!-- 自定义属性 -->
          <el-tab-pane :label="attributeLine.tabName" :name="attributeLine.tabCode">
            <DkcCol v-if="attributeFlag" v-model="attributeForm[pid]" :tabContent="attributeLine.tabContent"
...
import DkcCol from "./components/JNPF-col";
