          ...
          <el-col :span="4">
            <el-form-item>
              <el-select v-model="listQuery.productSource" :placeholder="productName + '来源'" clearable
                style="width: 100%;" @change="productSourceChange">
...
<!--            </el-dropdown>-->
            ...
            <el-button size="mini" type="primary" icon="el-icon-plus" @click="importForm">
              导入
            </el-button>
        ...
        <JNPF-table v-if="tableFlag" :data="tableData" :fixedNO="true" @sort-change="sortChange" custom-column
          ref="dataTable" :setColumnDisplayList="columnList" customKey="JNPFTableKey_139935">
          ...
          <el-table-column label="操作" width="200" fixed="right">
            <template slot-scope="scope">
              <tableOpts :isJudgePer="true" :editPerCode="'btn_edit'" :delPerCode="'btn_remove'"
                ...
                <el-button type="text" size="mini" @click.native="copyHandle('', 'copy',scope.row)">
                  复制
                </el-button>
