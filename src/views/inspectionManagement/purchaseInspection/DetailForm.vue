            ...
            <el-tab-pane label="基础信息" name="jcInfo">
                ...
                <el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px"
                  ...
                  <el-col :span="8" v-if="type === 'look'">
                    <el-form-item label="收货状态" prop="receivingStatus" ref="receivingStatus">
                      <el-input type="text" v-model="dataForm.receivingStatus === 'receiving' ? '待收货' : '已收货'"
              ...
              <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm">
                <el-table style="border: 1px solid #e3e7ee;" hasNO fixedNO v-bind="dataFormTwo.data"
                  ...
                  <el-table-column prop="purchaseQuantity" label="采购订单数量" width="160">
                  ...
                  <el-table-column prop="receiptQuantity" label="已入库数量" width="160">
                    <template slot-scope="scope">
                  ...
                  <el-table-column prop="mainUnit" label="单位(主)" width="130" show-overflow-tooltip>
                    <template slot-scope="scope">
