  ...
  <transition name="el-zoom-in-center">
    <div>
      ...
      <div class="JNPF-preview-main org-form">
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="5">
                  <el-form-item>
                    <el-date-picker v-model="reportDateArr" type="daterange" value-format="yyyy-MM-dd"
                      style="width: 100%;" start-placeholder="报工开始日期" end-placeholder="报工结束日期" clearable>
                    </el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="listQuery.productDrawingNo" @keyup.enter.native="search()" placeholder="请输入产品图号"
                      clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
              ...
              <JNPF-table :partentOrChild="'child'" ref="dataTable" v-loading="listLoading" :data="tableData"
                ...
                <el-table-column prop="timePrice" label="单价(元)" min-width="140">
                  <template slot-scope="scope">
                    ...
                    <div v-if="scope.row.pricingType == 'by_piece'">{{ scope.row.unitPrice }}</div>
                  </template>
                </el-table-column>
        ...
        <el-dialog title="更多查询" :modal-append-to-body="false" :close-on-click-modal="false"
