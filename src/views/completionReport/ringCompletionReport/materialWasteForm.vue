<template>
  ...
  <el-dialog title="设置设置料废原因" :close-on-click-modal="false" :close-on-press-escape="false"
    ...
    <div class="JNPF-common-layout" style="height: 68vh;overflow: auto;">
      ...
      <div class="JNPF-common-layout-center JNPF-flex-main" style="background-color: #fff;overflow-y:auto ;">
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main" style="padding-top: 0;">
          ...
          <JNPF-table v-loading="listLoading" :data="tableDataList" :fixedNO="true" customKey="JNPFTableKey_699923">
            <el-table-column prop="name" label="料废类型" min-width="180" >
            ...
            <el-table-column prop="num" label="料废数量" min-width="180" >
              <template slot="header">
