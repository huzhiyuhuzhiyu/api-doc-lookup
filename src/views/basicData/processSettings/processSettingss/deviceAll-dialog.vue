      ...
      <div class="JNPF-common-layout-center JNPF-flex-main">
        <el-row class="JNPF-common-search-box" :gutter="16">
          <el-form @submit.native.prevent>
            <el-col :span="6">
              <el-form-item>
                <el-input @keyup.native.enter="searchAllProduct()"  v-model="DeviceListRequestObj.code" placeholder="请输入设备编码" clearable />
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item>
                <el-input @keyup.native.enter="searchAllProduct()"  v-model="DeviceListRequestObj.name" placeholder="请输入设备名称" clearable />
              </el-form-item>
            </el-col>
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main">
          <JNPF-table v-loading="listLoading" :data="allproductData" hasC
            @selection-change="handleSelectionChangeAllPruduct" customKey="JNPFTableKey_669530">
  ...
  methods: {
    ...
    init(type) {
      ...
      stateEquEquipment(this.DeviceListRequestObj).then(listRes => {
        ...
        // this.allproductData = this.allproductData.filter(item=>item.state != 'discard')
