        ...
        <div class="JNPF-common-layout-center">
                ...
                <el-form @submit.native.prevent>
                    ...
                    <el-col :span="6">
                        <el-form-item label="主表id">
                            <el-input v-model="query.equipmentMaintainId" placeholder="请输入" clearable> </el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item>
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                ...
                <JNPF-table v-loading="listLoading" :data="list" @sort-change='sortChange'
                    ...
                    <el-table-column label="正常/异常" prop="normal" algin="left">
                        <template slot-scope="scope">
                            {{ scope.row.normal | dynamicText(normalOptions) }}
                        </template>
                    </el-table-column>
                    <el-table-column prop="measuredValue_name" label="实测值" align="left" />
    ...
    methods: {
        ...
        handleDel(id) {
            this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                ...
                request({
                    url: `/api/equipmentMaintainLine/Equipment_maintain_line/${id}`,
                    method: 'DELETE'
                }).then(res => {
                    this.$message({
                        type: 'success',
