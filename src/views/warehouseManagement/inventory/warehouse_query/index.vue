    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <JNPF-table v-loading="listLoading" highlight-current-row fixedNO ref="tableForm" :data="tableData"
          @sort-change="sortChange" custom-column show-summary :summary-method="getSummaries" customKey="JNPFTableKey_525496">
...
export default {
  ...
  methods: {
    ...
    handleDetail(scope, typeFlag) {
      ...
      this.$nextTick(() => {
        const { productsId, routingLineId, processId, warehouseId } = scope.row
        this.$refs.Form.init(productsId, routingLineId, processId, typeFlag, warehouseId)
      })
    },
    // 关闭明细页面
    closeForm(isRefresh) {
