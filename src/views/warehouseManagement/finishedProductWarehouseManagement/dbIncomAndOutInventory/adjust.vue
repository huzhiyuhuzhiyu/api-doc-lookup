  ...
  <transition name="el-zoom-in-center">
    <div class="JNPF-preview-main org-form">
      ...
      <div :class="['JNPF-common-page-header', btnType == 'look' ? 'noButtons' : '']">
        <el-page-header @back="goBack" :content="'查看库存调整单'" />
        <div class="options">
              ...
              <el-collapse v-model="activeNames">
                <el-collapse-item title="基本信息" name="basicInfo" class="orderInfo">
                  <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="160px" label-position="top">
                    <el-row :gutter="30" class="custom-row">
                      ...
                      <el-col :sm="6" :xs="24">
                            <el-form-item label="调整日期" prop="createTime">
                              <el-date-picker v-model="dataForm.createTime" type="date" value-format="yyyy-MM-dd"
                                style="width: 100%;" :picker-options="pickerOptions" placeholder="请选择调整日期" disabled>
                              </el-date-picker>
                            </el-form-item>
                          </el-col>
                          <el-col :sm="6" :xs="24">
                            <el-form-item label="调整人员" prop="createByName">
                              <el-input v-model="dataForm.createByName" placeholder="请选择调整人员" disabled maxlength="300" />
                            </el-form-item>
                          </el-col>
                      <el-col :sm="12" :xs="24">
                ...
                <el-collapse-item title="产品信息" name="productInfo" class="productInfo">
                  ...
                  <JNPF-table ref="product" :data="productData" :fixedNO="true" :hasC="false"
                    @selection-change="handeleProductInfoData" border :key="165" style="width: 100%;" customKey="JNPFTableKey_456530">
                    ...
                    <el-table-column prop="stockNum" label="调整前库存" width="150" :key="88" />
                    <el-table-column prop="takingNum" label="调整数量" width="120" :key="88" />
                    <el-table-column prop="diffNum" label="差额数量" width="120" :key="88" />

                    <el-table-column prop="warehouseName" label="当前仓库" width="120" :key="88" />
                    <el-table-column prop="shelfSpaceName" label="库位" width="80" :key="88" />
