<template>
  <div class="TableForm_main">
    ...
    <el-form :model="JNPFColTableData" ref="main" class="tableContainer">
      <el-table v-if="tableVisible" class="TableForm table" :data="JNPFColTableData.data" v-bind="customStyleData" hasNO
        fixedNO hasC @selection-change="handleSelectionChange" border>
