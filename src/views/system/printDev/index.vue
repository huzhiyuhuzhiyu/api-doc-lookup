                                                    ...
                                                    <template v-for="line in item.list">
                                                        ...
                                                        <template v-if="line.type === 1">
                                                            ...
                                                            <div class="template-item template-item__item" :class="line.enabledMark ? 'is-default' : ''"
                                                                ...
                                                                <div class="template-item__copy-btn" @click="copy(line.id)">
                                                                    <div class="icon-copy">
                                                                        <i class="icon-ym icon-ym-btn-copy"></i>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </template>
                    ...
                    .business-list__col-type-right {
                        ...
                        .business-list__col-template {
                            ...
                            .template-item__item {
                                ...
                                &:hover {
                                    .template-item__delete-btn ,.template-item__copy-btn {
                                        display: block;
                                    }
                                }
                                .template-item__copy-btn{
                                    display: none;
                                    position: absolute;
                                    top: -15px;
                                    left: -5px;
