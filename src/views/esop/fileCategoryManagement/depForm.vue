...
import {FileCategoryType, FileCategoryTypeChinese} from "@/views/esop/fileCategoryManagement/constants";
    ...
    computed:{
      title(){
          ...
          switch (this.dataForm.type){
              case FileCategoryType.IMAGE_DOCUMENT:
                  name = FileCategoryTypeChinese.IMAGE_DOCUMENT
                    break;
              case FileCategoryType.OFFICE_DOCUMENT:
                  name = FileCategoryTypeChinese.OFFICE_DOCUMENT
                break;
              case FileCategoryType.SYSTEM_ATTACHMENT:
                 name = FileCategoryTypeChinese.SYSTEM_ATTACHMENT
                break;
          }
          return  !this.dataForm.id ? '新建'+name+'分类' : '编辑'+name+'分类'
      }
    }
}
</script>
