    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      <el-row class="JNPF-common-search-box" :gutter="16">
        <el-form @submit.native.prevent>
          ...
          <el-col :span="4">
            <el-form-item>
              <el-input @keyup.native.enter="search()"  v-model.trim="listQuery.name" placeholder="请输入模具名称" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="4">
            <el-form-item>
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
        <div class="JNPF-common-head">
          <div>
            <topOpts @add="addOrUpdateHandle('', false,'add')">
              <el-button size="mini" type="primary" icon="el-icon-printer" @click="printTool('p039')">打印模具二维码</el-button>
        ...
        <JNPF-table v-if="istable" :data="tableData" :fixedNO="true" :customColumn="true" ref="dataTable" @sort-change="sortChange" custom-column hasC @selection-change="handleSelectionChange" customKey="JNPFTableKey_920621">
          <el-table-column prop="code" label="模具编码" min-width="200" sortable="custom" />
          <el-table-column prop="name" label="模具名称" min-width="200" sortable="custom" />
          <el-table-column prop="projectName" label="所属项目" min-width="120" v-if="isProjectSwitch==='1'" key="projectName" />
          <el-table-column prop="state" label="模具状态" min-width="140" sortable="custom">
          ...
          <el-table-column prop="specModel" label="模穴数量" min-width="200" sortable="custom" />
