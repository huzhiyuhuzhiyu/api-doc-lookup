    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="tableData" :fixedNO="true" @sort-change="sortChange" custom-column
          ref="dataTable" hasC @selection-change="currentChange" :checkSelectable="checkSelectable"  customKey="JNPFTableKey_182036">
...
import Form from '@/views/basicData/materialFiles/hoseConnection/Form'
export default {
  components: { Form },
  data() {
    return {
