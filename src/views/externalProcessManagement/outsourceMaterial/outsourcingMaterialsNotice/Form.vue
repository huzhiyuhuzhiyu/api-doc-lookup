      ...
      <div class="JNPF-preview-main org-form">
        <div :class="['JNPF-common-page-header', type === 'look' ? 'noButtons' : '']">
          <el-page-header @back="goBack"
            :content="type == 'add' ? '新建外协发料通知单' : type == 'edit' ? '编辑外协发料通知单' : type == 'copy' ? '新建外协发料通知单' : '查看外协发料通知单'" />
                ...
                <el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px"
                  ...
                  <el-col :sm="6" :xs="24">
                    <el-form-item label="外协供应商" prop="partnerName" ref="partnerName">
                      ...
                      <ComSelect-page :treeNodeClick="treeNodeClick" :isdisabled="true"
                  ...
                  <el-col :sm="6" :xs="24" v-if="type === 'look'">
                    <el-form-item label="发料状态" prop="deliveryStatus" ref="deliveryStatus">
                      <el-input type="text" :value="dataForm.deliveryStatus === 'undelivered' ? '未完成' : '已完成'"
