...
import {
    ALL_TEXT, FILE_CATEGORY_OPTION, FILE_CATEGORY_OPTION_FLAG,
    FILE_EXT_OPTION, FILE_EXT_OPTION_FLAG, FILE_OPERATE, fileCategoryOptionHandler,
    fileExtFilterOption, fileExtOptionHandler,
    TIME_OPTION,
    TIME_OPTION_FLAG
} from "@/views/drawingDocument/document/constant";
