          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="listQuery.orderNo" placeholder="请输入装箱单号" @keyup.enter.native="search()"
                      clearable />
                  </el-form-item>
                </el-col>
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" :fixedNO="true"
                @sort-change="sortChange" custom-column customKey="JNPFTableKey_248352">
                ...
                <el-table-column prop="sourceOrderNo" label="来源单号" min-width="200" sortable="custom" />
                <el-table-column prop="cooperativePartnerName" label="供应商名称" width="160" />
                <el-table-column prop="packingType" label="装箱类型" width="160">
                  <template slot-scope="scope">
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="linesQuery.orderNo" placeholder="请输入装箱单号" @keyup.enter.native="search()"
                      clearable />
                  </el-form-item>
                </el-col>
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="linesTableData" v-loading="listLoading" :data="linesTableData" :fixedNO="true"
                ...
                <el-table-column prop="orderNo" label="装箱单号" width="200" sortable="custom">
                  <template slot-scope="scope">
                ...
                <el-table-column label="操作" width="180" fixed="right">
                  <template slot-scope="scope">
                    ...
                    <el-dropdown hide-on-click>
                      ...
                      <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item
                          @click.native="printWithLodopitem(scope.row.packingListId, scope.row.packingType)">
                          打印条码
                        </el-dropdown-item>
  ...
  methods: {
    ...
    printWithLodop(row, type) {
      if (this.dateSelectVisable) this.dateSelectVisable = false
        ...
        if (selectedData.some(row => row.documentType === 'purchase_receiving' && row.productCategoryCode == '6' && row.productType === 'pt003')) {
          this.productionDate = this.jnpf.getToday()
          this.tempPrintData = selectedData // 暂存打印数据
        ...
        lineSalePackingList(this.linesQuery).then(res => {
          ...
          this.linesTableData.forEach(item => {
            if (item.packingType === 'single') {
              item.standardBoxName = item.standardBoxName
              item.oddBoxName = item.standardBoxName
            } else {
              item.standardBoxName = item.mainStandardBoxName
              item.oddBoxName = item.mainOddBoxName
            }
          })
