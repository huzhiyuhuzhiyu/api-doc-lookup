    ...
    <div class="JNPF-common-layout-center JNPF-flex-main" >
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
        ...
        <JNPF-table v-if="isProjectSwitchFlag" v-loading="listLoading" custom-column :data="tableData" hasNO fixedNO
          ...
          <el-table-column prop="mainUnit" label="直接领料入库" width="120" />
          <el-table-column prop="mainUnit" label="入库合计" width="120" />
          <el-table-column prop="mainUnit" label="原料消耗" width="120" />
          <el-table-column prop="mainUnit" label="自动扣料" width="120" />
          <el-table-column prop="mainUnit" label="直接领料出库" width="120" />
  ...
  data() {
    return {
      ...
      tableQuery: {
        ...
        scrapFlag: '',
        virtuallyFlag: '',
        warehouseId: '1859200167750713345',
        productDrawingNo: '',
        productCode: '',
        superQuery: {},
        lineFlag: 1
