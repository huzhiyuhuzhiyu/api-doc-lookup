...
export default {
  ...
  data() {
    return {
      ...
      WareListRequestObj: {
        ...
        partnerId: this.thisForm.dataForm.cooperativePartnerId, // 关联产品库位对照表
        choseFlag: true,
        // productsId: 
      }, // 货位选择弹出框列表请求参数
      WareTableItems: [
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      this.WareListRequestObj.productsId = this.scope.row.productsId;
      this.WareListRequestObj.routingLineId = this.scope.row.routingLineId;
    })
  },
  methods: {
