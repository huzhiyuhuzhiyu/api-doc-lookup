          ...
          <el-tab-pane label="工单信息" name="orderInfo">
            ...
            <el-form ref="dataForms" :model="reworkForm"  label-width="160px" label-position="top">
              <el-row :gutter="30" class="custom-row">
                ...
                <el-col :sm="8" :xs="24">
                            <el-form-item label="工废数量" prop="industrialWasteQuantity">
                                <el-input placeholder="请输入工废数量" disabled v-model="reworkForm.industrialWasteQuantity"></el-input>
                            </el-form-item>
                        </el-col>  
                <!-- <el-col :sm="8" :xs="24">
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="是否入库" prop="stockFlag">
                    <el-select v-model="reworkForm.stockFlag" placeholder="请选择是否入库" disabled style="width: 100%;">
