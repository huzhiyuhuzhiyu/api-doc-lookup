        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="订单分配" name="orderAllocation" v-loading="formLoading">
            ...
            <el-table ref="product" :data="productData" :fixedNO="true" :span-method="objectSpanMethod" class="tableheight"
              ...
              <el-table-column type="index" width="60" fixed="left" align="center" label="序号" />
              <!-- <el-table-column type="customerProductNo" width="120"  align="center" label="客户物料号" /> -->
  ...
  methods: {
    ...
    getSummaries(param) {
      ...
      if (this.btnType == 'edit' || this.btnType == 'add' || this.btnType == 'copy') {
        ...
        this.totalNum = sums[4]
        this.totalAssistantNum = sums[6]
        this.totalAmount = sums[9]
      }
      return sums;
    },
