    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      <div class="vux-flexbox filtrate-content filtrate-bar vux-flex-row" style="justify-content: flex-start;">
        <div class="vux-flexbox title-box vux-flex-row" style="justify-content: flex-start;">
          ...
          <div class="text-one-line">客户级别分析</div>
        </div>
...
import { getportraitLevel } from "@/api/CRMmanagement/instrumentPanel/index";
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      getportraitLevel(this.dataForm).then(res1 => {
        this.option = {
          tooltip: {
            trigger: 'item',
            formatter: '{b} : {c}'
