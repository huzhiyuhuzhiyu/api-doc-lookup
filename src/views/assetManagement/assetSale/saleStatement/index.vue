    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
        ...
        <JNPF-table v-if="tableFlag" @selection-change="handeleProductInfoData" hasC highlight-current-row
          ...
          <el-table-column prop="orderNo" label="资产出售单号" sortable="custom" />
          ...
          <el-table-column prop="propertyName" label="资产名称"  sortable="custom" />
          <el-table-column prop="propertyCode" label="资产编码"  ></el-table-column>
...
<script>
import {propertySaleOrderList} from '@/api/bimPropertyCategory/index'
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      propertySaleOrderList(this.superForm)
        .then((res) => {
