            ...
            <el-tab-pane label="基础信息" name="orderInfo">
              <el-collapse v-model="activeNames">
                ...
                <el-collapse-item title="工序信息" name="productInfo" class="productInfo">
                  <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="processForm" class="data-form">
                    <JNPF-table ref="product" :data="dataFormTwo.data" fixedNO v-loading="tableloading" customKey="JNPFTableKey_768810">
              ...
              <el-collapse v-model="activeNamess">
                ...
                <el-collapse-item title="领料清单" name="productInfo" class="productInfo"
                  ...
                  <TableForm-product :value="materialList" :ref="`linesForm_right`" :tableItems="linesFormItems_right"
                    :btnType="'add'" :projectId="dataForm.projectId" @addth="(data) => { addth(data, null,) }"
...
export default {
  ...
  components: {
    SelectProductForm,TableFormProduct,
    RoutingForm,
  },
  data() {
    return {
