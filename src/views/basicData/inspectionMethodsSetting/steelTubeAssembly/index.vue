    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="tableData" :fixedNO="true" @sort-change="sortChange" custom-column
          ref="dataTable" hasC @selection-change="currentChange" :checkSelectable="checkSelectable"  customKey="JNPFTableKey_243563">
          ...
          <el-table-column prop="drawingNo" label="产品图号" min-width="600" sortable="custom" />
...
import Form from '@/views/basicData/materialFiles/steelTubeAssembly/Form'
export default {
  components: { Form },
  data() {
    return {
