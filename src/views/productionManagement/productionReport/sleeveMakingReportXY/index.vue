    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" highlight-current-row fixedNO ref="tableForm" :data="tableData"
          ...
          <el-table-column prop="coldHeading" label="冷镦" width="130" sortable="custom" fixed="left"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getSummaries(param) {
      ...
      sums[17] = this.allTotal.clean||0
      sums[18] = this.allTotal.optoelectronicAppearance||0
      sums[19] = this.allTotal.pack||0
