...
export default () => [
  {
    ...
    tabContent: [
      ...
      //  一下全部都是 custom，组件选择
      { prop: "brandName", label: "品牌", value: "",typeCode:'pa011', type: 'custom', customComponent: 'ComSelect-list',},
      ...
      { prop: "sealingCoverStructureName", label: "密封盖-结构",typeCode:'pa012', value: "", type: "custom",customComponent: 'ComSelect-list', itemRules: [{ required: true, trigger: "change" }] ,itemDisabled: false},
      { prop: "sealingCoverTypingName", label: "密封盖-打字", value: "", type: "custom",customComponent: 'ComSelect-list', typeCode:'pa007', },
      { prop: "structureTypeName", label: "结构类型", value: "",typeCode:'pa013', type: "custom",customComponent: 'ComSelect-list', itemRules: [{ required: true, trigger: "change" }],itemDisabled: false  },
      { prop: "clearanceName", label: "游隙", value: "", type: "custom",typeCode:'pa001', customComponent: 'ComSelect-list', itemRules: [{ required: true, trigger: "change" }] ,itemDisabled: false },
      ...
      { prop: "oilName", label: "油脂", value: "",typeCode:'pa002',type: "custom",customComponent: 'ComSelect-list', itemRules: [{ required: true, trigger: "change" }],itemDisabled: false  },
      { prop: "oilQuantityName", label: "油脂量", value: "",typeCode:'pa003', type: "custom",customComponent: 'ComSelect-list' },
      { prop: "noiseName", label: "噪音", value: "",typeCode:'pa014', type: "custom",customComponent: 'ComSelect-list',itemRules: [{ required: true, trigger: "change" }],itemDisabled: false },
      { prop: "holderName", label: "保持架", value: "",typeCode:'pa004', type: "custom",customComponent: 'ComSelect-list', itemRules: [{ required: true, trigger: "change" }],itemDisabled: false },
      { prop: "vibrationLevelName", label: "振动等级", value: "", type: "custom",customComponent: 'ComSelect-list',typeCode:'pa005' },
      { prop: "accuracyLevelName", label: "精度等级", value: "", type: "custom",customComponent: 'ComSelect-list', typeCode:'pa006'},
      { prop: "colourName", label: "颜色", value: "",type: "custom",customComponent: 'ComSelect-list',typeCode:'pa010' },
      { prop: "apertureName", label: "孔径", value: "", type: "custom",customComponent: 'ComSelect-list',typeCode:'pa009' },
