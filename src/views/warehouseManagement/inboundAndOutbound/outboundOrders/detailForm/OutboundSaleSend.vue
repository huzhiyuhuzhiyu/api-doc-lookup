  ...
  <div>
    <transition name="el-zoom-in-center">
      <div class="JNPF-preview-main org-form">
            ...
            <el-tab-pane label="订单信息" name="orderInfo">
                ...
                <el-row :gutter="30" class="custom-row">
                  ...
                  <el-col :sm="8" :xs="24">
                    <el-form-item label="换货标识" prop="exchangeGoodsFlag">
                      <el-select v-model="dataForm.exchangeGoodsFlag" placeholder="请选择状态" style="width: 100%;"
                        @change="changeclick" :disabled="btnType == 'look' || Flagtype">
                  ...
                  <el-col :sm="8" :xs="24">
                    <el-form-item label="订单编号" prop="ordersNo">
                      <el-input v-model="dataForm.ordersNo" placeholder="请选择订单编号" readonly
                        @focus="openSeleceProductDialog" :disabled="btnType == 'look' || btnType == 'qrsh'">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :sm="8" :xs="24">
                  ...
                  <!-- <el-col :sm="8" :xs="24" v-if="btnType == 'look'" key="5">
                  ...
                  <!-- <el-col :sm="8" :xs="24" v-if="btnType == 'look'" key="6">
                  ...
                  <!-- <el-col :sm="12" :xs="24" v-if="btnType == 'look'" key="20">
              ...
              <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm" class="data-form">
                <el-table ref="product" :data="dataFormTwo.data" @selection-change="handeleProductInfoData">
                  ...
                  <!-- <JNPF-table ref="product" :data="productData" :hasC="iszt" @selection-change="handeleProductInfoData"
                height="700px" style="border: 1px solid #e3e7ee;"> -->
                  ...
                  <el-table-column prop="customerProductDrawingNo" label="客户产品图号" width="290" show-overflow-tooltip
                    key="16">
                  </el-table-column>
                  ...
                  <el-table-column prop="ordersNum" label="订单数量" width="160" key="9"
                    show-overflow-tooltip></el-table-column>
                  <el-table-column prop="outboundQuantity" label="已出库数量" width="160" key="10" show-overflow-tooltip>
                  </el-table-column>
                  <el-table-column prop="undeliveredQuantity" label="待出库数量" width="160" key="11"
                    v-if="btnType == 'add' || btnType == 'edit' || btnType == 'copy'" show-overflow-tooltip>
                  </el-table-column>
                  <el-table-column prop="receivingQuantity" label="收货数量" width="170" v-if="btnType == 'qrsh'" key="12">
                    ...
                    <template slot-scope="scope">
                      <el-form-item :prop="'data.' + scope.$index + '.' + 'receivingQuantity'"
                        :rules='productRules.receivingQuantity'>
                        <el-input v-model="scope.row.receivingQuantity" placeholder="请输入收货数量"
                  ...
                  <el-table-column prop="pickingQuantity" label="拣货数量" width="200" v-if="btnType == 'qrsh'"
                    show-overflow-tooltip key="13">
                  </el-table-column>
                  <el-table-column prop="deliveryQuantity" label="发货数量" width="170" key="21"
                  ...
                  <el-table-column prop="deliveryQuantity" label="换发货数量" width="170" key="30" v-else>
                    ...
                    <template slot-scope="scope">
                      <el-form-item :prop="'data.' + scope.$index + '.' + 'deliveryQuantity'"
                        :rules='productRules.deliveryQuantity'>
                        <el-input v-model="scope.row.deliveryQuantity" placeholder="请输入换发货数量"
                          :disabled="btnType == 'look' || btnType == 'qrsh'" maxlength="11"
                          @input="watchnums(scope.row, scope.$index)" style="width: 145px;">
                        </el-input>
                      </el-form-item>
                  ...
                  <!-- <el-table-column prop="receivedQuantity" label="确认收货数量" width="160" v-if="btnType == 'look'" key="14">
                  </el-table-column> -->
        ...
        <ComSelectPages ref="ComSelect-pages" @change="submitfaultLocationName" :tableItems="faultLocationNameItems"
          title="选择客户" placeholder="请选择客户" :listMethod="getCooperativeData" treeTitle="客户分类" :methodArr="{
            method: getcategoryTrees, requestObj: {
              keyword: '',
              type: 'customer'
            }
          }" :listRequestObj="form" :searchList="ProductfaultLocationName" :elementShow="false" />
        <el-dialog title="选择订单" :close-on-click-modal="false" :close-on-press-escape="false"
            ...
            <div class="JNPF-common-layout-center JNPF-flex-main">
              <el-row class="JNPF-common-search-box" :gutter="16">
                ...
                <el-col :span="6">
                  ...
                  <el-col :span="5">
                    <el-form-item>
                      <el-input v-model="ProductListRequestObj.cooperativePartnerCode" placeholder="请输入客户编码"
                        clearable />
                    </el-form-item>
                  </el-col>
                  <el-col :span="5">
                    <el-form-item>
                      <el-input v-model="ProductListRequestObj.cooperativePartnerName" placeholder="请输入客户名称"
                        clearable />
                    </el-form-item>
                  </el-col>
                  <el-col :span="4">
                    <el-form-item>
                      <el-select v-model="ProductListRequestObj.shipmentState" placeholder="请选择发货状态">
                        <el-option v-for="(item, index) in deliveryList" :key="index" :label="item.label"
                          :value="item.value"></el-option>
                      </el-select>
                    </el-form-item>
...
import changeAddress from "@/views/salesManagement/shippingnotice/assemblyNotice/changeAddress.vue"
import ComSelectPages from "@/views/salesManagement/shippingnotice/assemblyNotice/ComSelect-pages/index.vue";
  ...
  data() {
    return {
      ...
      ProductListRequestObj: {
        ...
        shipmentState: "un_shipment_completed",
        orderState: "",
        productionStatus: "",
        documentStatus: "",
        approvalStatus: "",
  ...
  methods: {
    changeclick(e) {
      if (this.dataForm.ordersNo) {
        this.$confirm('此操作将清空订单和产品数据,是否继续？', '提示', {
    ...
    seleceCustomerdd(e) {
      getOrderDetail(e.id).then(res => {
        ...
        if (this.dataForm.ordersNo && res.msg == 'Success') {
          this.$confirm('切换换货标识，将切换产品数据,是否继续？', '提示', {
            confirmButtonText: '确定',
            cancelButtonText: '取消',
            type: 'warning'
          }).then(() => {
    ...
    init(id, btnType) {
        ...
        getQuotationsendlist(this.dataForm.id).then(res => {
          ...
          if (this.btnType == 'copy') {
            ...
            getOrderDetail(res.data.notice.ordersId).then(res1 => {
              ...
              //   item.productDrawingNo = item.drawingNo
              // })
              // this.dataFormTwo.data = res1.data.orderLines
              res1.data.orderLines.map((item) => {
      ...
      //   // this.dataForm.deliverDate = this.dateFormat(end)
      //   // this.dataForm.deliveryStatus = 'undelivered'
      // }
    },
    goBack() {
      this.$emit('close')
