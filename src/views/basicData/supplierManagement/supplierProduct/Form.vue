                  ...
                  <el-col :span="6">
                    <el-form-item label="产品名称" prop="productName" ref="productName">
                      <ComSelect-page clearable @change="addth" :tableItems="ProductTableItems" title="选择产品"
                        ...
                        :elementShow="false" multiple :renderTree="false" :listDataFormatting="listDataFormatting" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="6">
...
<script>
import { getCooperativeData, getcategoryTree, getBimBusinessDetail, addPartnerOrProductData } from '@/api/basicData/index' //供应商数据
