          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="dataTableInbound" v-loading="listLoading" :data="inboundData" :fixedNO="true" @sort-change="sortChange" custom-column>
                <el-table-column prop="inspectorName" label="检验人"  sortable="custom"/>
                <el-table-column prop="samplingSumQuantity" label="累计检验总数"  sortable="custom"/>
                <el-table-column prop="unqualifiedSumQuantity" label="累计检验不合格总数"  sortable="custom"></el-table-column>
              </JNPF-table>
