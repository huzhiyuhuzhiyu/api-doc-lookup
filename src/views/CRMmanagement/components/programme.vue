  ...
  <div v-show="false">
    <div class="superQuery-main" v-loading="loading">
      <template v-if="conditionList.length">
        ...
        <div class="superQuery-main-Options">
          <div v-for="(item, index) in conditionList" :key="index" class="condition-list">
            <el-row :gutter="10">
              <el-col :span="7">
                <el-select v-model="item.prop" placeholder="请选择查询字段" @change="onFieldChange($event, item, index)" clearable disabled style="width: 100%;">
              ...
              <el-col :span="5">
                <el-select v-model="item.symbol" :placeholder="'请选择' + item.label" disabled style="width: 100%;">
              ...
              <el-col :span="11">
                ...
                <template v-if="item.type === 'input'">
                  <el-input v-model="item.value" v-bind="{ placeholder: `请输入${item.label || ''}`, maxlength: 50, clearable: true }" />
                </template>
                <!-- 下拉选择器 -->
                ...
                <!-- 日期时间选择器 -->
                <template v-else-if="['year', 'month', 'date', 'dates', 'months', 'years', 'week', 'datetime'].includes(item.type)">
                ...
                <template v-else-if="item.type === 'custom'">
                  <component :is="item.component" v-model="item.value" style="width:100%" v-on="fieldCache[item.prop].events" v-bind="{
