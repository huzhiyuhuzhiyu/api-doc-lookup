<template>
  <div class="JNPF-preview-main org-form">
    ...
    <div :class="['JNPF-common-page-header', btnType == 'look' ? 'noButtons' : '']">
      <div class="pageTitle">查看{{ list.find(item => item.value === dataForm.businessType).label }}单</div>
      <div class="options">
            ...
            <el-collapse v-model="activeNames">
                    ...
                    <el-col :sm="12" :xs="24">
                      <el-form-item label="备注" prop="remark">
                        <el-input v-model="dataForm.remark" placeholder="请输入备注" type="textarea" :rows="2"
                          maxlength="200" :disabled="btnType === 'look'" />
                      </el-form-item>
                    </el-col>
                  </el-row>
                </el-form>
              ...
              <el-collapse-item title="产品信息" name="productInfo">
                ...
                <el-table ref="product" :data="productData" :fixedNO="true" @selection-change="handeleProductInfoData"
                  ...
                  <el-table-column prop="originalBatchNumber" label="原产品批次号" key="originalBatchNumber"
                    v-if="dataForm.documentType == 'inbound'" min-width="180">
                    <template slot-scope="scope">
        ...
        <div class="JNPF-common-layout-center JNPF-flex-main">
          ...
          <div class="JNPF-common-layout-main JNPF-flex-main">
            <JNPF-table v-loading="listLoading" :data="productList" hasC
              @selection-change="handleSelectionChangeAllPruduct" @sort-change="sortChange" customKey="JNPFTableKey_328454">
    ...
    init(id, btnType) {
      ...
      if (id) {
        ...
        detailWarehouseData(id).then(res => {
          ...
          this.productData = res.data.spaceLines.map(item => ({
            ...item,
            productDrawingNo: item.productDrawingNo || item.drawingNo
          }))
