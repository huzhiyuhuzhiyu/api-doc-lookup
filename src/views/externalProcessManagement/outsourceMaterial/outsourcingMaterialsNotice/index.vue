          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="listQuery.orderNo" placeholder="请输入发货单号" @keyup.enter.native="search()"
                      clearable />
                  </el-form-item>
                </el-col>
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" :fixedNO="true"
                ...
                <el-table-column prop="deliveryStatus" label="发货状态" width="120" sortable="custom" fixed="right"
                  align="center">
                  <template slot-scope="scope">
                  ...
                  <template slot-scope="scope">
                    ...
                    <el-dropdown hide-on-click>
                      ...
                      <el-dropdown-menu slot="dropdown">
                        ...
                        <el-dropdown-item
                          @click.native="addOrUpdateHandle(scope.row.returnDeliveryNoticeId, 'copy', scope.row.ordersId)">
                          复制通知单
                        </el-dropdown-item>
                      </el-dropdown-menu>
                    </el-dropdown>
        ...
        <el-form ref="diaForm" :model="listQuery" label-width="120px" label-position="top">
          ...
          <el-col :span="12">
            <el-form-item label="发货完成时间">
              <el-date-picker v-model="listQuery.deliveryDateArr" type="datetimerange"
                :default-time="['00:00:00', '23:59:59']" value-format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"
                start-placeholder="发货完成开始时间" end-placeholder="发货完成结束时间" clearable>
              </el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  ...
  methods: {
    sortChange({ prop, order }) {
      ...
      let newProp;
      if (prop === 'partnerCode' || prop === 'partnerName' || prop === 'shipperName' || prop === 'createByName' || prop === 'productName' || prop === 'productDrawingNo') {
        newProp = prop
      } else {
