<template>
  <div>
    <transition name="el-zoom-in-center">
      <div class="JNPF-preview-main org-form" v-loading="allLoading">
        <div class="JNPF-common-page-header">
          <el-page-header @back="goBack" content="查看应收金额明细" />
        </div>
        <div class="moneyBox">
          <div class="cooperativePartnerName">
            客户名称：{{ dataForm.cooperativePartnerName }}
        ...
        <div class="main">
          <div class="mainList">
            <el-tabs v-model="activeName" @tab-click="handleClick">
                  ...
                  <div class="JNPF-common-layout-center JNPF-flex-main">
                    ...
                    <div class="JNPF-common-layout-main JNPF-flex-main">
                      <JNPF-table show-summary :summary-method="getSummaries" v-loading="listLoading"
                        highlight-current-row :fixedNO="true" ref="tableForm" :data="reconList" @sort-change="sortChange" customKey="JNPFTableKey_481735">
                        ...
                        <el-table-column prop="cooperativePartnerCode" label="客户编码" min-width="180" />
                        <el-table-column prop="cooperativePartnerName" label="客户名称" min-width="180" />
                        <el-table-column prop="includingTaxAmount" label="订单金额" min-width="180" />
                        <el-table-column prop="totalReconciliationAmount" label="应收金额" min-width="120">
                        ...
                        <el-table-column prop="totalPaymentAmount" label="已收款金额" min-width="120" />
                        <el-table-column prop="totalUnpaidAmount" label="未收款金额" min-width="120" />
                        <el-table-column prop="totalInvoicingAmount" label="已开票金额" min-width="120" />
                        <el-table-column prop="totalNotInvoicedAmount" label="未开票金额" min-width="120" />
                        ...
                        <el-table-column label="操作" min-width="180" fixed="right">
                          <template slot-scope="scope">
                            <el-button size="mini" type="text"
                              ...
                              @click="collectionHandle(scope.row.id, 'collection')">收款</el-button>
                            <el-button size="mini" type="text"
                              :disabled="Math.abs(scope.row.totalReconciliationAmount) - Math.abs(scope.row.totalInvoicingAmount) == 0 ? true : false"
                              @click="makeHandle(scope.row.id, 'make')">开票</el-button>
              ...
              <el-tab-pane label="收款明细" name="skInfo">
                <div class="JNPF-common-layout">
                  <div class="JNPF-common-layout-center JNPF-flex-main">
                    <el-row class="JNPF-common-search-box" :gutter="16">
                      <el-form @submit.native.prevent>
                        ...
                        <el-col :span="4">
                          <el-form-item>
                            <el-date-picker v-model="paymentDate" type="daterange" value-format="yyyy-MM-dd"
                              style="width: 100%;" clearable start-placeholder="请选择收款开始日期" end-placeholder="请选择收款结束日期">
                            </el-date-picker>
                          </el-form-item>
                        </el-col>
                    ...
                    <div class="JNPF-common-layout-main JNPF-flex-main">
                      <JNPF-table show-summary :summary-method="getSummaries" v-loading="listLoading"
                        ...
                        @sort-change="collectionSortChange" customKey="JNPFTableKey_240190">
                        ...
                        <el-table-column prop="paymentDate" label="收款日期" min-width="160" sortable="custom" />
                        <el-table-column prop="paymentMethod" label="收款方式" min-width="160">
                          <template slot-scope="scope">
                            <div v-if="scope.row.paymentMethod === 'transfer_accounts'">转账</div>
                            <div v-if="scope.row.paymentMethod === 'draft'">汇票</div>
                          </template>
                        </el-table-column>
                        <el-table-column prop="paymentAmount" label="已收款金额" min-width="120" />
                  ...
                  <div class="JNPF-common-layout-center JNPF-flex-main">
                    ...
                    <div class="JNPF-common-layout-main JNPF-flex-main">
                      <JNPF-table show-summary :summary-method="getSummaries" v-loading="listLoading"
                        ...
                        @sort-change="makeoutSortChange" customKey="JNPFTableKey_475463">
