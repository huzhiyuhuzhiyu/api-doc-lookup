        ...
        <div class="table-content" v-loading="listLoading">
          ...
          <div style="height: 400px;">
            <el-table ref="tabForm" :header-cell-style="headerCellStyle" :data="tableList" border>
              <el-table-column v-for="item in columnsData" :label="item.label" :prop="item.prop" :key="item.prop" min-width="150">
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      _this.tableList.push({ 'title': '当月回款金额(元)' })
