<template>
  <el-dialog title="办理离职" :close-on-click-modal="false" append-to-body :visible.sync="visible"
          ...
          <template>
            <el-col :span="24">
              <el-form-item label="离职日期" prop="changeDate" ref="changeDate">
                <el-date-picker v-model="dataForm.changeDate" type="date" placeholder="请选择离职日期" style="width: 100%;"
            ...
            <el-col :span="24">
              <el-form-item label="离职原因" prop="changeReason">
                <el-input v-model="dataForm.changeReason" placeholder="请输入离职原因" :style='{ "width": "100%" }' true
