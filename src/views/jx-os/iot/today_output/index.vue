<template>
  ...
  <div class="JNPF-common-layout">
    <Detailspages v-if="flag" :dataForm="dataForm" @handles="handles" />
    <div v-else="!flag" class="JNPF-common-layout-center">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <JNPF-table v-loading="listLoading" :data="list" @sort-change='sortChange' :span-method="arraySpanMethod">
          ...
          <el-table-column prop="code" label="设备编号" align="left" width="200" />
          <el-table-column prop="mrpWorkshopName" label="所属车间" align="left" width="200" />
          <el-table-column prop="output.avg" label="平均产量(个/小时)" align="left" width="200" /><!-- 运行时间 -->
          <el-table-column prop="output.sum" label="生产数量" align="left" width="200" />
...
<script>
import {
    getListOutPut, getListTodayOutPut
} from '@/api/equipment'
  import {
    getIot
  } from '@/api/iot'
