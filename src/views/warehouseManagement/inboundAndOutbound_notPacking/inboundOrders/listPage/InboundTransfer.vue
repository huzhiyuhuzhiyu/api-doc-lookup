          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <div class="JNPF-common-head" style="padding:10px">
                <el-page-header @back="$emit('close', true)" :content="'调拨入库'" />
              ...
              <JNPF-table v-loading="listLoading" ref="dataTable" :data="tableData" @sort-change="sortChange"
                ...
                <!-- <el-table-column prop="receiveStatus" label="接收状态" width="120" align="center" fixed="right">
                  <template slot-scope="scope">
                    <el-tag type="primary" v-if="!scope.row.outboundId">待出库</el-tag>
                    <el-tag type="warning" v-else-if="!!scope.row.outboundId && !scope.row.inboundId">待入库</el-tag>
                    <el-tag type="success" v-else-if="!!scope.row.outboundId && !!scope.row.inboundId">已入库</el-tag>
                  </template>
                </el-table-column> -->
                <el-table-column label="操作" width="140" fixed="right">
                  <template slot-scope="scope">
                    ...
                    <!-- :editDisabled="!scope.row.outboundId || !!scope.row.inboundId || scope.row.canReceive == false" -->
                      <el-dropdown hide-on-click>
                        ...
                        <el-dropdown-menu slot="dropdown">
                          <el-dropdown-item @click.native="addOrUpdateHandle(scope.row.id, true, scope.row.inboundId)">
                            查看详情
                          </el-dropdown-item>
                        </el-dropdown-menu>
                      </el-dropdown>
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table v-loading="listLoading" ref="linesDataTable" :data="linesTableData" @sort-change="sortChange"
                ...
                <el-table-column label="操作" width="140" fixed="right">
                  <template slot-scope="scope">
                    <tableOpts @edit="addOrUpdateHandle(scope.row.pickingId)"
                    :editText="'入库'" :hasDel="false">
                    <!-- :editDisabled="!scope.row.outboundId || !!scope.row.inboundId || scope.row.canReceive == false" -->
                      <el-dropdown hide-on-click>
                        <span class="el-dropdown-link">
...
export default {
  ...
  methods: {
    ...
    addOrUpdateHandle(id, readOnly, inboundId) {
      this.formVisible = true
      this.$nextTick(() => {
        this.$refs.Form.init(id, readOnly, "inbound_transfer", inboundId)
      })
    },
