          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table v-loading="listLoading" highlight-current-row :fixedNO="true" ref="tableForm" :data="tableDataList" @sort-change="sortChange" custom-column>
                ...
                <el-table-column prop="dateOrderStart" label="价格起始日期" sortable="custom" min-width="160" />
                <el-table-column prop="dateOrderStop" label="价格到期日期" sortable="custom" min-width="160" />
