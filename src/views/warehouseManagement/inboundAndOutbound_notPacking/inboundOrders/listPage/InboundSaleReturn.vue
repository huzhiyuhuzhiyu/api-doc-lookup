          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <div class="JNPF-common-head">
                <el-page-header @back="$emit('close', true)" :content="'销售退货入库'" />
        ...
        <el-tab-pane label="明细列表" name="linesTable">
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="linesTableData" v-loading="listLoading" :data="linesTableData" :fixedNO="true" style="height: 100%;" custom-column
                @sort-change="sortChange">
                <el-table-column prop="orderNo" label="退货单号" width="200" sortable="custom" fixed="left">
                  <template slot-scope="scope">
                ...
                <el-table-column label="操作" width="140" fixed="right">
                  <template slot-scope="scope">
                    <tableOpts @edit="addOrUpdateHandle(scope.row.returnDeliveryNoticeId)" :editText="'入库'" :hasDel="false">
                      <el-dropdown hide-on-click>
                        <span class="el-dropdown-link">
                          <el-button type="text" size="mini">
                            {{ $t('common.moreBtn') }}<i class="el-icon-arrow-down el-icon--right"></i>
          ...
          <el-col :span="12">
            <el-form-item label="退货日期">
              <el-date-picker v-model="linesQuery.deliveryDatefahuo" type="daterange" value-format="yyyy-MM-dd" style="width: 100%;"
                clearable start-placeholder="请选择退货开始日期" end-placeholder="请选择退货结束日期">
              </el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="申请时间">
              <el-date-picker v-model="linesQuery.createTimeArrfahuo" type="datetimerange" value-format="yyyy-MM-dd HH:mm:ss"
                :default-time="['00:00:00', '23:59:59']" style="width: 100%;" start-placeholder="请选择申请开始时间"
                end-placeholder="请选择申请结束时间" clearable :picker-options="global.timePickerOptions">
              </el-date-picker>
            </el-form-item>
          </el-col>
        </el-form>
...
import DetailForm from '../../../inboundAndOutbound/inboundOrders/detailForm/InboundSaleReturn.vue'
export default {
  ...
  methods: {
    ...
    sortChange({ prop, order }) {
      let newProp;
      if (prop === 'partnerCode' || prop === 'partnerName' || prop === 'productCode' || prop === 'productName' || prop === 'productDrawingNo' ||  prop === 'createByName') { newProp = prop }
    ...
    addOrUpdateHandle(id, readOnly) {
      if (readOnly) {
        ...
        this.$nextTick(() => { this.$refs.Form.init(id, undefined, "inbound_sale_return") })
      }
    },
  }
}
