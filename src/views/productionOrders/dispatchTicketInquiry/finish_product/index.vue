    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      <div class="JNPF-common-layout-center JNPF-flex-main">
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main">
          ...
          <JNPF-table ref="dataTable" v-loading="listLoading" :selectable="tableData" :data="tableData" fixedNO @sort-change="sortChange"
            custom-column hasC @selection-change="currentChange">
            <el-table-column prop="orderNo" label="派工单号" min-width="200" fixed="left" sortable="custom">
            ...
            <el-table-column prop="productionOrderNo" label="生产订单号" min-width="200" fixed="left" sortable="custom" />
            <el-table-column prop="workNo" label="工单号" min-width="200" fixed="left" sortable="custom" />
            <el-table-column prop="processName" label="工序名称" min-width="120" fixed="left" sortable="custom" />
  ...
  data() {
    return {
      ...
      initListQuery: {
        ...
        actualSsd: "",
        createByName: "",
        demandType: "finish_product", // 需求类型 生产成品需求 finish_product 、生产半成品需求 semi_finished
        dispatchType: "",
        endTime: "",
        equipmentName: "",
        keyword: "",
