    ...
    <div class="JNPF-preview-main org-form">
      <div :class="['JNPF-common-page-header', btnType === 'look' ? 'noButtons' : '']">
        ...
        <el-page-header @back="goBack"
          :content="btnType == 'add' ? '新建领料通知单' : btnType == 'edit' ? '编辑领料通知单' : btnType == 'copy' ? '新建领料通知单' : '查看领料通知单'" />
          ...
          <el-tab-pane label="通知单信息" name="orderInfo">
              ...
              <el-row :gutter="30" class="custom-row">
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="领料类型" prop="receiveType">
                    <el-select v-model="dataForm.receiveType" placeholder="请选择领料类型" style="width: 100%;"
                      @change="receiveTypeaction" :disabled="btnType == 'look'">
            ...
            <div v-if="btnType != 'look'">
              <el-button type="text" style="margin-right:8px;margin-left:8px;  font-size:14px!important"
                ...
                @click="openSeleceMaterDialog('order')">选择生产订单</el-button>|
              <el-button type="text" style="margin-right:8px;margin-left:8px ; font-size:14px!important"
            ...
            <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="product" class="data-form">
              <el-table ref="product" :data="dataFormTwo.productData" v-bind="dataFormTwo.data" hasC hasNO fixedNO
                ...
                <el-table-column label="操作" width="120" fixed="right"
                  v-if="btnType == 'edit' || btnType == 'add' || btnType == 'copy'" :key="24">
            ...
            <div v-if="btnType != 'look'">
              <el-button type="text" style="margin-right:8px;margin-left:8px;  font-size:14px!important"
                icon="el-icon-plus" :disabled="btnType == 'look' ? true : false"
                @click="openSeleceMaterDialog('procss')" v-if="dataForm.receiveType == 'process'">选择工序物料</el-button>
            </div>
            <el-form :model="dataFormlist" v-bind="dataFormlist" ref="productForm" class="data-form">
              <el-table ref="productlist" :data="dataFormlist.productlist" v-loading="tableloading">
                ...
                <el-table-column prop="productDrawingNo" label="产品图号" min-width="120"
                  show-overflow-tooltip></el-table-column>
                <el-table-column prop="routingCode" label="工艺路线编码" min-width="120"
                  show-overflow-tooltip></el-table-column>
                <el-table-column prop="routingName" label="工艺路线名称" min-width="120"
                  show-overflow-tooltip></el-table-column>
                ...
                <el-table-column prop="processName" label="工序名称" min-width="120"
                  show-overflow-tooltip></el-table-column>
                <el-table-column prop="mainUnit" label="单位" width="120" show-overflow-tooltip></el-table-column>
                <el-table-column prop="num" label="领料数量" width="150" show-overflow-tooltip
                  v-if="dataForm.receiveType == 'order'" key="151"></el-table-column>
                <el-table-column prop="num" label="领料数量" width="170" key="112" v-if="dataForm.receiveType == 'process'">
                  <template slot="header">
                    <span class="required">*</span>领料数量
                  </template>
                  <template slot-scope="scope">
                    <el-form-item :prop="'productlist.' + scope.$index + '.' + 'num'" :rules='productRules.num'>
                      <el-input v-model="scope.row.num" placeholder="请输入领料数量" :disabled="btnType == 'look'"
                        maxlength="20" @input="watchnums(scope.row, scope.$index)" style="width: 145px;">
                      </el-input>
                    </el-form-item>
                  </template>
                </el-table-column>
      ...
      <ComSelect-pages multiple ref="ComSelect-page1" @change="submitCustomerProduct" :datetype="datetype"
        title="选择生产订单" :renderTree="false" :listMethod="ordershengchanList"
        :listRequestObj="processMaterialListRequestObj" :searchList="ProductTableSearchList1" :elementShow="false" />
      <ComSelect-pages multiple ref="ComSelect-page2" @change="submitCustomerProduct2" :datetype="datetype1"
        title="选择工序物料" :renderTree="false" :tableItems="tableItemslist" :listMethod="ordercollectlList"
        :listRequestObj="processMaterialListRequestObj2" :searchList="ProductTableSearchList2" :elementShow="false"
        :picktype="false" />
    </div>
  </transition>
</template>
...
import ComSelectPages from '@/views/productionOrders/finishedproductreceiving/MaterialRequisitionNotice/ComSelect-pages/index.vue'
export default {
