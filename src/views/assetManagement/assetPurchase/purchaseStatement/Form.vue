              ...
              @click="batchDelete">批量删除</el-button>| -->
                  ...
                  <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm">
                    <el-table style="border: 1px solid #e3e7ee;" hasNO fixedNO v-bind="dataFormTwo.data"
                      ...
                      <el-table-column prop="orderNo" label="采购单号" width="190" show-overflow-tooltip>
                        ...
                        <template slot-scope="scope">
                          <el-form-item :prop="'data.' + scope.$index + '.' + 'excludingTaxAmount'"
                            ...
                            <div class="viewData green">
                              <span v-if="scope.row.propertyId">
                                +{{ scope.row.excludingTaxAmount }}
                              </span>
                              <el-input v-if="!scope.row.propertyId" v-model="scope.row.excludingTaxAmount" disabled>
                                {{ scope.row.excludingTaxAmount }}
                              </el-input>
                            </div>
                          </el-form-item>
                        ...
                        <template slot-scope="scope">
                          <el-form-item :prop="'data.' + scope.$index + '.' + 'taxAmount'"
                            ...
                            <div class="viewData green">
                              ...
                              <el-input v-if="!scope.row.propertyId" v-model="scope.row.taxAmount" disabled>
                                {{ scope.row.taxAmount }}
                              </el-input>
                            </div>
                          </el-form-item>
                        ...
                        <template slot-scope="scope">
                          <el-form-item :prop="'data.' + scope.$index + '.' + 'includingTaxAmount'"
                            ...
                            <div  class="viewData green">
                              ...
                              <el-input v-if="!scope.row.propertyId" v-model="scope.row.includingTaxAmount" >
                                {{ scope.row.includingTaxAmount }}
                              </el-input>
                            </div>
                          </el-form-item>
