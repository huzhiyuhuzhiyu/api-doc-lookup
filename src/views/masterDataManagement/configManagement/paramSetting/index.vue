    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="tag-group JNPF-common-search-box treeBox_bot"
        ...
        <el-radio-group v-model="activeName">
          ...
          <el-radio-button label="equipment">设备设置</el-radio-button>
        </el-radio-group>
      </div>
  ...
  methods: {
    ...
    initData() {
      if (this.activeName === 'product') {
        ...
        this.listQuery.pageSize = -1
        this.listQuery.businessCode = 'equipment'
        this.getData(16)
      }
        ...
        .then((res) => {
          ...
          list.forEach((item) => {
            ...
            if (item.configKey === 'inbound_purchase' || item.configKey === 'inbound_external') {
              ...
              item.radioOff = '按通知单出库'
              item.radioOn = '按订单出库'
            } else if (['proportion', 'inventorySearcheListFlag','unitPriceSetting'].includes(item.configKey)) {
              item.radioOff = '关闭'
              item.radioOn = '启用'
