  ...
  <div class="JNPF-common-layout">
    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="tableData" :fixedNO="true" @sort-change="sortChange" custom-column
          ref="dataTable" customKey="JNPFTableKey_589008">
          ...
          <el-table-column prop="deductionFee" label="扣压费" width="120" />
          <!-- 列表中显示的自定义属性 -->
              ...
              <tableOpts @edit="addOrUpdateHandle(scope.row.id, scope.row.partnerCategoryId)"
                ...
                <el-dropdown hide-on-click>
                  ...
                  <el-dropdown-menu slot="dropdown">
                    ...
                    <el-dropdown-item @click.native="calcRefresh(scope.row)">
                      计算更新
                    </el-dropdown-item>
        ...
        <el-form ref="diaForm" :model="listQuery" label-width="120px" label-position="top">
          ...
          <el-col :span="12">
            <el-form-item label="产品图号">
              <el-input v-model="listQuery.drawingNo" placeholder="请输入图号" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
    ...
    <el-dialog title="查看BOM引用" :close-on-click-modal="false" :close-on-press-escape="false" :visible.sync="bomVisibled"
      lock-scroll class="JNPF-dialog JNPF-dialog_center bomDialog" width="1000px">
        <JNPF-table ref="bomTableData" v-loading="bomListLoading" :data="bomTableData" border height="600" customKey="JNPFTableKey_901490">
...
import { getProductList, deleteProductData, getDynamicConditions, productsCalculateGross ,bomProductData} from '@/api/basicData/materialFiles'
  ...
  methods: {
    ...
    calcRefresh(row) {
      productsCalculateGross({
        id: row.id,
        grossWeightCoefficient: row.grossWeightCoefficient,
