            ...
            <el-tab-pane label="基础信息" name="jcInfo">
              ...
              <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm">
                <el-table style="border: 1px solid #e3e7ee;" hasNO fixedNO v-bind="dataFormTwo.data"
                  ...
                  <el-table-column prop="price" label="含税单价" min-width="160">
                  ...
                  <el-table-column prop="taxAmount" label="税额" min-width="200">
                    <template slot="header">
                  ...
                  <el-table-column prop="remark" label="备注" min-width="220">
                    <template slot-scope="scope">
                      <el-input v-model="scope.row.remark" disabled maxlength="20" placeholder="请输入备注">{{
                        scope.row.remark }}
                      </el-input>
                    </template>
                  </el-table-column>
...
import SourceArea from './outOrderSource.vue'
