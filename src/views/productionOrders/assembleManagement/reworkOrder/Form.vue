        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="订单信息" name="orderInfo">
            ...
            <el-table ref="products" :data="workOrderData" @selection-change="handleSelectionChange">
              ...
              <el-table-column prop="processCode" label="工序编码" :key="14" min-width="160"></el-table-column>
              <el-table-column prop="processName" label="工序名称" :key="15" min-width="150" />
              <el-table-column prop="processingType" label="加工类型" :key="19" min-width="130">
                <template slot-scope="scope">
                  <div>{{ scope.row.processingType == 'self_produced' ? '自制' : "外协" }}</div>
                </template>
              </el-table-column>
              <el-table-column prop="firstFlag" label="是否首道工序" :key="16" min-width="130">
                <template slot-scope="scope">
                  <el-checkbox v-model="scope.row.firstFlag" disabled></el-checkbox>
                </template>
              </el-table-column>
              <el-table-column prop="chargeableReworkFlag" label="是否计费返工" :key="18" min-width="130">
                <template slot-scope="scope">
              ...
              <el-table-column prop="firstInspection" label="是否首检" :key="29" min-width="130">
                <template slot-scope="scope">
                  <el-checkbox v-model="scope.row.firstInspection"
                    :disabled="btnType == 'look' ? true : false"></el-checkbox>
                </template>
              </el-table-column>
              <el-table-column prop="stockFlag" label="是否入库" :key="10" min-width="130">
                <template slot-scope="scope">
              ...
              <el-table-column prop="reportFlag" label="是否报工" :key="111" min-width="130">
                <template slot-scope="scope">
              ...
              <el-table-column prop="lastFlag" label="是否末道工序" :key="121" min-width="130">
                <template slot-scope="scope">
                  <el-checkbox v-model="scope.row.lastFlag" disabled></el-checkbox>
                </template>
              </el-table-column>
              <el-table-column label="操作" width="180" fixed="right" v-if="btnType != 'look'">
                <template slot-scope="scope">
          ...
          <el-tab-pane label="用料清单" name="annex">
            ...
            <el-row :gutter="30" style="padding: 0 15px">
              <el-table ref="product" :data="productData" :fixedNO="false" @selection-change="handeleProductInfoData"
                ...
                <el-table-column prop="productCode" label="产品编码" :key="3" min-width="100" />
                <el-table-column prop="productName" label="产品名称" :key="4" min-width="100">
                </el-table-column>
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <JNPF-table v-loading="listLoading" ref="workOrder" :data="processList" :fixedNO="true"
                ...
                <el-table-column prop="code" label="工序编码" min-width="130">
                </el-table-column>
                <el-table-column prop="name" label="工序名称" min-width="130"></el-table-column>
                <el-table-column prop="productCategoryIdText" label="工序分类" min-width="130"></el-table-column>
                <el-table-column prop="processingTypeName" label="加工类型" min-width="130"></el-table-column>
                <el-table-column prop="pricingTypeName" label="计价类型" min-width="130"></el-table-column>
              </JNPF-table>
            </div>
          </div>
        </div>
    ...
    handleConfirm(value) {
      this.$refs["dataForms"].validate((valid) => {
        if (valid) {
          ...
          this.reworkForm.businessCode = "assemble";
