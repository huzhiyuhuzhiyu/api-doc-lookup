    ...
    <div class="JNPF-common-layout-center">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="list" @expand-change="expandChange"
          ...
          <el-table-column prop="salesmanName" label="业务人员" width="150" sortable="custom" />
          <el-table-column prop="receivableMoney" label="付款金额" width="120" sortable="custom" />
          <el-table-column prop="creatorUser" label="制单人员" width="120" />
          <el-table-column prop="description" label="订单备注" width="120" show-overflow-tooltip />
