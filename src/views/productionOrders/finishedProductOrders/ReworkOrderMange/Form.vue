    ...
    <div class="JNPF-preview-main org-form">
          ...
          <el-tab-pane label="订单信息" name="orderInfo">
              ...
              <el-row :gutter="30" class="custom-row">
                <el-col :sm="8" :xs="24">
                  <el-form-item label="返工产品" prop="productsId">
                    <el-input
                      ...
                      v-model="reworkForm.productName"
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="工作令号" prop="workOrderNo">
                    <el-input
                      placeholder="请输入工作令号"
                      :disabled="btnType == 'look' ? true : false"
                      v-model="reworkForm.workOrderNo"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="工艺路线" prop="routingName">
                    <el-input
                      placeholder="请输入工艺路线"
                      disabled
                      v-model="reworkForm.routingName"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="生产BOM" prop="routingName">
                    <el-input
                      placeholder="请输入生产BOM"
                      disabled
                      v-model="reworkForm.bomName"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="计划开始日期" prop="planStartDate">
                    <el-date-picker
                      v-model="reworkForm.planStartDate"
                      type="date"
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="计划结束日期" prop="planEndDate">
                    <el-date-picker
                      v-model="reworkForm.planEndDate"
                      type="date"
                      value-format="yyyy-MM-dd"
                      @change="handleEnDate"
                      :disabled="btnType == 'look' ? true : false"
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="返工生产数量" prop="productionQuantity">
                    <el-input
                      v-model="reworkForm.productionQuantity"
                      placeholder="请输入返工生产数量"
                      @input="handleInput"
                      :disabled="btnType == 'look' ? true : false"
                      maxlength="200"
                    />
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="返工类型" prop="reworkType">
                    <el-select
                      v-model="reworkForm.reworkType"
                      placeholder="请选择返工类型"
                      style="width: 100%"
                      :disabled="btnType == 'look' ? true : false"
                    >
                      <el-option
                        v-for="(item, index) in reworkTypeList"
                        :key="index"
                        :label="item.label"
                        :value="item.value"
                      ></el-option>
            ...
            >
              ...
              <el-table-column
                ...
                :key="14"
              ></el-table-column>
              <el-table-column prop="processName" label="工序名称" :key="15" />
              <el-table-column prop="firstFlag" label="是否首道工序" :key="16">
                <template slot-scope="scope">
                  <el-checkbox
                    v-model="scope.row.firstFlag"
                    disabled
                  ></el-checkbox>
                </template>
              </el-table-column>
              <el-table-column
                prop="chargeableReworkFlag"
                label="是否计费返工"
                :key="18"
              >
                <template slot-scope="scope">
                  <el-checkbox
                    v-model="scope.row.chargeableReworkFlag"
                    :checked="scope.row.chargeableReworkFlag"
                    :disabled="btnType === 'look'"
                    @change="hangleChargeble(scope.row)"
                  ></el-checkbox>
                </template>
              </el-table-column>
              <el-table-column
              ...
              >
                <template slot-scope="scope">
                  <el-checkbox
                    v-model="scope.row.firstInspection"
                    :disabled="btnType == 'look' ? true : false"
                  ></el-checkbox>
                </template>
              </el-table-column>
              <el-table-column prop="stockFlag" label="是否入库" :key="10">
                <template slot-scope="scope">
                  <el-checkbox
              ...
              <el-table-column prop="reportFlag" label="是否报工" :key="111">
                <template slot-scope="scope">
                  <el-checkbox
              ...
              <el-table-column prop="lastFlag" label="是否末道工序" :key="121">
                <template slot-scope="scope">
                  <el-checkbox
                    v-model="scope.row.lastFlag"
                    disabled
                  ></el-checkbox>
                </template>
              </el-table-column>
            ...
            <el-row :gutter="30" style="padding: 0 15px">
              ...
              >
                ...
                >
                  ...
                  <template slot-scope="scope">
                    <el-input
                      @input="handleInputFun(scope)"
                      v-model="scope.row.materialsUsedQuantity"
                      :disabled="btnType == 'look' ? true : false"
                    >
                    </el-input>
                  </template>
              ...
              <el-row :gutter="30" class="custom-row">
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="产品图号" prop="productDrawingNo">
                    <el-input
                      placeholder="请输入产品图号"
                      disabled
                      v-model="flowCard.productDrawingNo"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="左芯子（图号）" prop="leftCore">
                    <el-input
                      placeholder="请输入左芯子（图号）"
                      disabled
                      v-model="flowCard.leftCore"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="左芯子长" prop="leftCoreLength">
                    <el-input
                      placeholder="请输入左芯子长"
                      disabled
                      v-model="flowCard.leftCoreLength"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="右芯子长" prop="rightCoreLength">
                    <el-input
                      placeholder="请输入右芯子长"
                      disabled
                      v-model="flowCard.rightCoreLength"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="套筒（图号）" prop="sleeveModel">
                    <el-input
                      placeholder="请输入套筒（图号）"
                      disabled
                      v-model="flowCard.sleeveModel"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="护套（图号）" prop="sheathModel">
                    <el-input
                      placeholder="请输入护套（图号）"
                      disabled
                      v-model="flowCard.sheathModel"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="剥内胶长" prop="innerRubberLength">
                    <el-input
                      placeholder="请输入剥内胶长"
                      disabled
                      v-model="flowCard.innerRubberLength"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="剥外胶长" prop="externalAdhesive">
                    <el-input
                      placeholder="请输入剥外胶长"
                      disabled
                      v-model="flowCard.externalAdhesive"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="扣压伸长量" prop="compressionElongation">
                    <el-input
                      ...
                      disabled
                      v-model="flowCard.compressionElongation"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="扣压时间" prop="withholdingTime">
                    <el-input
                      placeholder="请输入扣压时间"
                      disabled
                      v-model="flowCard.withholdingTime"
                    ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="芯孔变型量" prop="coreHoleDeformation">
                    <el-input
                      placeholder="请输入芯孔变型量"
                      disabled
                      v-model="flowCard.coreHoleDeformation"
                    ></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
      ...
      >
        <div class="JNPF-common-layout" style="height: 68vh; overflow: auto">
          <div class="JNPF-common-layout-left">
              ...
              <span class="options">
                <el-dropdown>
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item @click.native="getcategoryTree()"
            ...
            <el-scrollbar
              class="JNPF-common-el-tree-scrollbar"
            ...
            >
              <el-tree
                ...
                node-key="id"
                @node-click="handleNodeAllProduct"
                class="JNPF-common-el-tree"
                v-if="refreshTree"
                :filter-node-method="filterNodeAllProduct"
              >
                <span
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="6">
                  <el-form-item>
                    <el-input
                      v-model="ProductListRequestObj.code"
                      placeholder="请输入产品编码"
                      clearable
                    />
                  </el-form-item>
                ...
                <el-col :span="6">
                  <el-form-item>
                    <el-input
                      v-model="ProductListRequestObj.name"
                      placeholder="请输入产品名称"
                      clearable
                    />
                  </el-form-item>
                ...
                <el-col :span="6">
                  <el-form-item>
                    <el-input
                      v-model="ProductListRequestObj.drawingNo"
                      placeholder="请输入图号"
                      clearable
                    />
                  </el-form-item>
            ...
            <div
              class="JNPF-common-layout-main JNPF-flex-main"
              v-if="productType == 'workerInfo'"
            >
              <JNPF-table
              ...
              <pagination
                :total="allProductTotal"
                :page.sync="ProductListRequestObj.pageNum"
                :limit.sync="ProductListRequestObj.pageSize"
                @pagination="getAllProductList"
              />
            </div>
        ...
        <span
          slot="footer"
          class="dialog-footer"
          v-if="productType != 'workerInfo' ? true : false"
        >
      ...
      >
        <div
          ...
          style="height: 68vh; overflow: auto; margin-top: 15px"
        >
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <JNPF-table
                v-loading="listLoading"
                :data="routproductData"
                hasC
                @selection-change="handleSelectionChangeAllPruduct"
                ref="procForm"
                @row-dblclick="handleDBRowProductClick"
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <JNPF-table
                ...
                :data="processList"
                :fixedNO="true"
                @selection-change="selectProcess"
...
export default {
  ...
  methods: {
    ...
    submitProcess() {
      ...
      if (
        this.selectProcessArr[this.selectProcessArr.length - 1]
    ...
    handleConfirm(value) {
      this.$refs["dataForms"].validate((valid) => {
        if (valid) {
          ...
          if (
            this.workOrderData[this.workOrderData.length - 1].processingType !==
            "self_produced"
          ) {
            submitFlag = false;
            this.btnLoading = false;
