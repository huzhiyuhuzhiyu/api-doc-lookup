          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="dataForm.orderNo" @keyup.enter.native="search()" placeholder="请输入领料单号" clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="dataForm.personName" @keyup.enter.native="search()" placeholder="请输入领料人"
                      clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
                    <el-date-picker v-model="orderDateArr" type="daterange" value-format="yyyy-MM-dd" style="width: 100%;"
                      :picker-options="global.timePickerOptions" start-placeholder="领料开始日期" end-placeholder="领料结束日期"
                      clearable>
                    </el-date-picker>
                  </el-form-item>
                </el-col>
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="linesQuery.orderNo" placeholder="请输入领料单号" @keyup.enter.native="search()" clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
                  ...
                  <template slot-scope="scope">
                    ...
                    <el-dropdown hide-on-click>
                      ...
                      <el-dropdown-menu slot="dropdown">
                        ...
                        <el-dropdown-item @click.native="handleUserRelation(scope.row.materialCollectId, 'copy')">
                          复制通知单
                        </el-dropdown-item>
                      </el-dropdown-menu>
                    </el-dropdown>
        ...
        <el-form :model="dataForm" label-width="120px" label-position="top">
          ...
          <el-col :span="12">
            <el-form-item label="领料日期">
              <el-date-picker v-model="orderDateArr" type="daterange" value-format="yyyy-MM-dd" style="width: 100%;"
                :picker-options="global.timePickerOptions" start-placeholder="领料开始日期" end-placeholder="领料结束日期" clearable>
              </el-date-picker>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="创建时间">
              <el-date-picker v-model="createTimeArrsta" type="datetimerange" format="yyyy-MM-dd HH:mm:ss"
                ...
                start-placeholder="创建开始时间" end-placeholder="创建结束时间" :default-time="['00:00:00', '23:59:59']" clearable>
              </el-date-picker>
            </el-form-item>
          </el-col>
        </el-form>
          ...
          <el-col :span="12">
            <el-form-item label="领料日期">
              <el-date-picker v-model="deliveryDatefahuo" type="daterange" value-format="yyyy-MM-dd" style="width: 100%;"
                clearable start-placeholder="请选择领料开始日期" end-placeholder="请选择领料结束日期">
              </el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  name: 'MaterialRequisitionNotice',
  components: { Form, },
  data() {
    return {
      linesTotal: 0,
