      ...
      <div class="JNPF-common-layout-center JNPF-flex-main">
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main">
          ...
          <JNPF-table ref="dataTable" v-loading="listLoading" :selectable="tableData" :data="tableData" fixedNO
            ...
            <el-table-column prop="pickingStatus" label="领料状态" width="120" align="center" fixed="right"
              sortable="custom">
              <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    async handleBatch(batchType) {
      ...
      let flag=null
      if(batchType=='startWork'){
      for (let index = 0; index < this.selectedData.length; index++) {
        const item = this.selectedData[index];
        if(item.pickingStatus=="not_picked"){
          flag=false
          this.$message.error("请先领料再上工")
        }
        break
      }
      if(flag===false)return
