    ...
    <div class="JNPF-preview-main org-form">
      <div class="JNPF-common-page-header">
        ...
        <el-page-header @back="goBack"
          :content="btnType ? '查看承运商档案' : !parentId ? $t(`carrier.addCarrier`) : $t(`carrier.editCarrier`)" />
              ...
              <el-row :gutter="30" class="custom-row">
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="承运商编码" prop="code">
                    <el-input v-model="dataForm.code" placeholder="请输入承运商编码" maxlength="20"
                ...
                <!-- <el-col :sm="8" :xs="24">
                  <el-form-item label="含税计价精度" prop="includingTaxPrecision">
                    <el-input v-model="dataForm.includingTaxPrecision" oninput="value = value.replace(/[^0-9]/g,'')"
                      placeholder="请输入含税计价精度" :disabled="btnType ? true : false" maxlength="4" />
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="不含税计价精度" prop="excludingTaxPrecision">
                    <el-input v-model="dataForm.excludingTaxPrecision" placeholder="请输入不含税计价精度"
                      :disabled="btnType ? true : false" oninput="value = value.replace(/[^0-9]/g,'')" maxlength="4" />
                  </el-form-item>
                </el-col> -->
                <el-col :sm="8" :xs="24">
        ...
        :currOrgId="dataForm.id || '0'" />
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="身份证号" prop="idNo">
                    <el-input v-model="dataForm.idNo" placeholder="请输入身份证号" maxlength="25"
                      :disabled="btnType ? true : false" />
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="车牌号" prop="licensePlateNumber">
                    <el-input v-model="dataForm.licensePlateNumber" placeholder="请输入车牌号" maxlength="20"
                      :disabled="btnType ? true : false" />
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="驾驶证号" prop="driverLicense">
                    <el-input v-model="dataForm.driverLicense" placeholder="请输入驾驶证号" maxlength="50"
                      :disabled="btnType ? true : false" />
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="行驶证号" prop="drivingLicense">
                    <el-input v-model="dataForm.drivingLicense" placeholder="请输入车牌号" maxlength="50"
                      :disabled="btnType ? true : false" />
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="吨数单价" prop="tonnageUnitPrice">
                    <el-input v-model="dataForm.tonnageUnitPrice" placeholder="请输入吨数单价"
                      :disabled="btnType ? true : false" />
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="立方数单价" prop="cubicUnitPrice">
                    <el-input v-model="dataForm.cubicUnitPrice" placeholder="请输入立方数单价"
                      :disabled="btnType ? true : false" />
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                  <el-form-item label="件数单价" prop="unitPricePieces">
                    <el-input v-model="dataForm.unitPricePieces" placeholder="请输入件数单价"
                      :disabled="btnType ? true : false" />
                  </el-form-item>
                </el-col>
              </el-row>
...
export default {
  data() {
    return {
      ...
      dataRule: {
        tonnageUnitPrice: [{ validator: this.formValidate({ type: 'decimal', params: [16, 2, '请输入正确的吨数单价(最多保留2位小数,整数14位)'] }), trigger: 'blur' }],
        cubicUnitPrice: [{ validator: this.formValidate({ type: 'decimal', params: [16, 2, '请输入正确的立方数单价(最多保留2位小数,整数14位)'] }), trigger: 'blur' }],
        unitPricePieces: [{ validator: this.formValidate({ type: 'decimal', params: [16, 2, '请输入正确的件数单价(最多保留2位小数,整数14位)'] }), trigger: 'blur' }],
        // 编号、税号、名称、地区、国家、省、市、区、地址、联系人、电话和手机选填一项、付款方式、含税计价精度（默认2）、不含简况计价精度
        partnerCategoryIdText: [
