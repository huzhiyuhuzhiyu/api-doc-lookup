      ...
      <div style="overflow: auto;">
        <div class="group-container-body section has-hover">
          <div style="height: 65px;width: 100%;padding: 10px;">
            <div class="dash-rich-text">
              <div class="rich-text-content">备件领用归还分析</div>
            </div>
          </div>
        </div>
        <div style="margin-top: 10px;min-width: 1080px;">
          <el-tabs type="border-card" style="height: 100%;" v-model="activeName" @tab-click="handleClick">
            <el-tab-pane label="备件领用归还分析" name="djcsfx">
              <div class="inspectionnum">
                ...
                <div class="frequency-table">
                  ...
                  <div style="height: 672px;" class="JNPF-flex-main">
                    <JNPF-table ref="dataTableInspection" v-loading="listLoadingInspection" :data="tableInspectionresults" fixedNO custom-column customKey="JNPFTableKey_601927">
                      ...
                      <el-table-column prop="orderNo" label="单号" min-width="180"></el-table-column>
                      ...
                      <el-table-column prop="collectionTime" label="日期" width="180" sortable="custom"></el-table-column>
                      <el-table-column prop="maintainerIdText" label="领用/归还人" width="120"></el-table-column>
