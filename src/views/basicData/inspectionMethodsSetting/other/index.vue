    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="tableData" :fixedNO="true" @sort-change="sortChange" custom-column
          ref="dataTable" hasC @selection-change="currentChange" :checkSelectable="checkSelectable"  customKey="JNPFTableKey_890158">
          ...
          <el-table-column prop="productCategoryIdText" label="产品分类" width="120" sortable="custom" />
...
import Form from '@/views/basicData/materialFiles/other/Form'
export default {
  components: { Form },
  data() {
    return {
  ...
  methods: {
    ...
    getcategoryTree() {
      ...
      getcategoryTree({ classAttribute: "other", code: getQueryString('productCategoryCode') }).then(res => {
