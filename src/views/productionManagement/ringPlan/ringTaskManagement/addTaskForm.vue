              ...
              <el-collapse v-model="activeNames">
                ...
                <el-collapse-item title="工序信息" name="productInfo" class="productInfo">
                  <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm" class="data-form">
                    <JNPF-table ref="product" :data="dataFormTwo.data" fixedNO v-loading="tableloading" customKey="JNPFTableKey_790300">
  ...
  watch: {
    'dataForm.productionWeight': {
      handler: function (newVal, oldVal) {
        if (!this.dataForm.productsDrawingNo) return this.$message.error('请先选择型号')
