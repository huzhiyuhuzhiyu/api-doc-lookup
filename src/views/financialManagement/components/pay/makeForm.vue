            ...
            <el-tab-pane label="基础信息" name="jcInfo">
              <el-row :gutter="30">
                <el-form ref="dataForm" v-loading="formLoading" :model="dataForm" :rules="dataRule" label-position="top"
                  ...
                  <el-col :span="8">
                    <el-form-item :label="'待' + showLabel2 + '款金额'" prop="duePayAmount">
                  ...
                  <el-col :span="8">
                    <el-form-item :label="'待' + showLabel + '票金额'" prop="dueAmount">
                      <el-input v-model="dataForm.dueAmount" :placeholder="'待' + showLabel + '金额'" maxlength="20"
                        disabled />
                    </el-form-item>
                  </el-col>
            ...
            <el-tab-pane :label="'预' + showLabel2 + '款信息'" name="receiverInfo">
              <div style="display: flex;flex-direction: column;height: 100%;">
                <JNPF-table @selection-change="handeleProductInfoData" hasC fixedNO v-loading="formLoading"
                  :data="payData" custom-column ref="payRef" :checkSelectable="checkSelectable" customKey="JNPFTableKey_147168">
