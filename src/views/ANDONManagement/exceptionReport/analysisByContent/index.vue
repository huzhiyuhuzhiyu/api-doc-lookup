      ...
      <div class="content-table-main">
        ...
        <div class="table-content" v-loading="listLoading">
          ...
          <div style="height: 400px;">
            <JNPF-table  v-if="tableList.length > 0" ref="tabForm" :data="tableList" custom-column row-key="id" :hasNO="false" style="border:1px solid #ebeef5;border-right:none;" customKey="JNPFTableKey_974313">
