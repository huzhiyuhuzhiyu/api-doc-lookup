      ...
      <div class="JNPF-preview-main org-form">
        <div :class="['JNPF-common-page-header', type === 'look' ? 'noButtons' : '']">
          <el-page-header @back="goBack"
            :content="type == 'add' ? '新建采购收货通知单' : type == 'edit' ? '编辑采购收货通知单' : type == 'look' ? '查看采购收货通知单' : '新建采购收货通知单'" />
            ...
            <el-tab-pane label="基础信息" name="jcInfo">
              ...
              <el-row :gutter="15" class="">
                <el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px"
                  ...
                  <el-col :span="8">
                    <el-form-item label="采购订单" prop="purchaseOrderNo" ref="purchaseOrderNo">
                      <el-input type="text" v-model="dataForm.purchaseOrderNo" placeholder="请选择采购订单" readonly
                  ...
                  <el-col :span="8" v-if="type === 'look'">
                    <el-form-item label="供应商编码" prop="partnerCode" ref="partnerCode">
                      <el-input type="text" v-model="dataForm.partnerCode" placeholder="请输入供应商编码" maxlength="20"
                  ...
                  <el-col :span="8" v-if="type === 'look'">
                    <el-form-item label="供应商名称" prop="partnerName" ref="partnerName">
                      <el-input type="text" v-model="dataForm.partnerName" placeholder="请输入供应商名称" maxlength="20"
                        :disabled="type == 'look' ? true : false">
                      </el-input>
                    </el-form-item>
                  </el-col>
                  ...
                  <el-col :span="8" v-if="type === 'look'">
                    <el-form-item label="收货状态" prop="receivingStatus" ref="receivingStatus">
                      <el-input type="text" :value="dataForm.receivingStatus === 'receiving' ? '未完成' : '已完成'"
                  ...
                  <el-col :span="8" v-if="type === 'look'">
                    <el-form-item label="检验状态" prop="inspectionStatus" ref="inspectionStatus">
                      <el-input type="text" :value="dataForm.inspectionStatus === 'unInspect' ? '待检验' : '已检验'"
              ...
              <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm">
                <el-table style="border: 1px solid #e3e7ee;" hasNO fixedNO v-bind="dataFormTwo.data"
                    ...
                    <template slot-scope="scope">
                      <el-form-item prop="productName">
                        <!-- <el-input :title="scope.row.productName" v-model="scope.row.productName"
                              :disabled="type != 'add'" readonly maxlength="20" placeholder="产品名称">{{
                  ...
                  <el-table-column prop="mainUnit" label="单位(主)" min-width="120" key="mainUnit" show-overflow-tooltip>
                    <template slot-scope="scope">
                  ...
                  <!-- <el-table-column prop="warehouse" label="收货仓库" min-width="200" fixed="left">
                        ...
                        <template slot-scope="scope">
                          <el-form-item ref="warehouseRef" :prop="'data.' + scope.$index + '.' + 'warehouse'"
                            ...
                            <ComSelect-list :requestObj="{}" :dialogTitle="'选择仓库'"
                              v-model="scope.row.warehouse" :isdisabled="type === 'look'" :method="getWarehouseList"
                              :paramsObj="{ scope }" @change="changeWarehouse"></ComSelect-list>
                          </el-form-item>
                        </template>
                      </el-table-column> -->

                  <el-table-column prop="purchaseQuantity" label="采购数量" min-width="200" key="purchaseQuantity">
...
export default {
  ...
  data() {
    return {
      ...
      dataForm: {
        ...
        notificationType: "procure",             //	通知单类型 外协通知 external、销售通知 sale,可用值:external,sale           
      ...
      rules: {
        ...
        purchaseOrderNo: [{ required: true, message: '请选择采购订单', trigger: ['change'] }],
  ...
  methods: {
    ...
    //     this.$set(this.dataFormTwo.data[index], 'notificationType', 'procure')
    //     console.log(this.dataFormTwo.data[index]);
                  ...
                  linesData.forEach(item => {
                    if (resultArray.length) {
                      resultArray.forEach(item2 => {
                        ...
                        item2.drawingNo = item2.productDrawingNo
                ...
                detailpurPurchaseReceiptReturnGoods(this.dataForm.id).then(res => {
                  ...
                  linesData.forEach(item => {
                    res.data.forEach(item2 => {
                      ...
                      if (item.id === item2.ordersLineId) {
                        item2.purchaseQuantity = item.purchaseQuantity ? item.purchaseQuantity : 0
                        item2.receiptQuantity = item.receiptQuantity
                      }
                    })
                  })
    ...
    changeOrder(data) {
      ...
      purPurchaseOrderdetail(this.dataForm.purchaseOrderId).then(res => {
        ...
        console.log("this.dataForm.data", this.dataFormTwo.data);
