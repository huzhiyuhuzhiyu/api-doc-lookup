        ...
        <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                ...
                <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableDataList" @sort-change="sortChange"
                    custom-column  customKey="JNPFTableKey_115319">
                    ...
                    <el-table-column prop="newFlag" label="是否最新版本" width="120">
                        <template slot-scope="scope">
                            <div v-if="scope.row.newFlag == '0'">否</div>
                            <div v-else-if="scope.row.newFlag == '1'">是</div>
                        </template>
                    </el-table-column>
...
import { getbimDrawingData, deletebimDrawing } from '@/api/basicData/index'
...
export default {
    ...
    methods: {
        ...
        initData() {
            getbimDrawingData(this.tableQuery).then(res => {
