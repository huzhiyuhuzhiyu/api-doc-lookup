          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="listQuery.parentOrderNo" placeholder="请输入领料单号" clearable
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" :fixedNO="true"
                ...
                <el-table-column prop="parentOrderNo" label="领料单号" min-width="200" fixed="left" sortable="custom">
                  <template slot-scope="scope">
                    <el-link type="primary" @click.native="addOrUpdateHandle(scope.row.id, true)">
                      {{ scope.row.parentOrderNo }}
                    </el-link>
                  </template>
                </el-table-column>
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="linesQuery.parentOrderNo" placeholder="请输入领料单号" @keyup.enter.native="search()"
                      clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="linesTableData" v-loading="listLoading" :data="linesTableData" :fixedNO="true"
                ...
                <el-table-column prop="parentOrderNo" label="领料单号" width="200" sortable="custom">
                  <template slot-scope="scope">
                    <el-link type="primary" @click.native="handleUserRelation(scope.row.materialCollectId, true)">
                      {{ scope.row.parentOrderNo }}
                    </el-link>
                  </template>
                </el-table-column>
        ...
        <el-form ref="diaForm" :model="linesQuery" label-width="120px" label-position="top">
          <el-col :span="12">
            <el-form-item label="领料单号">
              <el-input v-model="linesQuery.parentOrderNo" placeholder="请输入领料单号" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
import DetailForm from '../../../inboundAndOutbound/outboundOrders/detailForm/OutboundPickOut.vue'
export default {
