                ...
                <el-collapse-item title="工序信息" name="processInfo">
                  <el-col :span="24">
                    ...
                    <JNPF-table :hasC="type !== 'look'" hasNO style="border: 1px solid #e3e7ee;" ref="processRef"
                      ...
                      row-key="code" :hasMove="type !== 'look'" @changeMove="changeMove" :height="customStyleData" customKey="JNPFTableKey_661226">
...
import ProcessDialog from '../processSettingss/personnel-dialog.vue'
