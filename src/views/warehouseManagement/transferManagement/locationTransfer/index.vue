          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
                ...
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="listQuery.transferOutWarehouseName" @keyup.enter.native="search()"
                      placeholder="请输入移库仓库名称" clearable />
                  </el-form-item>
                </el-col>
                <!-- <el-col :span="4">
                  <el-form-item>
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table v-loading="listLoading" ref="dataTable" :data="tableData" @sort-change="sortChange"
                ...
                <el-table-column prop="orderNo" label="移库单号" min-width="200" fixed="left" sortable="custom">
                ...
                <el-table-column prop="transferOutWarehouseCode" label="移库仓库编码" min-width="160" />
                <el-table-column prop="transferOutWarehouseName" label="移库仓库名称" min-width="160" sortable="custom" />
                <el-table-column prop="reasonRejection" label="驳回理由" min-width="160" />
                <el-table-column prop="approvalCompletionDate" label="审批完成时间" min-width="160" sortable="custom" />
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="linesQuery.orderNo" @keyup.enter.native="search()" placeholder="请输入移库单号"
                      clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="linesQuery.transferOutWarehouseCode" @keyup.enter.native="search()"
                      placeholder="请输入移库仓库编码" clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table v-loading="listLoading" ref="linesDataTable" :data="linesTableData" @sort-change="sortChange"
                ...
                <el-table-column prop="orderNo" label="移库单号" min-width="200" fixed="left" sortable="custom">
                  <template slot-scope="scope">
                    <el-link type="primary" @click.native="addOrUpdateHandle(scope.row.pickingId, true)">
                      {{ scope.row.orderNo }}
                    </el-link>
                  </template>
                </el-table-column>
                ...
                <el-table-column prop="removeGoodsShelvesName" label="移出货架" min-width="180" />
                <el-table-column prop="removeShelfSpaceName" label="移出货位" min-width="180" />
                <el-table-column prop="targetGoodsShelvesName" label="移入货架" min-width="180" />
                <el-table-column prop="targetShelfSpaceName" label="移入货位" min-width="180" />
                <el-table-column prop="remark" label="备注" min-width="200" />
    ...
    <el-dialog title="更多查询" :close-on-click-modal="false" :close-on-press-escape="false" :visible.sync="visible"
      ...
      <el-row :gutter="20">
        ...
        <el-form v-model="listQuery" label-width="120px" label-position="top" v-if="activeName === 'dataTable'">
          <el-col :span="12">
            <el-form-item label="移库仓库名称">
              <el-input v-model="listQuery.transferOutWarehouseName" placeholder="请输入移库仓库名称" clearable />
            </el-form-item>
          </el-col>
          <!-- <el-col :span="12">
        ...
        <el-form v-model="linesQuery" label-width="120px" label-position="top" v-else>
          <el-col :span="12">
            <el-form-item label="移库单号">
              <el-input v-model="linesQuery.orderNo" placeholder="请输入移库单号" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="移库仓库编码">
              <el-input v-model="linesQuery.transferOutWarehouseCode" placeholder="请输入移库仓库编码" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="移库仓库名称">
              <el-input v-model="linesQuery.transferOutWarehouseName" placeholder="请输入移库仓库名称" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    sortChange({ prop, order }) {
      let newProp
      if (this.activeName === 'dataTable') {
        if (['productCode', 'productName', 'drawNo', 'transferOutWarehouseName'].includes(prop)) { newProp = prop }
        else { newProp = prop.replace(/[A-Z]/g, match => '_' + match.toLowerCase()); }
        this.listQuery.orderItems[0].asc = order === 'ascending'
        this.listQuery.orderItems[0].column = order === null ? "" : newProp
      } else {
        if (['transferOutWarehouseName', 'productName', 'productDrawingNo', 'createTime'].includes(prop)) { newProp = prop }
        else { newProp = prop.replace(/[A-Z]/g, match => '_' + match.toLowerCase()); }
