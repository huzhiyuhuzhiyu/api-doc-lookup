    ...
    <el-tabs tab-position="left" style="height:100%" v-model="activeTab">
      <el-tab-pane name="allPanel">
        ...
        <div class="main JNPF-flex-main">
          ...
          <div>
            <JNPF-table v-loading="listLoading" :data="list" empty-text="该文件夹为空" size="mini" style="height: 72vh;">
              ...
              <el-table-column prop="isShare" label="共享文件">
                <template slot-scope="scope">
              ...
              <el-table-column prop="creatorTime" label="创建日期" />
