    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
          ...
          <el-col :span="4" v-for="item in searchList" :key="item.prop">
            ...
            <el-form-item>
              ...
              <el-date-picker v-else-if="item.type === 'date'" v-model="listQuery.createTimeArr" type="datetimerange"
                value-format="yyyy-MM-dd HH:mm:ss" :default-time="['00:00:00', '23:59:59']" style="width: 100%;" :start-placeholder="item.label + '开始时间'"
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <div class="JNPF-common-head">
          <el-page-header @back="$emit('close', true)" :content="listQuery.documentType === 'inbound' ? '入库数量明细' : '出库数量明细'" />
        ...
        <JNPF-table :partentOrChild="'child'" ref="dataTables" v-loading="listLoading" :data="tableData" fixedNO custom-column>
