      ...
      <div class="JNPF-common-layout-center JNPF-flex-main">
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main">
          <div class="JNPF-common-head">
            <div>
              <el-button size="mini" @click="handleBatch('startWork')" :disabled="!startWorkFlag"
                :loading="btnLoading">批量上工</el-button>
          ...
          <JNPF-table ref="dataTable" v-loading="listLoading" :selectable="tableData" :data="tableData" fixedNO
            ...
            <el-table-column prop="pickingStatus" label="领料状态" width="140" align="center" fixed="right"
              sortable="custom">
              <template slot-scope="scope">
                <el-tag type="warning" disable-transitions v-if="scope.row.pickingStatus === 'not_picked'">未领料</el-tag>
                <el-tag type="primary" disable-transitions
                  v-else-if="scope.row.pickingStatus === 'picking'">领料中</el-tag>
                <el-tag type="success" disable-transitions
                  v-else-if="scope.row.pickingStatus === 'picked'">已领料</el-tag>
              </template>
            </el-table-column>
            ...
            <el-table-column label="操作" width="160" fixed="right">
              <template slot-scope="scope">
                <el-button size="mini" type="text" :disabled="scope.row.workOrderStatus!='normal'||scope.row.startingStatus == 'in_progress'"
      ...
      <el-row :gutter="15" class="">
        <el-form ref="elForm" :model="dataForm" size="small" label-position="top">
          <el-row :gutter="30" class="custom-row">
            ...
            <el-col :sm="24" :xs="24">
              <el-form-item :label="batchFormTitle+'时间'" prop="operatingTime"
                :rules="[{ required: true, trigger: 'change', message: batchFormTitle === '上工'?'请选择上工时间':'请选择下工时间' }]">
                <el-date-picker v-model="dataForm.operatingTime" type="datetime" :placeholder="'请选择'+batchFormTitle+'时间'"
  ...
  methods: {
    ...
    async dataFormSubmit() {
      ...
      let requestData = effectData.map(o => {
        return {
          downTime:this.batchFormTitle === '下工'?this.dataForm.operatingTime:'',
          personId: this.dataForm.personId, // 工作人员id
          upTime: this.batchFormTitle === '上工'?this.dataForm.operatingTime:'', // 操作时间
          dispatchListId: o.id,
