      ...
      <div class="content-table-main">
        ...
        <div class="table-content" v-loading="listLoading">
          ...
          <div style="height: 400px;">
            <JNPF-table ref="tabForm" show-summary :summary-method="getSummaries" :data="tableList" custom-column row-key="id" :hasNO="false" style="border:1px solid #ebeef5;border-right:none;" customKey="JNPFTableKey_811788">
              ...
              <el-table-column prop="dealCustomerRate" label="客户成交率(%)" min-width="130" />
              <el-table-column prop="contractMoney" label="合同总金额(元)" min-width="130" />
