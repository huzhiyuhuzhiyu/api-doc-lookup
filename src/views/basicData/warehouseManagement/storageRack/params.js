...
export default () => [
  {
    ...
    tabContent: [
      ...
      { prop: "name", label: "库位名称", value: "", type: 'input', render: true, itemRules: [{ required: true, trigger: "change" }] },
      { prop: "code", label: "库位编码", value: "", type: 'input', render: true, itemRules: [{ required: true, trigger: "change" }], itemDisabled: false },
