<template>
  <el-dialog title="选择外协订单" :close-on-click-modal="false" :close-on-press-escape="false" :visible.sync="allProVisible"
    lock-scroll class="JNPF-dialog JNPF-dialog_center selectPro" width="71%" append-to-body>
      ...
      <div class="JNPF-common-layout-center JNPF-flex-main">
        <el-row class="JNPF-common-search-box" :gutter="24">
          <el-form @submit.native.prevent>
            ...
            <el-col :span="4">
              <el-form-item>
                <el-select v-model="listQuery.receivingListStatus" placeholder="收货状态"  style="width: 100%;" clearable>
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main">
          <JNPF-table v-loading="listLoading" :data="allorderData" @row-dblclick="seleceCustomerdd" @selection-change="seleceCustomerdd">
            ...
            <el-table-column label="操作" width="100">
              <template slot-scope="scope">
                <el-button type="text" size="mini" @click="seleceCustomerdd(scope.row)">选择</el-button>
              </template>
            </el-table-column>
          </JNPF-table>
...
export default {
  data() {
    return {
      ...
      receiptReturnType: [
        { label: "未收货完成", value: "receiving" },
        { label: "已收货完成", value: "received" }
      ],
    }
  },
  methods: {
