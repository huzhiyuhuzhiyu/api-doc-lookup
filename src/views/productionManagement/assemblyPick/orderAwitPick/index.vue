    ...
    <div class="JNPF-common-layout">
        ...
        <div class="JNPF-common-layout-center JNPF-flex-main"  v-if="!formVisible">
            ...
            <el-table-column prop="processName" label="工序名称" min-width="300" sortable="custom"></el-table-column>
                        ...
                        <el-table-column prop="qualifiedQuantity" label="下道已领数量" min-width="150" />
                        ...
                        <el-table-column label="操作" width="220" fixed="right">
                            <template slot-scope="scope">
                                <el-button size="mini" type="text" @click="addition(scope.row)">生产领BOM料</el-button>
                                <el-button size="mini" type="text" @click="addition(scope.row)">生产领料</el-button>
