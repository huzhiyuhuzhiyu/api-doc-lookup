                  ...
                  <div>
                    <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm">
                      ...
                      <el-table-column prop="angle" label="角度" width="120" v-if="$store.getters.configData.orderField.angle">
                        ...
                        <el-table-column label="操作" :width="$store.getters.configData.product.enable_symbol ? 120 : 80" fixed="right">
                          <template slot-scope="scope">
                              <el-button type="text" v-if="$store.getters.configData.product.enable_symbol" :disabled="!scope.row.productsId ? true : btnType === 'look'"
                                         @click="selectProductSymbol(scope,dataFormTwo.data)" style=" color: #3fb9f8">选择代号</el-button>
                            <el-button type="text" class="JNPF-table-delBtn"  v-if="dataFormTwo.data.length > 1"
...
export default {
    ...
    mixins: [AbProjectMixin, tenantMinix, ProductSymbolMixin],
    ...
    methods: {
        ...
        openSeleceProductDialog() {
            ...
            if (this.$store.getters.configData.product.enable_productName) {
                ...
                this.ProductTableSearchList.splice(index + 1, 0, {
                    prop: 'productName',
                    label: '产品名称',
                    type: 'input'
                })
            ...
            if (this.abProjectSwitchVisible) {
                ...
                this.ProductTableSearchList.unshift({
                    prop: 'projectId',
                    label: '所属项目',
                    type: 'select',
