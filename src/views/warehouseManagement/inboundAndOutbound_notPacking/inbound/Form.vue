          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="formLoading" ref="main">
              ...
              <TableForm-product :value="linesList" @input="linesChange" ref="linesForm" class="TableForm"
                :tableItems="linesListItems" :openMode="openMode" @addth="addOrDelLinesItem" @deleteth="addOrDelLinesItem"
                @openSide="openSide" :warehouseId="dataForm.warehouseId" customStyle />
            </div>
          </div>
        </div>
      </div>
    ...
    refeshDataFormItems() {
      ...
      this.dataFormItems = [
        { prop: "sourceType", label: "来源类型", value: "io_other", type: "select", options: this.originTypeList, itemRules: [{ required: true, trigger: "blur" }], itemDisabled: true, sm },
        {
          ...
          change: this.wareChange, requestObj: { chooseUserFlag: true, type: 'normal' }, itemRules: [{ required: true, trigger: "no" }], dialogTitle: "选择仓库", sm
        },
