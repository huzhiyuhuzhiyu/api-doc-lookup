    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
        ...
        <JNPF-table ref="tabForm" v-loading="listLoading" :data="tableData" custom-column row-key="id" :fixedNo="true"
          v-if="isProjectSwitchFlag" @sort-change="sortChange" customKey="JNPFTableKey_926723">
...
export default {
  ...
  methods: {
    ...
    sortChange({ prop, order }) {
      let newProp
      if (prop == 'productDrawingNo'||prop=='mainUnit'||prop=='projectName'||prop=='classAttribute' || prop == 'productCode' || prop == 'warehouseName') {
        newProp = prop
      } else {
