<template>
  <div class="JNPF-common-layout">
      ...
      <div class="JNPF-common-layout-center JNPF-flex-main">
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
          <div class="JNPF-common-head">
            <div> <el-button type="primary" size="mini" icon="el-icon-download"
          ...
          <JNPF-table ref="dataTable" :data="tableData" :fixedNO="true" v-if="isProjectSwitchFlag"
            ...
            :setColumnDisplayList="columnList" customKey="JNPFTableKey_778193">
            <el-table-column prop="productionOrderNo" label="生产任务单号" min-width="200" sortable="custom">
              <template slot-scope="scope">
                <el-link type="primary" @click.native="handleUserRelation(scope.row.productionOrderId)">{{
            ...
            <el-table-column prop="requisitionQuantity" label="下道已领数量" min-width="150" />
            ...
            <el-table-column label="操作" width="220" fixed="right">
              <template slot-scope="scope">
                <el-button size="mini" v-if="scope.row.processingType === 'self_produced'"
                  :disabled="scope.row.pickingStatus === 'finished'" type="text"
                  @click="addition(scope.row, true)">生产领BOM料</el-button>
                <el-button size="mini" :disabled="scope.row.lastFlag" type="text"
                  @click="addition(scope.row, false)">生产领料</el-button>
    ...
    <PickForm :flowCode="flowCode" v-if="pickVisible" ref="PickForm" @refreshDataList="initData" @close="closeForm" />
    <!-- 高级查询 -->
...
import PickForm from './Form/index.vue'
...
export default {
  name: 'OrderAwitPick',
  components: { ExportForm, SuperQuery, Form, PickForm },
  ...
  methods: {
    ...
    addition(data, isBomPick) {
      this.pickVisible = true
      this.$nextTick(() => {
        this.$refs.PickForm.init(data, 'add', false, 'awit', isBomPick)
      })
    },
    ...
    sortChange(item) {
      this.orderForm.orderItems[0] = getSortField(item, ['partnerCode', 'productName', 'projectName', 'partnerName', 'shipperName', 'createByName', 'productDrawingNo'])
      this.initData()
    },
