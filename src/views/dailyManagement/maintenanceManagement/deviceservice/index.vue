  ...
  <div class="JNPF-common-layout">
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
        ...
        <JNPF-table ref="dataTable" v-if="istable" hasC @selection-change="handeleInfoData" :data="tableData" @sort-change="sortChange" custom-column customKey="JNPFTableKey_231506">
