          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="dataTableInbound" v-loading="listLoading" :data="tableData"  @sort-change="sortChange" custom-column customKey="JNPFTableKey_7668545512749">
                <el-table-column prop="partnerName" label="供应商名称"  ></el-table-column>
                <el-table-column prop="productsName" label="产品名称"  />
                <el-table-column prop="sumNum" label="采购收货数量"  />
                <el-table-column prop="sumAmount" label="采购金额"  ></el-table-column>
                <el-table-column prop="amountPercent" label="采购金额占比"   width="200">
              ...
              <span>总收货数量:{{ totalSumNum }}</span>
              <span style="margin-left: 10px;">总采购金额:{{ totalSumTotalAmount }}</span>
              </pagination>
            </div>
