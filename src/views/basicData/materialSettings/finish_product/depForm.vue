<template>
  <el-dialog :title="!dataForm.id ? '新建成品分类' : '编辑成品分类'" :close-on-click-modal="false" :close-on-press-escape="false"
    ...
    <el-form ref="dataForm" v-loading="formLoading" :model="dataForm" :type="dataForm.type" :rules="dataRule"
      ...
      <el-form-item label="备注" prop="remark">
        <el-input v-model="dataForm.remark" placeholder="请输入备注" type="textarea" :rows="3" maxlength="200" />
      </el-form-item>
    </el-form>
