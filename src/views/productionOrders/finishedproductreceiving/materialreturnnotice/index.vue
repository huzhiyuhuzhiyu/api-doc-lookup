                    ...
                    <div class="JNPF-common-layout-center JNPF-flex-main">
                                ...
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-date-picker v-model="orderDateArr" type="daterange" value-format="yyyy-MM-dd"
                                            ...
                                            start-placeholder="退料开始日期" end-placeholder="退料结束日期" clearable>
                                        </el-date-picker>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
                        ...
                        <div class="JNPF-common-layout-main JNPF-flex-main">
                            ...
                            <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" @sort-change="sortChange"
                                ...
                                <el-table-column prop="personName" label="退料人" min-width="150" />
                                <el-table-column prop="operationDate" label="退料日期" min-width="150" sortable="custom" />
                    ...
                    <div class="JNPF-common-layout-center JNPF-flex-main">
                        <el-row class="JNPF-common-search-box" :gutter="16">
                            <el-form @submit.native.prevent>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-input v-model="linesQuery.orderNo" placeholder="请输入退料单号"
                                            @keyup.enter.native="search()" clearable />
                                    </el-form-item>
                                </el-col>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-input v-model="linesQuery.personName" placeholder="请输入退料人"
                                            @keyup.enter.native="search()" clearable />
                                    </el-form-item>
                                </el-col>
                                <el-col :span="4">
                                    <el-form-item>
                                        <el-date-picker v-model="deliveryDatefahuo" type="daterange"
                                            ...
                                            start-placeholder="退料开始日期" end-placeholder="退料结束日期">
                                        </el-date-picker>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="6">
                        ...
                        <div class="JNPF-common-layout-main JNPF-flex-main">
                            ...
                            <JNPF-table ref="linesTableData" v-loading="listLoading" :data="linesTableData" :fixedNO="true"
                                ...
                                <el-table-column prop="orderNo" label="退料单号" width="200" sortable="custom" fixed="left">
                                    <template slot-scope="scope">
                ...
                <el-form :model="dataForm" label-width="120px" label-position="top">
                    <el-col :span="12">
                        <el-form-item label="退料单号">
                            <el-input v-model="dataForm.orderNo" placeholder="请输入退料单号" clearable />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                    ...
                    <el-col :span="12">
                        <el-form-item label="退料人">
                            <el-input v-model="dataForm.personName" placeholder="请输入退料人" clearable />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="退料日期">
                            <el-date-picker v-model="orderDateArr" type="daterange" value-format="yyyy-MM-dd"
                                style="width: 100%;" :picker-options="global.timePickerOptions" start-placeholder="退料开始日期"
                                end-placeholder="退料结束日期" clearable>
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    ...
                    <el-col :span="12">
                        <el-form-item label="退料状态">
                            <el-select v-model="dataForm.pickingStatus" placeholder="请选择退料状态" clearable>
...
export default {
    ...
    data() {
        return {
            ...
            listLoading: false,
            orderList: [
                { label: "未退料", value: "not_back" },
                { label: "已退料", value: "back" },
            ],
            documentStateList: [
