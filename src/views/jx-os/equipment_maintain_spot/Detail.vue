        ...
        <div class="JNPF-preview-main">
            ...
            <el-form ref="elForm" :model="item" size="small" label-width="100px" label-position="right"
                ...
                <el-col :span="24">
                    <el-row :gutter="15">
                        ...
                        <el-col :span="8">
                            <el-form-item label="点检类型" prop="equimentMaintainTypeId_name">
            ...
            <el-row :gutter="15" class=" main" :style="{margin: '0 auto',width: '100%'}">
                <JNPF-table v-loading="listLoading" :data="list" @sort-change='sortChange'
                    ...
                    <!-- <el-table-column prop="equipmentMaintainId_name" label="主表id" align="left" /> -->
                    <el-table-column prop="equimentMaintainTypeItemId_name" label="点检内容" align="left" />
                    <el-table-column prop="method_name" label="点检方法" align="left" />

                    <!-- <el-table-column prop="method" label="方法" align="left">
                        <template slot-scope="scope">
                            <el-select v-model="scope.row.method" placeholder="请选择" disabled>
                    ...
                    <el-table-column prop="requirement" label="点检要求" align="left" />
                    <el-table-column prop="standard" label="点检标准" align="left" />
                    ...
                    <!-- <el-table-column v-show = "false" label="操作" fixed="right" width="100">
                        <template slot-scope="scope">
...
export default {
    ...
    data() {
        return {
            ...
            item: {},
            columnList: [
                { prop: 'equimentMaintainTypeItemId', label: '内容' },
                { prop: 'normal', label: '正常/异常' },
                { prop: 'measuredValue', label: '实测值' },
                { prop: 'note', label: '备注' },
                { prop: 'method', label: '方法' },
            ],

            equimentMaintainTypeItemIdOptions: [],

            equimentMaintainTypeItemIdProps: { "label": "name", "value": "F_Id" },
    ...
    methods: {
        ...
        init(item, id) {
            ...
            request({
                ...
                this.state = this.item.state == '1' ? '待点检' : '已点检';
                this.listLoading = false
            })
        },

        // addOrUpdateHandle(id, isDetail) {
        //     if (this.item.state == '待响应') {
        //         this.$message({
        //             message: '请先响应任务',
        //             type: 'warning'
        //         });
        //     } else if (this.item.state == '已完成') {
        //         this.$message({
        //             message: '已完成的任务,不可更新',
        //             type: 'warning'
        //         });
        ...
        //             this.$refs.Form.init(id, isDetail)
        //         })
        //     }
        // },
