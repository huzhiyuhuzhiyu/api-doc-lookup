          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <div class="JNPF-common-head">
                <el-page-header @back="$emit('close', true)" :content="'采购收货入库'" />
              ...
              <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" :fixedNO="true"
                ...
                <el-table-column prop="purchaseOrderNo" label="采购单号" width="200" fixed="left" sortable="custom" />
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="linesTableData" v-loading="listLoading" :data="linesTableData" :fixedNO="true"
                ...
                <el-table-column label="操作" width="140" fixed="right">
                  <template slot-scope="scope">
                    <tableOpts @edit="addOrUpdateHandle(scope.row.purchaseReceiptReturnGoodsId)" :editText="'入库'"
                      :hasDel="false">
                      <el-dropdown hide-on-click>
                        <span class="el-dropdown-link">
                          <el-button type="text" size="mini">
...
import DetailForm from '../../../inboundAndOutbound/inboundOrders/detailForm/InboundPurchase.vue'
export default {
  ...
  methods: {
    sortChange({ prop, order }) {
      ...
      if (this.activeName === 'dataTable') {
        ...
        if (prop === 'productName' || prop === 'productDrawingNo' || prop === 'createTime' || prop === 'orderNo' || prop === 'purchaseOrderNo') { newProp = prop }
        else { newProp = prop.replace(/[A-Z]/g, match => '_' + match.toLowerCase()); }
    ...
    addOrUpdateHandle(id, readOnly) {
      if (readOnly) {
        ...
        this.$nextTick(() => { this.$refs.Form.init(id, undefined, "inbound_purchase") })
      }
    },
  }
}
