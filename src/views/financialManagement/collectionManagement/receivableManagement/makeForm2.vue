    ...
    <transition name="el-zoom-in-center">
      <div class="JNPF-preview-main org-form">
        <div class="JNPF-common-page-header">
          <el-page-header @back="goBack" content="开票" />
          <div class="options">
        ...
        <div class="main">
          <el-tabs v-model="activeName">
            <el-tab-pane label="基础信息" name="jcInfo">
              <el-row :gutter="30">
                <el-form ref="dataForm" v-loading="formLoading" :model="dataForm" :rules="dataRule" label-position="top"
                  ...
                  <el-col :span="8">
                    <el-form-item label="待收款金额" prop="duePayAmount">
                  ...
                  <el-col :span="8">
                    <el-form-item label="待开票金额" prop="dueAmount">
                      <el-input v-model="dataForm.dueAmount" placeholder="待开票金额" maxlength="20" disabled />
                    </el-form-item>
                  </el-col>

                  <el-col :span="8">
                    <el-form-item label="开票金额" prop="invoicingAmount">
                      <el-input v-model="dataForm.invoicingAmount" placeholder="请输入开票金额" maxlength="20" />
                    </el-form-item>
                  </el-col>
                  <el-col :span="8">
            ...
            <el-tab-pane label="预收款信息" name="receiverInfo">
              <div style="display: flex;flex-direction: column;height: 100%;">
                <JNPF-table @selection-change="handeleProductInfoData" hasC fixedNO v-loading="formLoading"
                  :data="payData" custom-column ref="payRef" :checkSelectable="checkSelectable" customKey="JNPFTableKey_339418">
                  <el-table-column prop="remainingAmount" label="收款剩余金额" min-width="160" />
                  <el-table-column prop="paymentDate" label="收款日期" min-width="180" />
