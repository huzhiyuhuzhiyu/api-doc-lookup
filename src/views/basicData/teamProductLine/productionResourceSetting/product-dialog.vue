      ...
      <div class="JNPF-common-layout-center JNPF-flex-main">
        <el-row class="JNPF-common-search-box" :gutter="16">
          <el-form @submit.native.prevent>
            ...
            <el-col :span="6">
              <el-form-item>
                <el-input v-model="ProductListRequestObj.drawingNo" placeholder="请输入产品图号" clearable />
              </el-form-item>
            </el-col>
          ...
          <JNPF-table v-loading="listLoading" :data="allproductData">
            ...
            <el-table-column label="操作" width="100">
              <template slot-scope="scope">
                <el-button size="mini" type="text" @click="seleceCustomer(scope.row)">选择</el-button>
              </template>
            </el-table-column>
          </JNPF-table>
          <pagination :total="allProductTotal" :page.sync="ProductListRequestObj.pageNum"
            :limit.sync="ProductListRequestObj.pageSize" @pagination="initData2(type,index)" />
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    searchAllProduct() {
      ...
      this.initData2(this.type,this.index)
    },
    ...
    seleceCustomer(e) {
      ...
      if (this.type === 'dataFormProduct') {


        this.selectArr = e
        console.log(this.selectArr);
        this.$emit('productsSubmit', this.selectArr,this.type,this.index)
      }
      if (this.type === 'dataFormTwoProduct') {


        this.selectArrTwo = e
        this.$emit('productsSubmit', this.selectArrTwo,this.type,this.index)
      }
    },
    // submitAllProduct() {
