            ...
            <el-tab-pane label="点检概况" name="djgk">
              <div class="statistical">
                <div class="analysis-content">
                  <card class="card-item" bodyheight="240px" title="今日已检分布（台）"></card>
                  <card class="card-item" bodyheight="240px" title="今天各设备点检次数"></card>
                  <card class="card-item" bodyheight="240px" title="今日未检分布（台）"></card>
                </div>
