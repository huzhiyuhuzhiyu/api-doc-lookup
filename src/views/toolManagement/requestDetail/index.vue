    ...
    <div v-if="!formVisible" class="JNPF-common-layout-center JNPF-flex-main">
      <el-row class="JNPF-common-search-box" :gutter="16">
        <el-form @submit.native.prevent>
          ...
          <el-col :span="4">
            <el-form-item>
              <el-date-picker v-model="orderForm.dateArr" type="daterange" value-format="yyyy-MM-dd"
                style="width: 100%;" start-placeholder="请选择领用开始日期" end-placeholder="请选择领用结束日期">
              </el-date-picker>
            </el-form-item>
          </el-col>
           <el-col :span="4">
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      this.jnpf.searchTimeFormat(this.orderForm, 'dateArr', 'collStartTime', 'collEndTime')
