        ...
        <div class="JNPF-common-layout-center JNPF-flex-main">
          <el-row class="JNPF-common-search-box" :gutter="16">
            <el-form @submit.native.prevent>
              ...
              <el-col :span="6">
                <el-form-item >
                  <el-date-picker v-model="dateArr" type="datetimerange" format="yyyy-MM-dd HH:mm:ss"
                    :picker-options="global.timePickerOptions" value-format="yyyy-MM-dd HH:mm:ss" style="width: 100%;"
                    start-placeholder="最新入库开始时间" end-placeholder="最新入库结束时间" :default-time="['00:00:00', '23:59:59']" clearable>
                  </el-date-picker>
                </el-form-item>
              </el-col>
          ...
          <div class="JNPF-common-layout-main JNPF-flex-main">
            ...
            <JNPF-table v-loading="listLoading" :data="tableData" hasNO fixedNO @sort-change="sortChange"
              ref="dataTables" customKey="JNPFTableKey_268595">
  ...
  methods: {
    ...
    initData() {
      ...
      if(this.dateArr.length){
        this.listQuery.lsSd=this.dateArr[0]
        this.listQuery.lsEd=this.dateArr[1]
      }else{
        this.listQuery.lsSd=""
        this.listQuery.lsEd=""
      }
