              ...
              <el-row :gutter="30" class="custom-row">
                ...
                <el-col :sm="12" :xs="24">
                  <el-form-item label="备注" prop="remark">
                    <el-input v-model="dataForm.remark" placeholder="请输入备注" :disabled="btnType == 'look' ? true : false" maxlength="200" />
                  </el-form-item>
                </el-col>
              </el-row>
            </el-form>
  ...
  data() {
    return {
      ...
      sleeveItems: [
        ...
        { prop: "productDrawingNo", label: "产品图号", value: "", type: 'view', width: "350", },
        { prop: "num", label: "原数量(主)", value: "", type: 'view', width: "100", },
        ...
        { prop: "price", label: "原单价", value: "", type: 'view', width: "80" },
        { prop: "excludingTaxAmount", label: "原金额", value: "", type: 'view', width: "80" },
        { prop: "deliveryDate", label: "原交货日期", value: "", type: 'view', width: "180" },
        { prop: "ask", label: "要求", value: "", type: 'view', width: "200" },
        { prop: "newNum", label: "新数量(主)", value: "", type: 'input', width: "120", maxlength: 11, itemRules: [{ required: true, trigger: "blur" }, { validator: this.formValidate({ type: 'decimal', params: [10, 2, false, errMsg => { this.$message.error(`新数量(主)：${errMsg}`) }] }), trigger: 'blur' }] },
        { prop: "newAssistantNum", label: "新数量(副)", value: "", type: 'view', width: "100" },
        { prop: "newPrice", label: "新单价", value: "", width: "100", change: this.changePrice, type: 'input', itemRules: [{ required: true, trigger: "blur" }, { validator: this.formValidate({ type: 'decimal', params: [10, 2, false, errMsg => { this.$message.error(`新单价：${errMsg}`) }] }), trigger: 'blur' }] },
        { prop: "newExcludingTaxAmount", label: "新金额", value: "", type: 'view', width: "80" },
