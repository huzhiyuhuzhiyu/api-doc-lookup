        ...
        <JNPF-table v-loading="listLoading" highlight-current-row ref="tableForm" :data="tableDataList"
          ...
          <el-table-column label="操作" width="180" fixed="right">
            <template slot-scope="scope">
              ...
              <el-button type="text" size="mini" @click.native="handleUserRelation(scope.row.id, 'look')">
                查看详情
              </el-button>
              <!-- </tableOpts> -->
...
<script>
import {propertyAccountReconciliationList} from '@/api/bimPropertyCategory/index'
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      propertyAccountReconciliationList(this.superForm)
        .then((res) => {
