          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="dataTable" @selection-change="handeleFinshData" hasC v-loading="listLoading"
                ...
                <el-table-column prop="partnerCode" label="供应商编码" min-width="140" />
                <el-table-column prop="partnerName" label="供应商名称" min-width="140" />
                ...
                <el-table-column prop="deliveryCompletionDate" label="收货完成时间" min-width="200" />
                ...
                <el-table-column prop="inspectionStatus" label="检验状态" align="center" width="120" sortable="custom"
                  fixed="right">
                  <template slot-scope="scope">
        ...
        <el-tab-pane label="明细列表" name="linesTable">
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table @selection-change="handeleFinshData" hasC :checkSelectable="checkSelectable"
                ref="linesTableData" v-loading="listLoading" :data="linesTableData" :fixedNO="true"
    ...
    <el-dialog title="更多查询" :close-on-click-modal="false" :close-on-press-escape="false" :visible.sync="visible"
      ...
      <el-row :gutter="20" v-else>
        ...
        <el-form ref="diaForm" :model="linesQuery" label-width="120px" label-position="top">
          ...
          <el-col :span="12">
            <el-form-item label="供应商编码">
              <el-input v-model="linesQuery.partnerCode" placeholder="请输入供应商编码" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="供应商名称">
              <el-input v-model="linesQuery.partnerName" placeholder="请输入供应商名称" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="业务员">
