    ...
    <el-row :gutter="15" class="">
      <el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px" label-position="right">
        <template v-if="!loading">
            <el-col :span="24">
               <el-form-item label="环境类型" prop="energyType">
...
export default {
    ...
    methods: {
      ...
      clearData() {
        ...
        this.dataForm.energyType = "TEMPERATURE";
        this.dataForm.typeS = "HJ";
