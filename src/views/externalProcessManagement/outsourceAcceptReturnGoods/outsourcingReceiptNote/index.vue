          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table @selection-change="handeleFinshData" hasC :checkSelectable="checkSelectable" ref="dataTable" v-loading="listLoading" :data="tableData" :fixedNO="true"
                ...
                <el-table-column prop="purchaseOrderNo" label="外协单号" min-width="220" sortable="custom">
                </el-table-column>
                ...
                <el-table-column prop="inspectionStatus" label="检验状态" align="center" min-width="120" sortable="custom"
                  fixed="right">
                  <template slot-scope="scope">
                ...
                <el-table-column prop="receivingStatus" label="收货状态" align="center" min-width="120" sortable="custom"
                  fixed="right">
                  <template slot-scope="scope">
