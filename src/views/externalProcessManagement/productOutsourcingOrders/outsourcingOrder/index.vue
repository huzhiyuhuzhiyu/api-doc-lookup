        ...
        <el-tab-pane label="单据列表" name="orderList">
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table  @selection-change="handeleFinshData" hasC :checkSelectable="checkSelectable" v-if="flag" v-loading="listLoading" highlight-current-row :fixedNO="true" ref="tableForm"
                :data="tableDataList" @sort-change="sortChange" custom-column>
                <!-- <el-table-column prop="source" label="来源" min-width="180" sortable="custom">
                  <template slot-scope="scope">
                    <div v-if="scope.row.source == 'procure'">采购</div>
                    <div v-if="scope.row.source == 'mrp'">MRP下发</div>
                    <div v-if="scope.row.source == 'external_process'">外协工序</div>
                  </template>
                </el-table-column> -->
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                ...
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="listsQuery.orderNo" placeholder="请输入外协单号" clearable
                      @keyup.enter.native="searchDetail()" />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="listsQuery.cooperativePartnerCode" placeholder="请输入外协供应商编码" clearable
                      @keyup.enter.native="searchDetail()" />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="listsQuery.productName" placeholder="请输入产品名称" clearable
                      @keyup.enter.native="searchDetail()" />
                  </el-form-item>
                </el-col>
                <el-col :span="6">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table @selection-change="handeleFinshData" hasC :checkSelectable="checkSelectable" v-loading="listLoading" highlight-current-row :fixedNO="true" ref="detailTableData"
                ...
                <el-table-column prop="orderNo" label="外协单号" min-width="200" sortable="custom" fixed="left">
                  <template slot-scope="scope">
                    <el-link type="primary" @click.native="addOrUpdateHandle(scope.row.purchaseOrderId, 'looks')">{{
                      scope.row.orderNo
                    }}</el-link>
                  </template>
                </el-table-column>
                ...
                <el-table-column label="操作" width="90" fixed="right">
                  <template slot-scope="scope">
                    <el-dropdown hide-on-click>
                      ...
                      <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item @click.native="addOrUpdateHandle(scope.row.purchaseOrderId, 'looks')">
                          查看详情
                        </el-dropdown-item>
                      </el-dropdown-menu>
                    </el-dropdown>
        ...
        <el-form ref="diaForm" :model="listQuery" label-width="120px" label-position="top">
          ...
          <el-col :span="12">
            <el-form-item label="外协单号">
              <el-input v-model.trim="listQuery.orderNo" placeholder="请输入外协单号" clearable @keyup.enter.native="search()" />
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item label="外协供应商名称">
              <el-input v-model.trim="listQuery.cooperativePartnerName" placeholder="请输入外协供应商名称" clearable
                @keyup.enter.native="search()" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="外协供应商编码">
              <el-input v-model.trim="listQuery.cooperativePartnerCode" placeholder="请输入外协供应商编码" clearable
                @keyup.enter.native="search()" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
import { purchaseOrderList, detailpurchaseOrderList ,purPurchaseOrderdetail , purPurchaseBatch, purPurchaseBatchLine} from '@/api/purchasingAndOutsourcingOrders/index'
        ...
        row = {
          ...
          purchaseOrderLines: res.data.purchaseOrderLineVOList.map(item => {
            return {
              ...
              outShipmentList:item.outShipmentVOList.map(line=>{
                return {
                  ...line,
                  demandQuantity1:line.demandQuantity,
                  id:''
                }
              }),
              id: '',
