          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" :fixedNO="true"
                @sort-change="sortChange" custom-column customKey="JNPFTableKey_713665">
                ...
                <el-table-column prop="num" label="总箱数" min-width="160" />
                ...
                <el-table-column prop="submitDate" label="提交时间" min-width="200" sortable="custom" />
  ...
  data() {
    return {
      ...
      initListQuery: {
        ...
        createByName: "",
        documentNo: 0,
        documentType: "direct_allocation",
        endTime: "",
        keyword: "",
        orderNo: "",
        packingType: "",
