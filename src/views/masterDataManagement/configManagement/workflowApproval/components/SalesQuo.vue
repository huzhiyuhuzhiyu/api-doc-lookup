          ...
          <el-tab-pane label="订单信息" name="orderInfo">
            ...
            <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="160px" label-position="top">
              <el-row :gutter="30" class="custom-row">
                ...
                <el-col :sm="6" :xs="24" v-if="dataForm.quotationType == 'latest'">
                ...
                <el-col :sm="6" :xs="24" v-if="dataForm.quotationType == 'latest'">
                  ...
                  <el-form-item label="意向客户" prop="yxCooperativePartnerIdText"
                    ...
                    <ComSelect-page key="yxPartner" ref="ComSelect-page" v-model="dataForm.cooperativePartnerIdText"
                      :tableItems="yxPartnerTableItems" dialogTitle="选择意向客户" treeTitle="意向客户分类" placeholder="请选择意向客户"
                  ...
                  <el-form-item label="客户" prop="cooperativePartnerIdText" v-else>
                    <ComSelect-page key="partner" ref="ComSelect-page" v-model="dataForm.cooperativePartnerIdText"
                      :tableItems="partnerTableItems" dialogTitle="选择客户" treeTitle="客户分类" placeholder="请选择客户"
                ...
                <el-col :sm="6" :xs="24" v-if="dataForm.approvalStatus == 'rebut'">
            ...
            <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm" class="data-form">
              <el-table ref="product" :data="dataFormTwo.lines">
                ...
                <el-table-column prop="customerDrawingNumber" label="客户物料号" width="200" fixed='left'
                  v-if="dataForm.quotationType !== 'old_metalworking'">
                ...
                <el-table-column prop="productCode" label="产品编码" min-width="200" fixed="left" show-overflow-tooltip v-if="dataForm.quotationType == 'old_metalworking'" key="productCode">
                ...
                <el-table-column prop="productName" label="产品名称" min-width="200" fixed="left" show-overflow-tooltip v-if="dataForm.quotationType == 'old_metalworking'" key="productName">
                  <template slot-scope="scope">
                ...
                <el-table-column prop="drawingNo" label="产品图号" min-width="200" fixed="left" show-overflow-tooltip v-if="dataForm.quotationType == 'old_metalworking'" key="drawingNo">
                  <template slot-scope="scope">
                  ...
                  <template slot-scope="scope">
                    <el-form-item :prop="'lines.' + scope.$index + '.' + 'num'" :rules='productRules.num'>
                      <el-input :title="scope.row.num" v-model="scope.row.num" placeholder="请输入数量" :disabled="status"
                        maxlength="11" style="width: 135px;" oninput="value=value.replace(/[^0-9.]/g,'')">
                      </el-input>
                    </el-form-item>
                  </template>
                </el-table-column>
...
import { getApprovalTemplate, getApprovalDetailTree, busApprovalFlowTree, getSaleBusDetail, approvalTransferList } from '@/api/basicData/approvalAdministrator'
import errorDialog from '@/components/WorkFlow/dialog/errorDialog.vue'
import okOrNo from './okOrNoForm.vue'
import transferForm from './transferForm.vue'
export default {
  components: { workFlow, errorDialog, okOrNo, transferForm },
  data() {
    return {
      okOrNoVisible: false,
