...
export default {
  ...
  //     productId: '',
  //     routingLineId: '',
  //     sourceOrderNo: this.$parent.dataForm.sourceNo
  //   }
  // },
  data() {
    return {
      ...
      linesListItems: [
        ...
        // },
        // { prop: "num", label: "数量", value: "", type: "view", minWidth: 160, render: this.$parent.sourceType !== 'inbound_scrap' },
        { prop: "num", label: "数量", value: "", type: "input", itemRules: [{ required: true, trigger: "blur" }, { validator: this.formValidate({ type: 'decimal', params: [20, 4, "", (errMsg) => { this.$message.error('数量：' + errMsg) }] }), trigger: 'blur' }], minWidth: 160 }
      ],
      linesList: [],
    }
  },
