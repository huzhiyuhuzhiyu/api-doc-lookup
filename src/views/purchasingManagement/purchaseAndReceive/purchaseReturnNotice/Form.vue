      ...
      <div class="JNPF-preview-main org-form">
        <div :class="['JNPF-common-page-header', type === 'look' ? 'noButtons' : '']">
          <el-page-header @back="goBack"
            :content="type == 'add' ? '新建采购退货通知单' : type == 'edit' ? '编辑采购退货通知单' : type == 'look' ? '查看采购退货通知单' : '新建采购退货通知单'" />
            ...
            <el-tab-pane label="基础信息" name="jcInfo">
                ...
                <el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px"
                  ...
                  <el-col :span="8" v-if="type === 'look'">
                    <el-form-item label="退货状态" prop="receivingStatus" ref="receivingStatus">
                      <el-input type="text" v-model="dataForm.receivingStatus === 'returning' ? '未完成' : dataForm.receivingStatus === 'returned' ? '已完成' : '已停止'"
                  ...
                  <el-col :sm="24" :xs="24">
                    <el-form-item label="备注" prop="remark" ref="remark">
                      <el-input type="textarea" :row="3" v-model="dataForm.remark" :placeholder="type == 'look' ? '' : '请输入备注'" maxlength="200"
                        :disabled="type == 'look' ? true : false">
                      </el-input>
                    </el-form-item>
                  </el-col>
              ...
              <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm">
                <el-table style="border: 1px solid #e3e7ee;" hasNO fixedNO v-bind="dataFormTwo.data"
                  ...
                  <el-table-column prop="drawingNo" label="产品图号" min-width="200" fixed="left" show-overflow-tooltip>
                    <template slot-scope="scope">
                  ...
                  <el-table-column prop="purchaseQuantity" label="采购数量" min-width="200">
