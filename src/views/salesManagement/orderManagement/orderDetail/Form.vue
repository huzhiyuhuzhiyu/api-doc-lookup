    ...
    <div>
      <div class="JNPF-preview-main org-form">
            ...
            <div class="JNPF-common-layout-center JNPF-flex-main">
              <el-row class="JNPF-common-search-box" :gutter="16">
                <el-form @submit.native.prevent>
                  ...
                  <el-col :span="6">
                    <el-form-item>
                      <el-input @keyup.native.enter="searchAllProduct()"  v-model="ProductListRequestObj.drawingNo" placeholder="请输入图号" clearable />
                    </el-form-item>
                  </el-col>
        ...
        <el-dialog title="提示" append-to-body :close-on-click-modal="false" :close-on-press-escape="false"
          :visible.sync="tipsvisible" lock-scroll class="JNPF-dialog JNPF-dialog_center" width="400px">
          <div><span style="font-size: 18px;color: #67c23a;"> 导入成功！</span><span style="font-size:16px;">还可用进行如下操作：</span></div>
