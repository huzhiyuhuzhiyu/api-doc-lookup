    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" highlight-current-row :fixedNO="true" ref="tableForm" :data="tableDataList"
          @sort-change="sortChange" custom-column border @selection-change="handleSelectionChange" hasC customKey="JNPFTableKey_298615">
          ...
          <el-table-column prop="totalCost" label="成本合计(元)(不含税)" min-width="220" sortable="custom" />
          <el-table-column prop="coefficient1" label="系数1" min-width="80" />
          <el-table-column prop="coefficient2" label="系数2" min-width="80" />
          <el-table-column prop="totalProfitCost" label="加利润成本合计(含税)" min-width="210" sortable="custom" />
          <el-table-column prop="excludingTaxTotalProfitCost" label="加利润成本合计(元)(不含税)" min-width="280" sortable="custom" />
          ...
          <el-table-column prop="listPriceUpdateByName" label="最新牌价更新人" min-width="160" />
          ...
          <el-table-column prop="updateByName" label="最新成本更新人" min-width="160" />
        </JNPF-table>
...
export default {
  ...
  methods: {
      ...
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          let obj = {
            ...
            "taxRate": this.setForm.taxRate/100,
          }
    ...
    sortChange({ prop, order }) {
      ...
      if (prop == "materialCost"||prop=='totalLaborCost'||prop=='feeAmount'||prop=='totalCost'||prop=='totalProfitCost'||prop=='excludingTaxTotalProfitCost'||prop=='listPrice'||prop=='updateTime'||prop=='listPriceUpdateTime') { 
        newProp = prop.replace(/[A-Z]/g, match => '_' + match.toLowerCase());
      }else{
        newProp = prop
      }
