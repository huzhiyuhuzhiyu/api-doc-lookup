      ...
      <div class="JNPF-common-layout-center JNPF-flex-main">
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
          ...
          <JNPF-table :partentOrChild="'dataTable'" ref="dataTable" :data="tableData"
            ...
            <el-table-column prop="orderNo" label="归还单号" min-width="180" sortable="custom" />
            <el-table-column prop="useOderNO" label="领用单号" min-width="180" sortable="custom" />
            <el-table-column prop="useIdName" label="领用人" min-width="180" sortable="custom" />
            <el-table-column prop="useTime" label="领用日期" min-width="180" sortable="custom" />
            <el-table-column prop="equipmentIdName" label="配件名称" min-width="180" sortable="custom" />
            <el-table-column prop="equipmentIdCode" label="配件编码" min-width="180" sortable="custom" />
            <el-table-column prop="useIdName" label="归还人" min-width="180" sortable="custom" />
            <el-table-column prop="sumRequisitionNum" label="总归还数量" min-width="180" sortable="custom" />
            <el-table-column prop="requisitionedNum" label="已归还数量" min-width="180" sortable="custom" />
            <el-table-column prop="unRequisitionQuantity" label="待归还数量" min-width="180" sortable="custom" />
            <el-table-column prop="receivedQuantity" label="已入库数量" min-width="180" sortable="custom" />
            <el-table-column prop="collectionTime" label="归还时间" min-width="180" sortable="custom" />
          </JNPF-table>
