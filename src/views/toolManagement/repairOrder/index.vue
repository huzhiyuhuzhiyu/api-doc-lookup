  ...
  data() {
    return { 
      ...
      searchList: [
        ...
        { field: 'equipmentIdName', fieldValue: '', label: '工具名称', symbol: 'like', searchType: 1, width: 120 },
        { field: 'equipmentIdCode', fieldValue: '', label: '工具编码', symbol: 'like', searchType: 1, width: 120 },
      ],
      taskKey:"",
