      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <div class="JNPF-common-head">
          <div>
            ...
            <el-button style="margin-left:10px" size="mini" @click="batchStop" type="info">批量暂停</el-button>
        ...
        <el-table ref="dataTable" v-loading="listLoading" :data="tableData" @sort-change="sortChange" custom-column hasC
          ...
          <el-table-column prop="productName" fixed="left" label="产品名称" width="120" :show-overflow-tooltip="true"></el-table-column>
          <el-table-column prop="productDrawingNo" fixed="left" label="产品图号" width="120" :show-overflow-tooltip="true"></el-table-column>
          ...
          <el-table-column prop="submitDate" label="提交时间" min-width="200"></el-table-column>
          <el-table-column prop="productionStatus" fixed="right" label="生产状态" width="120" sortable="custom">
            <template slot-scope="scope">
          ...
          <el-table-column prop="orderStatus" fixed="right" label="订单状态" width="120" sortable="custom">
            <template slot-scope="scope">
  ...
  methods: {
    ...
    batchWorker(id) {
      ...
      prodOrderInfo(obj).then(res => {
        ...
        console.log("详情>", res);
        if(!res.data.workOrderList.length){
          this.$message({
            message:"该订单没有可派工的数据",
            type:"error"
          })
