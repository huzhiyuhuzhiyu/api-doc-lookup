...
<template>
    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      <el-row class="JNPF-common-search-box" :gutter="16">
        <el-form @submit.native.prevent>
          ...
          <el-col :span="4">
            <el-form-item>
              <el-input v-model="orderForm.routingCode" placeholder="请输入工艺路线编码"  @keyup.enter.native="dataFormSubmit()" clearable />
            </el-form-item>
          </el-col>
  ...
  @select="handleSelection" @row-click="clickRow">
        ...
        scope.row.orderNo
          ...
          <el-table-column prop="industrialWasteQuantity" label="已报工废数量" width="120"></el-table-column>
          ...
          <el-table-column prop="suspendByName" label="暂停人" width="100"></el-table-column>
          <el-table-column prop="suspendDate" label="暂停时间" min-width="180"></el-table-column>
          ...
          <el-table-column label="操作" width="140" fixed="right">
            <template slot-scope="scope">
              ...
              <el-button size="mini" type="text"
                  :disabled="!(scope.row.orderStatus == 'normal' && scope.row.productionStatus != 'production_completed'&& scope.row.dispatchStatus=='not_finished' )"
                  @click.stop="batchWorker(scope.row.id)">派工</el-button>
              <el-button size="mini" type="text"
...
export default {
  name: 'carrierProfile',
  components: { Form, TableFormProduct, Forms,  },
  data() {
    return {
      hasfixed:true,
      sourceList: [],
