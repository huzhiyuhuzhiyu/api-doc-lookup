          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                ...
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="listQuery.ordersNo" placeholder="请输入销售订单号" @keyup.enter.native="search()"
                      clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" :fixedNO="true"
                ...
                <el-table-column prop="ordersNo" label="销售订单号" min-width="200" />
  ...
  methods: {
    ...
    addOrUpdateHandle(id, readOnly) {
      if (readOnly) {
        ...
        this.$nextTick(() => { this.$refs.Form.init(id, readOnly, 'sale_back', 'notice') })
      }
    },
    sortChange({ prop, order }) {
      let newProp
      if (prop === 'shipperName' || prop === 'partnerCode' || prop === 'partnerName' || prop === 'productCode' || prop === 'productName' || prop === 'productDrawingNo' || prop === 'createByName') { newProp = prop }
