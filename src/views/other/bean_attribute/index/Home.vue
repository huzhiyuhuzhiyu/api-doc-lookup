...
<template>
    <el-drawer  :title="!dataForm.id ? '新建' : '编辑'" :visible.sync="visible" :wrapperClosable="false" size="762px"
  ...
  <div class="container">
    <div class="left-board" >
      ...
      <div style="background: white;">
          <div>
              <div class="center-board1" style="height: 150px!important;overflow: hidden!important; ">
                    ...
                    <el-form :size="formConf.size" :label-position="formConf.labelPosition"
                      ...
                      <draggable class="drawing-board" :list="drawingList" :animation="340"
                        ...
                        <draggable-item v-for="(element, index) in drawingList" :key="element.renderKey"
                          ...
                          :form-conf="formConf" @activeItem="activeFormItem" :put="shouldClone" :end='onTableEnd' />
                      </draggable>
...
export default {
  ...
  methods: {
      ...
      dataFormSubmit(){
          ...
          this.dataForm.content = JSON.stringify(this.formData)
      ...
      // request() {
          ...
          let _data = JSON.parse(JSON.stringify(this.dataForm))
          // console.log(_data);
          // return
          if (!this.dataForm.id) {
              request({
    ...
    AssembleFormData() {
      ...
      this.formData = this.formData.fields[0]
    },
    empty() {
