        ...
        <div class="main" v-loading="listLoading">
          ...
          <div class="processBox">
            ...
            <div style="height: 40px; line-height: 40px; background: #f5f7fa;padding-left:10px" class="text">
              <span style="font-weight:600;margin-right:10px">总材料成本：{{ totalMaterialCost!=0?totalMaterialCost.toFixed(3):0 }}(元)</span>
            </div>
          </div>
          ...
          <div class="processBox" style="margin-top:20px">
            ...
            <div style="height: 40px; line-height: 40px; background: #f5f7fa;padding-left:10px" class="text">
              <span style="font-weight:600;margin-right:20px">总人工费用：{{ totalWorkingHours!=0?totalWorkingHours.toFixed(3):0 }}(元)</span>
            </div>
          </div>
          <div class="processBox" style="margin-top:20px">
            <div
            ...
            <div style="height: 40px; line-height: 40px; background: #f5f7fa;padding-left:10px" class="text">
              <span style="font-weight:600;margin-right:10px">总制造费用：{{ totalManufacturingCosts!=0?totalManufacturingCosts.toFixed(3):0
              }}(元)</span>
            </div>
          ...
          <div style="margin-top:20px" class="text">
            <span style="margin-left:10px;font-weight:600;">总材料成本：</span><span
              style="margin-right:20px;">{{ totalMaterialCost!=0?totalMaterialCost.toFixed(3):0 }}(元)</span>
            <span style="margin-left:10px;font-weight:600;">总人工费用：</span><span
              style="margin-right:20px;">{{ totalWorkingHours!=0?totalWorkingHours.toFixed(3):0 }}(元)</span>
            <span style="margin-left:10px;font-weight:600;">总制造费用：</span><span
              style="margin-right:20px;">{{ totalManufacturingCosts!=0?totalManufacturingCosts.toFixed(3):0 }}(元)</span>
            <span style="font-weight:600"> 合计成本:</span><span>{{
              totalMaterialCost&&totalWorkingHours&&totalManufacturingCosts?(Number(totalMaterialCost) + Number(totalWorkingHours) + Number(totalManufacturingCosts)).toFixed(3):0 }}(元)</span>
          </div>
        </div>
      </div>
    </transition>
