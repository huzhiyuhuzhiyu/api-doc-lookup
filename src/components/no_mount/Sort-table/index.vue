<template>
  <div class="tableContainer" v-if="!refreshTable">
    <el-table row-key="id" :data="data" ref="JNPFTable" class="JNPF-common-table" :height="height"
      :element-loading-text="$t('common.loadingText')" v-bind="$attrs" v-on="$listeners" :border="border"
      :header-cell-style="headerCellStyle">
      <el-table-column prop="selection" type="selection" width="60" :fixed="fixedSelect" v-if="hasC" align="center"
