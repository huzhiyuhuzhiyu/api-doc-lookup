          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="4">
                  <el-form-item>
                    <el-input @keyup.native.enter="search()"  v-model.trim="form.transferNo" placeholder="请输入拆卸单号" clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
                    <el-input @keyup.native.enter="search()"  v-model.trim="form.transferByName" placeholder="请输入拆卸人" clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="6">
                  <el-form-item>
