    ...
    <div class="JNPF-common-layout-center">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" :data="list" @sort-change='sortChange' :span-method="arraySpanMethod">
          <el-table-column prop="name_name" label="工序名称" align="left" />
          <el-table-column prop="type_name" label="类别" align="left" />
          <el-table-column prop="unitPrice_name" label="计件单价" align="left" />
          <el-table-column prop="timePrice_name" label="计时单价" align="left" />
          <el-table-column prop="coefficientPrice_name" label="单价系数" align="left" />
  ...
  export default {
    ...
    data() {
      return {
        ...
        tableField118_equipmentIdcolumnOptions: [{
          "label": "设备名称",
          "value": "name"
        }, {
          "label": "设备编码",
    ...
    methods: {
      ...
      initData() {
        ...
        request({
          url: `/api/mrp_process/Mrp_process/getList`,
          method: 'post',
          data: _query
        }).then(res => {
          var _list = [];
      ...
      handleDel(id) {
        this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
          ...
          request({
            url: `/api/mrp_process/Mrp_process/${id}`,
            method: 'DELETE'
          }).then(res => {
            this.$message({
              type: 'success',
      ...
      download(data) {
        ...
        request({
          url: `/api/mrp_process/Mrp_process/Actions/Export`,
          method: 'post',
          data: query
        }).then(res => {
