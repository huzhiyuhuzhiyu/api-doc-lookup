            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                <div class="JNPF-common-head">
                    <div>
                        ...
                        <el-button type="primary" v-show="query.state == '1'?true:false" icon="el-icon-s-tools" @click="handleBatchRemoveDel()">响应
                        </el-button>
                    </div>
                ...
                <JNPF-table v-loading="listLoading" :data="list" @sort-change='sortChange'
                    ...
                    <el-table-column prop="name_name" label="维修单号" align="left" />
                    <el-table-column prop="equimentId_name" label="设备名称" align="left" />
                    <el-table-column prop="partnerId_name" label="申请人" align="left" />
                    <el-table-column prop="requestTime_name" label="申请时间" align="left" />
                    ...
                    <el-table-column label="操作" fixed="right" width="150">
                        <template slot-scope="scope">
                            <el-button type="text" v-show="scope.row.state == '2'?true:false"
                                @click="addOrUpdateHandles(scope.row)">维修
                            </el-button>
...
export default {
    ...
    methods: {
        ...
        handleBatchRemoveDel() {
            ...
            request({
                url: `/api/equipmentRepair/Equipment_repair/batchRemove/${ids}`,
                method: 'get',
                data
            }).then(res => {
                this.$message({
        ...
        accomplish(id) {
            request({
                url: '/api/equipmentRepair/Equipment_repair/end/' + id,
                method: 'get'
            }).then(res => {
                this.$message({
                    type: 'success',
