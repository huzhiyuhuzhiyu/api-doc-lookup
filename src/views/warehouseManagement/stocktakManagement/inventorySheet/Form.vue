                  ...
                  <el-collapse v-model="activeNames">
                    <el-collapse-item title="基本信息" name="basicInfo" class="orderInfo">
                      <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="160px"
                        ...
                        <el-row :gutter="30" class="custom-row">
                          ...
                          <el-col :sm="6" :xs="24">
                            <el-form-item label="盘点人员" prop="salesName">
                              <el-input v-model="dataForm.salesName" placeholder="请输入单号" disabled maxlength="300" />
                            </el-form-item>
                          </el-col>
                    ...
                    <el-collapse-item title="产品信息" name="productInfo" class="productInfo">
                      ...
                      <JNPF-table ref="product" :data="productData" :fixedNO="true" :hasC="btnType != 'look'"
                        ...
                        <el-table-column prop="productDrawingNo" label="当前库存" min-width="320" :key="6"
                          show-overflow-tooltip> </el-table-column>

                        <el-table-column prop="shelfSpaceName" label="盘点数量" width="120" :key="10112"
                          v-if="allocationFlag">
                          ...
                          <template slot-scope="scope">
                            <el-input v-model="scope.row.shelfSpaceName" readonly :disabled="btnType == 'look'"
                              @focus="openSeleceWareDialog(scope.row, scope.$index, 'table')" placeholder="盘点数量">
                            </el-input>

                          </template>
                        </el-table-column>
                        <el-table-column prop="mainUnit" label="差额数量" width="80" :key="8" />
                        <el-table-column prop="shelfSpaceName" label="当前仓库" width="120" :key="10112"
                          v-if="allocationFlag">
                          <template slot="header">
                          ...
                          <template slot-scope="scope">
                            <el-input v-model="scope.row.shelfSpaceName" readonly :disabled="btnType == 'look'"
                              @focus="openSeleceWareDialog(scope.row, scope.$index, 'table')" placeholder="当前仓库">
                            </el-input>
                        ...
                        <el-table-column prop="num" label="批次号" width="140" :key="77">
                          <template slot="header">
                            <span class="required">*</span>批次号
                          </template>
                          <template slot-scope="scope">
                            <el-input :disabled="btnType == 'look'" @input="watchNum(scope.row, scope.$index)"
                              v-model="scope.row.num" placeholder="批次号"></el-input>
                          </template>
                        </el-table-column>
              ...
              <el-collapse v-model="activeNames" style="margin-top: 5px;">
                ...
                <el-collapse-item title="产品信息" name="productInfo" class="productInfo">
                  ...
                  <JNPF-table ref="product" :data="productData" :fixedNO="true" :hasC="btnType != 'look'"
                    ...
                    <el-table-column prop="shelfSpaceName" label="盘点数量" width="120" :key="10112" v-if="allocationFlag">
                      <template slot="header">
                        <span class="required">*</span>盘点数量
                      </template>
                      <template slot-scope="scope">
                    ...
                    <el-table-column prop="mainUnit" label="差额数量" width="80" :key="8" />
                    <el-table-column prop="shelfSpaceName" label="当前仓库" width="120" :key="10112" v-if="allocationFlag">
                      <template slot="header">
                        <span class="required">*</span>盘点数量
                      </template>
                      <template slot-scope="scope">
