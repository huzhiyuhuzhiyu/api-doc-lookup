  ...
  <div class="JNPF-common-layout">
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <JNPF-table v-loading="listLoading" highlight-current-row :fixedNO="true" ref="dataTable" :data="tableDataList" @sort-change="sortChange" custom-column customKey="JNPFTableKey_513205">
          <el-table-column prop="createDate" label="日期" min-width="130" />
          <el-table-column prop="producerName" label="操作员" min-width="110" />
          <el-table-column prop="workOrderNo" label="工作令号" min-width="170" />
