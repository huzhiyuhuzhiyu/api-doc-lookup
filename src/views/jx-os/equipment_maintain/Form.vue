        ...
        <el-row :gutter="17" class="">
            <el-form ref="elForm" :model="dataForm" :rules="rules" size="small" label-width="100px"
                ...
                <template v-if="!loading">
                    ...
                    <el-col :span="24">
                        <el-form-item label="保养类型" prop="equimentMaintainTypeId">
                    ...
                    <el-col :span="24" v-if="show">
                        <div class="">
                            <JNPF-table v-loading="listLoadingitem" :data="listitem" @sort-change='sortChangeitem'
                                ...
                                <el-table-column prop="method_name" label="方法" align="left" width="150" />
...
export default {
    ...
    data() {
        return {
            ...
            stateOptions: [{ "fullName": "待保养", "id": "1" }, { "fullName": "已保养", "id": "2" }],
