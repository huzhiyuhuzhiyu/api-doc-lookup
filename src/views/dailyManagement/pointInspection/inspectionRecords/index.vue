        ...
        <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
                <el-form @submit.native.prevent>
                    ...
                    <el-col :span="4">
                        <el-form-item>
                            <el-input v-model="orderForm.actualMaintenanceIdText" placeholder="请输入实际点检人" clearable
                                @keyup.enter.native="search()" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                ...
                <JNPF-table ref="dataTable" v-loading="listLoading" :data="tableData" @sort-change="sortChange" fixedNO
                    ...
                    <el-table-column prop="planMaintenanceDate" label="计划点检日期" width="180"
                    ...
                    <el-table-column prop="actualMaintenanceDate" label="实际点检日期" width="180"
                        sortable="custom"></el-table-column>
