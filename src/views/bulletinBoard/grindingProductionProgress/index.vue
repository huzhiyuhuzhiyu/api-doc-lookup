...
<template>
  <div class="JNPF-common-layout" :loading="loading" style="position: relative;">
      ...
      <iframe style="width: 100%;height: 100%" src="http://screen.dasunyun.com/v/1930075209248903170" frameborder="0" ref="iframeRef"></iframe>
  </div>
</template>
...
export default {
  name: 'grindingProductionProgress',
  data() {
    return {
        fullScreenFn: null,
        loading:false,
