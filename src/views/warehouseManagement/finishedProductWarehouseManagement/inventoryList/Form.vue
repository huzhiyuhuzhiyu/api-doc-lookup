          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <JNPF-table v-loading="listLoading" :data="productList" hasC
                @selection-change="handleSelectionChangeAllPruduct" customKey="JNPFTableKey_676086">
...
export default {
  components: { TableFormProduct, CustomerForm, WareHouseForm, BatchNumberForm ,Process , recordList},
