  ...
  <transition name="el-zoom-in-center">
    <div class="JNPF-preview-main">
      <div class="JNPF-common-page-header" v-if="showHeader">
        <el-page-header @back="goBack" :content="'供应商产品'"/>
        <div class="options">
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
              <div class="JNPF-common-head">
                <topOpts @add="addOrUpdateHandle('', 'add')" :isJudgePer="true" :addPerCode="''">
...
export default {
  ...
  computed: {
    showHeader(){
      return !(this.formVisible || this.depFormVisible)
    },
  },
  async created() {
