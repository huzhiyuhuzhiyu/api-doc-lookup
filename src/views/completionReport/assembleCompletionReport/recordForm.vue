    ...
    <div class="JNPF-common-layout" style="height:600px;overflow: auto;">
      <div class="JNPF-common-layout-center JNPF-flex-main">
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main">
          ...
          <JNPF-table v-loading="listLoading" ref="dataTable"  custom-column :data="tableDataList" :fixedNO="true" customKey="JNPFTableKey_580176"  @sort-change="sortChange">
            ...
            <el-table-column prop="markingMethod" label="打标记" min-width="120" sortable="custom" v-if="isXBN"/>
