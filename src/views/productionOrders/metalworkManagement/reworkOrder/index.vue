      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <div class="JNPF-common-head">
          <div>
            ...
            <el-button size="mini" @click="batchStop" type="info" style="margin-left:10px">批量暂停</el-button>
          ...
          <el-table-column label="操作" width="180" fixed="right">
            <template slot-scope="scope">
              <el-button size="mini" type="text"
                  :disabled="!(scope.row.orderStatus == 'normal' && scope.row.productionStatus != 'production_completed'&& scope.row.dispatchStatus=='not_finished'&& scope.row.documentStatus=='submit' )"
              ...
              <el-dropdown hide-on-click>
                ...
                <el-dropdown-menu slot="dropdown">
                  ...
                  <el-dropdown-item class="JNPF-table-delBtn" @click.native="andleDel(scope.row.id)" :disabled="scope.row.documentStatus == 'draft' ? false : true"> 删除</el-dropdown-item>
