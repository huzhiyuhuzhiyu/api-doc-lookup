                  ...
                  <el-collapse v-model="activeNames">
                    ...
                    <el-collapse-item title="产品信息" name="productInfo">
                      ...
                      <JNPF-table ref="product" :data="productData" :fixedNO="true" hasC
                        @selection-change="handeleProductInfoData" border :key="165" style="width: 100%;" customKey="JNPFTableKey_885992">
                        ...
                        <el-table-column prop="num" label="领料数量" width="140" :key="8088">
                          ...
                          <template slot-scope="scope">
                            <el-input v-model="scope.row.num" placeholder="领料数量" :disabled="btnType == 'look'"
                              ...
                              @blur="computedTotal(scope.row, scope.$index)">
                            </el-input>
                          </template>
                        </el-table-column>
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              <JNPF-table v-loading="listLoading" :data="allproductData" hasC @sort-change="sortChange" :fixedNO="true"
                @selection-change="handleSelectionChangeAllPruduct" ref="dataTable" @row-click="handleRowClick" customKey="JNPFTableKey_890088">
                ...
                <el-table-column prop="sealingCoverTyping" :label="$store.getters.sealingCoverTyping"  min-width="140"
                  v-if="sealingCoverTypingFlag == 1" sortable="custom"></el-table-column>
...
import { getCooperativeData, deleteCooperative, excelExport, getOrderFiledMap } from '@/api/basicData/index'
...
export default {
  ...
  methods: {
    ...
    sortChange({ prop, order }) {
      let newProp;
      if (prop === 'productName' || prop === 'productCode' || prop === 'documentStatus' || prop == 'productDrawingNo' || prop == 'shelfSpaceName' || prop == 'warehouseName' || prop == 'productCategoryName') {
        newProp = prop
      } else {
