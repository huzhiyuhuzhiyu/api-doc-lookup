  ...
  <transition name="el-zoom-in-center">
    <div class="JNPF-preview-main org-form">
      <div class="JNPF-common-page-header">
        ...
        <el-page-header @back="goBack" content="新增返工订单" />
          ...
          <el-tab-pane label="订单信息" name="orderInfo">
              ...
              <el-row :gutter="30" class="custom-row">
                <el-col :sm="8" :xs="24">
                  <el-form-item label="返工产品" prop="productsId">
                    <el-input readonly placeholder="请选择返工产品" disabled v-model="reworkForm.productName"></el-input>
                  </el-form-item>
                </el-col>

                <el-col :sm="8" :xs="24">
                  <el-form-item label="工作令号" prop="workOrderNo">
                    <el-input placeholder="请输入工作令号" v-model="reworkForm.workOrderNo"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
                ...
                <!-- <el-col :sm="8" :xs="24">
                  <el-form-item label="计划开始日期" prop="planStartDate">
                    <el-date-picker v-model="reworkForm.planStartDate" type="date" value-format="yyyy-MM-dd"
                      @change="handleStDate"   style="width: 100%"
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="计划结束日期" prop="planEndDate">
                    <el-date-picker v-model="reworkForm.planEndDate" type="date" value-format="yyyy-MM-dd"
                      @change="handleEnDate"   style="width: 100%"
                      placeholder="计划结束日期">
                    </el-date-picker>
                  </el-form-item>
                </el-col> -->
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="备注" prop="remark">
                    <el-input v-model="reworkForm.remark" placeholder="请输入备注" maxlength="200" />
                  </el-form-item>
                </el-col>
              </el-row>
            </el-form>
            ...
            <div>
              <el-button type="text" style="margin-right:8px;margin-left:8px font-size:14px!important" icon="el-icon-plus"
                @click="openSeleceProductDialog()">选择工序</el-button>|
              ...
              <el-button type="text" style="margin-right:8px;margin-left:8px font-size:14px!important"
                icon="el-icon-delete" @click="batchDeleteProcess">批量删除</el-button>|
            </div>
            <el-table ref="products" :data="workOrderData" @selection-change="handleSelectionChange">
              ...
              <el-table-column prop="processCode" label="工序编码" :key="14"></el-table-column>
              <el-table-column prop="processName" label="工序名称" :key="15" />
              <el-table-column prop="processingType" label="加工类型" :key="19">
              ...
              <el-table-column prop="chargeableReworkFlag" label="是否计费返工" :key="18">
                <template slot-scope="scope">
                  <el-checkbox v-model="scope.row.chargeableReworkFlag" :checked="scope.row.chargeableReworkFlag"
                    @change="hangleChargeble(scope.row)"></el-checkbox>
                </template>
              </el-table-column>
              <el-table-column prop="firstInspection" label="是否首检" :key="29">
                <template slot-scope="scope">
                  <el-checkbox v-model="scope.row.firstInspection"></el-checkbox>
                </template>
              </el-table-column>
              <el-table-column prop="stockFlag" label="是否入库" :key="10">
                <template slot-scope="scope">
                  <el-checkbox v-model="scope.row.stockFlag" :disabled="scope.$index == workOrderData.length - 1 ||
              ...
              <el-table-column prop="reportFlag" label="是否报工" :key="111">
                <template slot-scope="scope">
                  <el-checkbox v-model="scope.row.reportFlag" :disabled="scope.row.processingType !== 'self_produced' ||
...
export default {
  ...
  methods: {
    ...
    init(data) {
      ...
      this.reworkForm.productionQuantity = data.repairQuantity

      this.reworkForm.productName = data.productName
      this.reworkForm.code = data.productCode
      this.reworkForm.productsId = data.productsId
      this.ProductListRequestObj.name = data.productName
      this.ProductListRequestObj.code = data.productCode
      this.reworkForm.routingId = data.routingId
      this.reworkForm.routingName = data.routingName
      if (data.bomId) {
        data.bomFlag = "是"
      } else {
        data.bomFlag = "否"
      ...
      this.reworkForm.bomId = data.bomId
      this.reworkForm.bomFlag = data.bomFlag
      this.reworkForm.unqualifiedLineId = data.id
      let obj = {
        productName: data.productName,
        productCode: data.productCode,
        productDrawingNo: data.productDrawingNo,
        routingName: "",
        routingId: "",
        materialProcessId: "",
        materialProcessName: "",
        productsId: data.productsId,
        materialsUsedQuantity: data.repairQuantity,
        mainUnit: data.mainUnit,
        deputyUnit: data.deputyUnit,
        ratio: data.ratio,
        calculationDirection: data.calculationDirection,
      }
