                      ...
                      <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm">
                        <el-table style="border: 1px solid #e3e7ee;" :fixedNO="true" ref="multipleTable"
                          ...
                          <el-table-column prop="purchaseQuantity" label="数量"
                            :width="isDeputyUnitSwitch === '1' ? 110 : 100">
                            <template slot="header">
                              <span class="required">*</span>
...
export default {
  ...
  methods: {
    ...
    openSeleceProductDialog() {
      if (this.dataFormTwo.data.length >1) return this.$message.error(`只能选择一个产品`)
    ...
    changePurchaseQuantity(index, val) {
      ...
      if (this.dataFormTwo.data[index].purchaseQuantity) {
        let item = this.dataFormTwo.data[index]
        this.dataFormTwo.data[index].outShipmentList = [{
