        ...
        <el-tab-pane label="保养任务" name="orderList">
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
              ...
              <JNPF-table v-if="istable" highlight-current-row :fixedNO="true" ref="tableForm" :data="tableDataList" @sort-change="sortChange" custom-column customKey="JNPFTableKey_278947">
        ...
        <el-tab-pane label="超期保养任务" name="detailList">
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main" v-loading="listLoading">
              ...
              <JNPF-table v-if="istable" highlight-current-row :fixedNO="true" ref="detailTableData" :data="detailTableData" @sort-change="sortChangeDetail" custom-column customKey="JNPFTableKey_506811">
                <el-table-column prop="name" label="任务名称" min-width="200" sortable="custom">
                </el-table-column>
