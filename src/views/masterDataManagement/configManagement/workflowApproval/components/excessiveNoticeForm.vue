          ...
          <el-tab-pane label="通知单信息" name="orderInfo">
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="超领料日期" prop="operationDate">
                    <el-date-picker v-model="dataForm.operationDate" type="date" value-format="yyyy-MM-dd"
                      style="width: 100%;" placeholder="请选择超领料日期" :disabled="btnType == 'look' ? true : false">
                    </el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
            ...
            <el-form :model="dataFormlist" v-bind="dataFormlist" ref="productForm" class="data-form">
              <el-table ref="productlist" :data="dataFormlist.productlist" hasC hasNO fixedNO @selection-change="handeleProductInfoData" v-loading="tableloading">
                ...
                <el-table-column prop="mainUnit" label="单位" width="120" show-overflow-tooltip></el-table-column>totalUsedQuantity
                ...
                <el-table-column prop="num" label="超领料数量" width="170" key="112" v-if="dataForm.receiveType=='process'">
...
<script>
import { ordershengchanList, detailordershengchan, addWithdrawal, updateWithdrawal, detailWithdrawal,getMaterialList,getWorkList } from '@/api/productOrdes/index'
