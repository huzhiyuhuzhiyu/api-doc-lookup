      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <div class="JNPF-common-head" style="padding: 8px">
          <div>
           ...
           <el-button size="mini" type="primary" icon="el-icon-printer" @click="batchSetEquFun">设置所属设备</el-button>
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      searchList: [
        { field: 'productName', fieldValue: '', label: '配件名称', symbol: 'like', searchType: 1, width: 120 },
        { field: 'productCode', fieldValue: '', label: '配件编码', symbol: 'like', searchType: 1, width: 120 },
      ],
  ...
  methods: {
    ...
    batchFun(){
      if(!this.selectArr.length)return this.$message.error("请先选择您要归还的配件数据")
