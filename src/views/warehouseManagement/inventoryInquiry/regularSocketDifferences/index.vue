    ...
    methods: {
        setTableItems(){
            this.tableItems = [
                ...
                {prop:"outerMgNum", label:'磨工车间',minWidth:140,sortable:'custom2'},
                {prop:"outerZpNum", label:'装配车间',minWidth:140,sortable:'custom2'},
                {prop:"outerDzNum", label:'半成品库',minWidth:130,sortable:'custom2'},
                {prop:"outerRclNum", label:'热处理库',minWidth:150,sortable:'custom2'},
                ...
                {prop:"innerMgNum", label:'磨工车间',minWidth:140,sortable:'custom2'},
                {prop:"innerZpNum", label:'装配车间',minWidth:140,sortable:'custom2'},
                {prop:"innerDzNum", label:'半成品库',minWidth:130,sortable:'custom2'},
                {prop:"innerRclNum", label:'热处理库',minWidth:150,sortable:'custom2'},
