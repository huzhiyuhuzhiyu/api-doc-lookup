<template>
  <div class="JNPF-common-layout">
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                ...
                <el-col :span="4">
                  <el-form-item>
                    <el-input
                      v-model="orderForm.productDrawingNo"
                      placeholder="请输入产品图号"
                      clearable
                    />
                  </el-form-item>
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table
                ...
                custom-column
                hasC
                @selection-change="handleProduce"
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table
                ...
                @selection-change="handlePurchase"
              ...
              >
                ...
                >
                  <template slot-scope="scope">
                    <div
                      :style="
                        scope.row.immediatelyBuyFlag == 1 ? 'color:red;' : ''
                      "
                    >
                ...
                >
                  <template slot-scope="scope">
                    ...
                    <el-link
                      type="primary"
                      @click.native="viewData(scope.row.id, 'look')"
                      v-if="scope.row.replaceStatus == 'applying'"
                      >替代中</el-link
                    >
                ...
                <el-button size="mini" type="text" :disabled="(scope.row.mainProductFlag? true: scope.row.replaceStatus == 'normal'? false: true) || Number(scope.row.issuedQuantity) > 0"
    ...
    >
      <el-row :gutter="20">
        ...
        >
          ...
          <el-col :span="12" v-if="orderForm.demandType == 'purchase'">
            <el-form-item label="是否立即采购">
              <el-select
                v-model="orderForm.immediatelyBuyFlag"
                placeholder="请选择是否立即采购"
              >
                <el-option
                  v-for="(item, index) in immediatelyBuyFlagList"
                  :key="index"
                  :label="item.label"
                  :value="item.value"
                ></el-option>
          ...
          <el-col :span="12" v-if="orderForm.demandType == 'purchase'">
            <el-form-item label="替代状态">
              <el-select
                v-model="orderForm.replaceStatus"
                placeholder="请选择替代状态"
                filterable
                clearable
              >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="dataFormSubmit()"> 搜索</el-button>
      </span>
    </el-dialog>
    <el-dialog
      :title="'物料下达'"
      ...
      lock-scroll
      class="JNPF-dialog JNPF-dialog_center wlxd"
      width="1200px"
    >
      ...
      <JNPF-table
        ...
        height="600"
        hasC
        @selection-change="selectInsertOrderFun"
      > 
        <el-table-column
          prop="productCode"
          label="产品编码"
        ...
        <el-table-column
          ...
          label="采购数量"
          width="100"
          v-if="orderForm.demandType == 'purchase'"
        />
        <el-table-column
          prop="outputQuantity"
          label="外协数量"
          width="100"
          v-if="orderForm.demandType == 'out'"
        />
        <el-table-column
          prop="deliveryDates"
          label="订单交货日期"
        ...
        >
          ...
          <template slot-scope="scope">
            <el-date-picker
              ...
              value-format="yyyy-MM-dd"
              style="width: 100%"
              :disabled="orderForm.demandType == 'produce'"
              placeholder="请选择交货日期"
        ...
        >
          ...
          <template slot-scope="scope">
            <el-input
              v-model="scope.row.planDemandQuantity"
              disabled
              placeholder="请输入下达数量"
    ...
    />
    <RetrospectForm v-if="retrospectFormVisible" ref="retrospectForm" @refreshDataList="initData" @close="closeForm" :customList="customList"
    />
  </div>
</template>
