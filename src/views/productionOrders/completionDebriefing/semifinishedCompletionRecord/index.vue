      ...
      <div class="JNPF-common-layout-center JNPF-flex-main">
        <el-row class="JNPF-common-search-box" :gutter="16">
          <el-form @submit.native.prevent>
            <el-col :span="4">
              <el-form-item>
                <el-input v-model="workRecoordForm.productionOrderNo" @keyup.enter.native="search()"
        ...
        <div class="JNPF-common-layout-main JNPF-flex-main">
          <JNPF-table ref="dataTable" v-loading="listLoading" :data="workRecoordList" :fixedNO="true"
            ...
            <el-table-column prop="productionOrderNo" label="生产订单号" width="180" fixed="left" sortable="custom"></el-table-column>
            ...
            <el-table-column prop="workingTime" label="上工时长(秒)" width="140" sortable="custom"></el-table-column>
