  ...
  <div class="JNPF-common-layout">
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        <JNPF-table v-loading="listLoading" highlight-current-row :fixedNO="true" ref="dataTable" :data="tableDataList" @sort-change="sortChange" custom-column customKey="JNPFTableKey_498375">
          ...
          <el-table-column prop="producerMaterialWasteQuantity" label="料废数量" min-width="110" />
...
export default {
  ...
  methods: {
    ...
    sortChange({ prop, order }) {
      let newProp;
      if (prop === 'productDrawingNo' || prop === 'workOrderNo' || prop === 'processName' || prop ==='producerReportNum') {
        newProp = prop
      } else {
