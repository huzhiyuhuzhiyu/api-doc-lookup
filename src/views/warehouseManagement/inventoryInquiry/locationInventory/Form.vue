        ...
        <div class="JNPF-common-layout-center JNPF-flex-main">
              ...
              <el-col :span="6">
                <el-form-item>
                  <el-select v-model="listQuery.standardValue" placeholder="规值" clearable>
                    <el-option v-for="(item, index) in standardValueList" :key="index" :label="item.label"
                      :value="item.value"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
          ...
          <div class="JNPF-common-layout-main JNPF-flex-main">
            ...
            <JNPF-table v-loading="listLoading" :data="tableData" hasNO fixedNO @sort-change="sortChange"
              ref="dataTables" customKey="JNPFTableKey_879765">
...
export default {
  ...
  methods: {
    ...
    reset() {
      this.$refs['dataTables'].$refs.JNPFTable.clearSort() // 清除排序箭头高亮
      this.listQuery = JSON.parse(JSON.stringify(this.originalListQuery))
      this.initData()
    },
    initData() {
