    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table ref="dataTable" v-loading="listLoading" row-key="id" highlight-current-row :data="tableData"
          custom-column :setColumnDisplayList="columnList" @sort-change="sortChange" customKey="JNPFTableKey_496179">
...
<script>
import {finServiceTicketCategoryDel,finServiceTicketCategoryList}from '@/api/service/index'
...
export default {
  ...
  methods: {
    ...
    initData() {
      ...
      finServiceTicketCategoryList(this.superForm)
        .then((res) => {
    ...
    handleDel(id) {
      this.$confirm(this.$t('common.delTip'), this.$t('common.tipTitle'), {
        ...
        .then(() => {
          finServiceTicketCategoryDel(id).then((res) => {
            this.initData()
            this.$message({
              type: 'success',
              message: '删除成功',
