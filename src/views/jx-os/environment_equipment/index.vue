    ...
    <div class="JNPF-common-layout">
        ...
        <div class="JNPF-common-layout-center">
                    ...
                    <el-col :span="6">
                        <el-form-item label="环境类型">
                            <el-select v-model="query.energyType" placeholder="请选择" clearable>
                                <el-option v-for="(item, index) in energyTypeOptions" :key="index"
                                           :label="item.fullName"
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
                ...
                >
                    <el-table-column prop="name_name" label="点位名称" align="left"/>
                    <el-table-column prop="code_name" label="点位编号" align="left"/>
                    <el-table-column prop="energyType_name" label="环境类型" align="left"/>
                    <!-- <el-table-column prop="" label="起始度数" align="left" >
                     <template>
                         1000
                     </template>
                    </el-table-column> -->
...
export default {
    ...
    methods: {
        ...
        getenergyTypeOptions() {
            getDictionaryDataSelector('382892790524160709').then(res => {
