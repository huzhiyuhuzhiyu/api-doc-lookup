...
<script>
import { noVModelList } from '@/views/testForm/components/Generator/generator/comConfig'
import { isNumberStr } from '@/views/testForm/components/Generator/utils'
import { saveFormConf, getDrawingList } from '@/views/testForm/components/Generator/utils/db'
...
export default {
  ...
  data() {
    return {
      ...
      generalWidthOptions: ['600px', '800px', '1000px', '40%', '50%', '60%', '70%', '90%'],
