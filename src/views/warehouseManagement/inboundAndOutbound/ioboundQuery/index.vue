...
<template>
  <div class="JNPF-common-layout">
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                ...
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="dataForm.originNo" @keyup.enter.native="search()" placeholder="请输入来源单号"
                      clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="dataForm.partnerName" @keyup.enter.native="search()" placeholder="请输入合作伙伴名称"
                      clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="6">
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="linesQuery.orderNo" placeholder="请输入单号" @keyup.enter.native="search()"
                      clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                ...
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="linesQuery.productDrawingNo" placeholder="请输入产品图号" @keyup.enter.native="search()"
                      clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="6">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <pagination :total="linesTotal" :page.sync="linesQuery.pageNum" :limit.sync="linesQuery.pageSize"
                @pagination="initData">
                <div>
                  <span>入库合计数量(主)：{{ totalNum }}</span>&nbsp;&nbsp;<span>入库合计数量(副)：{{ totaldeputyNum }}</span>&nbsp;&nbsp;<span>出库合计数量(主)：{{ tooutboundtalNum }}</span>&nbsp;&nbsp;<span>出库合计数量(副)：{{ tooutboundtaldeputyNum }}</span>
                </div>
              </pagination>
            </div>
          </div>
    ...
    <el-dialog title="更多查询" :close-on-click-modal="false" :close-on-press-escape="false" :visible.sync="visible"
        ...
        <el-form :model="dataForm" label-width="120px" label-position="top">
          ...
          <el-col :span="12">
            <el-form-item label="创建时间">
              <el-date-picker v-model="createTimeArrsta" :picker-options="global.timePickerOptions" type="datetimerange" format="yyyy-MM-dd HH:mm:ss" value-format="yyyy-MM-dd HH:mm:ss"
      ...
      <el-row :gutter="20" v-else>
        <el-form ref="diaForm" :model="linesQuery" label-width="120px" label-position="top">
          ...
          <el-col :span="12">
            <el-form-item label="单据类型">
              <el-select v-model="linesQuery.documentType" placeholder="请选择单据类型" filterable clearable>
                <el-option v-for="(item, index) in documentStateList" :key="index" :label="item.label"
                  :value="item.value"></el-option>
              </el-select>
            </el-form-item>
    ...
    <Form1 v-if="formVisible1" ref="Form1" @refreshDataList="initData" @close="closeForm1"
      :originTypeList="originTypeList1" />
