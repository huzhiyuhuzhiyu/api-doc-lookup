        ...
        <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
                <el-form @submit.native.prevent>
                    <el-col :span="4">
                        <el-form-item>
                            <el-input v-model.trim="tableQuery.code" placeholder="请输入不良编码" clearable />
                        </el-form-item>
                    </el-col>
                    <el-col :span="4">
                        <el-form-item>
                            <el-input v-model.trim="tableQuery.name" placeholder="请输入不良名称" clearable />
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item>
...
export default {
    ...
    methods: {
        ...
        initData() {
            ...
            getAdverseCausesList(this.tableQuery).then(res => {
                // 
