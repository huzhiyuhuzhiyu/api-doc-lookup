  ...
  <transition name="el-zoom-in-center">
    <div class="JNPF-preview-main org-form">
      <div :class="['JNPF-common-page-header', btnType === 'look' ? 'noButtons' : '']">
        ...
        <el-page-header @back="goBack" :content="btnType == 'add' ? '新建领料通知单' : btnType == 'edit' ? '编辑领料通知单' : btnType == 'copy' ? '新建领料通知单' : '查看领料通知单'" />
          ...
          <el-tab-pane label="通知单信息" name="orderInfo">
              ...
              <el-row :gutter="30" class="custom-row">
                ...
                <el-col :sm="8" :xs="24">
                  <el-form-item label="领料日期" prop="operationDate">
                    <el-date-picker v-model="dataForm.operationDate" :default-value="new Date()" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" style="width: 100%;" placeholder="请选择领料日期" :disabled="btnType == 'look' ? true : false">
                    </el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :sm="8" :xs="24">
            ...
            <el-form :model="dataFormlist" v-bind="dataFormlist" ref="productForm" class="data-form">
              <el-table ref="productlist" :data="dataFormlist.productlist" v-loading="tableloading">
                ...
                <el-table-column prop="mainUnit" label="单位" width="120" show-overflow-tooltip></el-table-column>
                <el-table-column prop="num" label="领料数量" width="150" show-overflow-tooltip v-if="dataForm.receiveType=='order'" key="151"></el-table-column>
                <el-table-column prop="num" label="领料数量" width="170" key="112" v-if="dataForm.receiveType=='process'">
                  ...
                  <template slot-scope="scope">
                    <el-form-item :prop="'productlist.' + scope.$index + '.' + 'num'" :rules='productRules.num'>
                      <el-input v-model="scope.row.num" placeholder="请输入领料数量" :disabled="btnType == 'look'" maxlength="20"
                        @input="watchnums(scope.row, scope.$index)" style="width: 145px;">
                      </el-input>
                    </el-form-item>
                  </template>
                </el-table-column>
                <el-table-column prop="inventoryQuantity" label="库存数量" width="140" show-overflow-tooltip></el-table-column>
              </el-table>
            </el-form>
          </el-tab-pane>
        </el-tabs>
