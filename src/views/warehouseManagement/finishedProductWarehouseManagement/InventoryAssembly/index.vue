          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                ...
                <el-col :span="6">
                  <el-form-item>
                    <el-date-picker v-model="quotationTime" type="daterange" value-format="yyyy-MM-dd" style="width: 100%;" start-placeholder="请选择组装开始日期" end-placeholder="请选择组装结束日期">
                    </el-date-picker>
                  </el-form-item>
                </el-col>
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table v-loading="listLoading" ref="tableForm" :data="tableDataList" :fixedNO="true" @sort-change="sortChange" custom-column customKey="JNPFTableKey_267320">
                ...
                <el-table-column prop="transferDate" label="组装日期" width="160" sortable="custom" />
                <el-table-column prop="warehouseName" label="仓库" min-width="200" />
                <el-table-column prop="shelfSpaceName" label="库位" min-width="200" />
          ...
          <div class="JNPF-common-layout-center JNPF-flex-main">
            <el-row class="JNPF-common-search-box" :gutter="16">
              <el-form @submit.native.prevent>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="linesQuery.transferNo" placeholder="请输入组装单号" @keyup.enter.native="search()" clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="4">
                  <el-form-item>
                    <el-input v-model="linesQuery.transferByName" placeholder="请输入组装人" @keyup.enter.native="search()" clearable />
                  </el-form-item>
                </el-col>
                <el-col :span="6">
                  <el-form-item>
                    <el-date-picker v-model="deliveryDatefahuo" type="daterange" value-format="yyyy-MM-dd" clearable :picker-options="global.timePickerOptions" style="width: 100%;" start-placeholder="请选择组装开始日期" end-placeholder="请选择组装结束日期">
                    </el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
            ...
            <div class="JNPF-common-layout-main JNPF-flex-main">
              ...
              <JNPF-table ref="linesTableData" v-loading="listLoading" :data="linesTableData" :fixedNO="true" custom-column @sort-change="sortChange" :partentOrChild="'child'">
                ...
                <el-table-column prop="masterWarehouseName" label="目标仓库" min-width="200" />
                ...
                <el-table-column prop="masterProductDrawingNo" label="目标品名规格" min-width="400" />
                ...
                <el-table-column prop="productDrawingNo" label="原品名规格" min-width="400" />
                <!-- <el-table-column prop="productSpec" label="原产品规格型号" width="200" /> -->
                <el-table-column prop="warehouseName" label="原仓库" min-width="200" />
