    ...
    <div class="JNPF-common-layout-center JNPF-flex-main">
      ...
      <div class="JNPF-common-layout-main JNPF-flex-main">
        ...
        <JNPF-table v-loading="listLoading" highlight-current-row :fixedNO="true" ref="tableForm" :data="tableDataList"
          @sort-change="sortChange" @row-dblclick="addOrUpdateHandles" customKey="JNPFTableKey_165199">
          ...
          <el-table-column prop="totalReconciliationAmount" label="应付金额" min-width="180">
            <template slot-scope="scope">
              <el-link type="primary" @click.native="addOrUpdateHandle(scope.row.cooperativePartnerId, 'payable')">{{
  ...
  methods: {
    addOrUpdateHandles(e){
      ...
      if (e.cooperativePartnerId) {
        this.$nextTick(() => {
          this.$refs.JNPFForm.init(e.cooperativePartnerId, 'payable')
        })
      }
    },
