          ...
          <el-tabs v-model="activeName" @tab-click="handleClick" class=".el-table">
              ...
              <el-collapse v-model="activeNames">
                  ...
                  <el-form ref="dataForm" :model="dataForm" :rules="dataRule" label-width="160px" label-position="top">
                    <el-row :gutter="30" class="custom-row">
                      ...
                      <el-col :sm="6" :xs="24" v-if="true"><!-- 原dataForm.taskMethod == 'appoint' -->
                        <el-form-item label="产线" prop="productionLineId" disabled>
                ...
                <el-collapse-item title="工序信息" name="productInfo" class="productInfo">
                  <el-form :model="dataFormTwo" v-bind="dataFormTwo" ref="productForm" class="data-form">
                    <JNPF-table ref="product" :data="dataFormTwo.data" fixedNO v-loading="tableloading" customKey="JNPFTableKey_715763">
            ...
            <el-tab-pane label="领料清单" name="annex">
              <el-collapse v-model="activeNamess">
                ...
                <el-collapse-item title="领料信息" name="pickInfo" class="orderInfo" v-if="allocationFlag">
                ...
                <el-collapse-item title="领料清单" name="productInfo" class="productInfo"
                  ...
                  <JNPF-table ref="product" :data="materialList" fixedNO v-loading="tableloading" customKey="JNPFTableKey_333469">
...
export default {
  ...
  methods: {
    ...
    checkFun() {
      ...
      if (this.dataForm.pickingWay == 'production_order' && this.dataForm.autoMaterialFlag) {
