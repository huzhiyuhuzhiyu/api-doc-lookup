<template>
    <FileUploadWorkingInstruction
        :page-type="PageType.FileManagementCustomerProduct"
        :application-type="ApplicationType.CUSTOMER_PRODUCT"
        :flow-code="FlowCode.CUSTOMER_PRODUCT"
...
export default {
    name: 'FileManagementCheckCustomerProduct',
