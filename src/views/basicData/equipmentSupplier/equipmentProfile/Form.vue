    ...
    <div class="JNPF-preview-main org-form">
      <div class="JNPF-common-page-header">
        ...
        <el-page-header @back="goBack" :content="btnType
            ? '查看设备商档案'
            : !parentId
              ? $t(`equipment_supplier.addEquipment_supplier`)
              : $t(`equipment_supplier.editEquipment_supplier`)
          " />
...
import { editPartner, addPartner, getCooperativeInfo, getCounryData, checkCode } from '@/api/basicData/index'
